...
cargo  test --manifest-path=optionable/Cargo.toml --no-default-features --features derive,chrono,serde_json
cargo  test --manifest-path=optionable/Cargo.toml --no-default-features --features std,derive,chrono,serde_json
cargo  test --manifest-path=optionable/Cargo.toml --no-default-features --features alloc,derive,chrono,serde_json
