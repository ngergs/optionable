...
use k8s_openapi028::apimachinery::pkg::apis::meta::v1::{FieldsV1, ManagedFieldsEntry, ObjectMeta};
use kube4::CustomResource;
...
with_common_derives! {
    ...
    #[kube(
        crates(kube_core="::kube4::core", k8s_openapi = "::k8s_openapi028"),
        ...
        attr = "optionable(kube(resource, kube_crate=::kube4, k8s_openapi_crate=::k8s_openapi028), derive(Clone, Debug, Default, Deserialize, Serialize, PartialEq))",
    )]
