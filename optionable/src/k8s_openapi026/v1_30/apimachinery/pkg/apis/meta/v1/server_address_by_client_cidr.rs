...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR {
...
> for ServerAddressByClientCIDRAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR,
    ) -> Result<(), crate::Error> {
