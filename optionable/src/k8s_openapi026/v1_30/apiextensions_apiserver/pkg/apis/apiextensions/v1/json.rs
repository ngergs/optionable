...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSON {
...
> for JSONAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSON,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSON,
    ) -> Result<(), crate::Error> {
