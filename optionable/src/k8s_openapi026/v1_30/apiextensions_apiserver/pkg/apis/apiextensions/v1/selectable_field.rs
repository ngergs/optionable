...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::SelectableField {
...
> for SelectableFieldAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::SelectableField,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::SelectableField,
    ) -> Result<(), crate::Error> {
