...
impl crate::Optionable for k8s_openapi026::api::networking::v1::IngressPortStatus {
...
for k8s_openapi026::api::networking::v1::IngressPortStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1::IngressPortStatus>
for IngressPortStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::IngressPortStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::networking::v1::IngressPortStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::IngressPortStatus,
    ) -> Result<(), crate::Error> {
