...
impl crate::Optionable for k8s_openapi026::api::networking::v1alpha1::ServiceCIDRSpec {
...
for k8s_openapi026::api::networking::v1alpha1::ServiceCIDRSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1alpha1::ServiceCIDRSpec>
for ServiceCIDRSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1alpha1::ServiceCIDRSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1alpha1::ServiceCIDRSpec,
    ) -> Result<(), crate::Error> {
