...
pub struct IPAddressSpecAc {
    ...
    pub parent_ref: Option<
        <::k8s_openapi026::api::networking::v1alpha1::ParentReference as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::networking::v1alpha1::IPAddressSpec {
...
for k8s_openapi026::api::networking::v1alpha1::IPAddressSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1alpha1::IPAddressSpec>
for IPAddressSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1alpha1::IPAddressSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::networking::v1alpha1::IPAddressSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1alpha1::IPAddressSpec,
    ) -> Result<(), crate::Error> {
