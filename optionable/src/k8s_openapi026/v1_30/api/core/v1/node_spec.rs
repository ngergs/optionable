...
pub struct NodeSpecAc {
    ...
    pub config_source: <Option<
        ::k8s_openapi026::api::core::v1::NodeConfigSource,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub taints: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::Taint>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unschedulable: <Option<bool> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::NodeSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::NodeSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::NodeSpec> for NodeSpecAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::NodeSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::NodeSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::NodeSpec,
    ) -> Result<(), crate::Error> {
