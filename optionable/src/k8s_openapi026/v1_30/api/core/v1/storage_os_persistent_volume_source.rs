...
for k8s_openapi026::api::core::v1::StorageOSPersistentVolumeSource {
...
> for StorageOSPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::StorageOSPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::StorageOSPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
