...
pub struct ContainerStateAc {
    ...
    pub running: <Option<
        ::k8s_openapi026::api::core::v1::ContainerStateRunning,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub terminated: <Option<
        ::k8s_openapi026::api::core::v1::ContainerStateTerminated,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub waiting: <Option<
        ::k8s_openapi026::api::core::v1::ContainerStateWaiting,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::ContainerState {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::ContainerState {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ContainerState>
for ContainerStateAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::ContainerState) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::ContainerState, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ContainerState,
    ) -> Result<(), crate::Error> {
