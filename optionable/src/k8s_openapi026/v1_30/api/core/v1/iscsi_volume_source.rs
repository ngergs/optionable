...
pub struct ISCSIVolumeSourceAc {
    ...
    pub secret_ref: <Option<
        ::k8s_openapi026::api::core::v1::LocalObjectReference,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target_portal: Option<<std::string::String as crate::Optionable>::Optioned>,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::ISCSIVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::ISCSIVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ISCSIVolumeSource>
for ISCSIVolumeSourceAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::ISCSIVolumeSource) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::ISCSIVolumeSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ISCSIVolumeSource,
    ) -> Result<(), crate::Error> {
