...
impl crate::Optionable for k8s_openapi026::api::core::v1::ReplicationControllerSpec {
...
for k8s_openapi026::api::core::v1::ReplicationControllerSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ReplicationControllerSpec>
for ReplicationControllerSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ReplicationControllerSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::ReplicationControllerSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ReplicationControllerSpec,
    ) -> Result<(), crate::Error> {
