...
pub struct PersistentVolumeClaimSpecAc {
    ...
    pub data_source_ref: <Option<
        ::k8s_openapi026::api::core::v1::TypedObjectReference,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resources: <Option<
        ::k8s_openapi026::api::core::v1::VolumeResourceRequirements,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub selector: <Option<
...
impl crate::Optionable for k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec {
...
for k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec>
for PersistentVolumeClaimSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PersistentVolumeClaimSpec,
    ) -> Result<(), crate::Error> {
