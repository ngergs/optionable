...
for k8s_openapi026::api::core::v1::VsphereVirtualDiskVolumeSource {
...
> for VsphereVirtualDiskVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::VsphereVirtualDiskVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::VsphereVirtualDiskVolumeSource,
    ) -> Result<(), crate::Error> {
