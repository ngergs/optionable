...
for k8s_openapi026::api::admissionregistration::v1alpha1::ExpressionWarning {
...
> for ExpressionWarningAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::ExpressionWarning,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::ExpressionWarning,
    ) -> Result<(), crate::Error> {
