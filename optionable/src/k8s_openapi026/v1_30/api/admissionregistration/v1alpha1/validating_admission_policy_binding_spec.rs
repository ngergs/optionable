...
pub struct ValidatingAdmissionPolicyBindingSpecAc {
    ...
    pub param_ref: <Option<
        ::k8s_openapi026::api::admissionregistration::v1alpha1::ParamRef,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec {
...
> for ValidatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
