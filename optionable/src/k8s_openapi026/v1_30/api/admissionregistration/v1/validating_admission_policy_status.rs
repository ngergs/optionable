...
for k8s_openapi026::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus {
...
> for ValidatingAdmissionPolicyStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1::ValidatingAdmissionPolicyStatus,
    ) -> Result<(), crate::Error> {
