...
for k8s_openapi026::api::admissionregistration::v1beta1::Variable {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::admissionregistration::v1beta1::Variable,
> for VariableAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::Variable,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::Variable,
    ) -> Result<(), crate::Error> {
