...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesAllocationResult {
...
> for NamedResourcesAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesAllocationResult,
    ) -> Result<(), crate::Error> {
