...
for k8s_openapi026::api::resource::v1alpha2::ResourceClaimConsumerReference {
...
> for ResourceClaimConsumerReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceClaimConsumerReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceClaimConsumerReference,
    ) -> Result<(), crate::Error> {
