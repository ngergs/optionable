...
pub struct AllocationResultAc {
    ...
    pub resource_handles: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1alpha2::ResourceHandle>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shareable: <Option<bool> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::AllocationResult {
...
for k8s_openapi026::api::resource::v1alpha2::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::AllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::AllocationResult,
    ) -> Result<(), crate::Error> {
