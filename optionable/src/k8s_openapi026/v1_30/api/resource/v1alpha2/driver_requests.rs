...
pub struct DriverRequestsAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requests: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1alpha2::ResourceRequest>,
...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::DriverRequests {
...
for k8s_openapi026::api::resource::v1alpha2::DriverRequests {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::DriverRequests>
for DriverRequestsAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::DriverRequests,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1alpha2::DriverRequests, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::DriverRequests,
    ) -> Result<(), crate::Error> {
