...
for k8s_openapi026::api::resource::v1alpha2::StructuredResourceHandle {
...
> for StructuredResourceHandleAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::StructuredResourceHandle,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::StructuredResourceHandle,
    ) -> Result<(), crate::Error> {
