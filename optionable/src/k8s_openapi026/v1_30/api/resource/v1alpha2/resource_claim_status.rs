...
pub struct ResourceClaimStatusAc {
    ...
    pub allocation: <Option<
        ::k8s_openapi026::api::resource::v1alpha2::AllocationResult,
    ...
    pub reserved_for: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::resource::v1alpha2::ResourceClaimConsumerReference,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::ResourceClaimStatus {
...
for k8s_openapi026::api::resource::v1alpha2::ResourceClaimStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::ResourceClaimStatus>
for ResourceClaimStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceClaimStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceClaimStatus,
    ) -> Result<(), crate::Error> {
