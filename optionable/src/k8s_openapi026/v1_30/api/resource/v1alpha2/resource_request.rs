...
pub struct ResourceRequestAc {
    ...
    pub named_resources: <Option<
        ::k8s_openapi026::api::resource::v1alpha2::NamedResourcesRequest,
...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::ResourceRequest {
...
for k8s_openapi026::api::resource::v1alpha2::ResourceRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::ResourceRequest>
for ResourceRequestAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceRequest,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1alpha2::ResourceRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceRequest,
    ) -> Result<(), crate::Error> {
