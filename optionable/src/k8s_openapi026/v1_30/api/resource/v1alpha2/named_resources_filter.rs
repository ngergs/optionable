...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesFilter {
...
> for NamedResourcesFilterAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesFilter,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesFilter,
    ) -> Result<(), crate::Error> {
