...
for k8s_openapi026::api::resource::v1alpha2::ResourceClaimParametersReference {
...
> for ResourceClaimParametersReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceClaimParametersReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceClaimParametersReference,
    ) -> Result<(), crate::Error> {
