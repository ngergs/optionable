...
pub struct NamedResourcesInstanceAc {
    ...
    pub attributes: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1alpha2::NamedResourcesAttribute>,
...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesInstance {
...
> for NamedResourcesInstanceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesInstance,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesInstance,
    ) -> Result<(), crate::Error> {
