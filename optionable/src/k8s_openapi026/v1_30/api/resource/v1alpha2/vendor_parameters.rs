...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::VendorParameters {
...
for k8s_openapi026::api::resource::v1alpha2::VendorParameters {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::VendorParameters>
for VendorParametersAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::VendorParameters,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1alpha2::VendorParameters,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::VendorParameters,
    ) -> Result<(), crate::Error> {
