...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesIntSlice {
...
> for NamedResourcesIntSliceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesIntSlice,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesIntSlice,
    ) -> Result<(), crate::Error> {
