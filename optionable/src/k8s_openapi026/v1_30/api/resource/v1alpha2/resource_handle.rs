...
pub struct ResourceHandleAc {
    ...
    pub structured_data: <Option<
        ::k8s_openapi026::api::resource::v1alpha2::StructuredResourceHandle,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha2::ResourceHandle {
...
for k8s_openapi026::api::resource::v1alpha2::ResourceHandle {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha2::ResourceHandle>
for ResourceHandleAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceHandle,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1alpha2::ResourceHandle, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceHandle,
    ) -> Result<(), crate::Error> {
