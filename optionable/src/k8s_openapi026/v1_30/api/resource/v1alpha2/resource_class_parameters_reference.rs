...
pub struct ResourceClassParametersReferenceAc {
...
for k8s_openapi026::api::resource::v1alpha2::ResourceClassParametersReference {
    type Optioned = ResourceClassParametersReferenceAc;
}
#[automatically_derived]
impl crate::Optionable for ResourceClassParametersReferenceAc {
    type Optioned = ResourceClassParametersReferenceAc;
}
#[automatically_derived]
...
for k8s_openapi026::api::resource::v1alpha2::ResourceClassParametersReference {
    fn into_optioned(self) -> ResourceClassParametersReferenceAc {
        ResourceClassParametersReferenceAc {
    ...
    fn try_from_optioned(
        value: ResourceClassParametersReferenceAc,
    ...
    fn merge(
        &mut self,
        other: ResourceClassParametersReferenceAc,
    ) -> Result<(), crate::Error> {
...
> for ResourceClassParametersReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::ResourceClassParametersReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::ResourceClassParametersReference,
    ) -> Result<(), crate::Error> {
