...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesStringSlice {
...
> for NamedResourcesStringSliceAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesStringSlice,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesStringSlice,
    ) -> Result<(), crate::Error> {
