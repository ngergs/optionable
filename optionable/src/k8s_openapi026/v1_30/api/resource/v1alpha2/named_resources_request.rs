...
for k8s_openapi026::api::resource::v1alpha2::NamedResourcesRequest {
...
> for NamedResourcesRequestAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha2::NamedResourcesRequest,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha2::NamedResourcesRequest,
    ) -> Result<(), crate::Error> {
