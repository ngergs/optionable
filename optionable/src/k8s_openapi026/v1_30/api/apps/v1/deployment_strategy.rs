...
pub struct DeploymentStrategyAc {
    ...
    pub rolling_update: <Option<
        ::k8s_openapi026::api::apps::v1::RollingUpdateDeployment,
...
impl crate::Optionable for k8s_openapi026::api::apps::v1::DeploymentStrategy {
...
impl crate::OptionableConvert for k8s_openapi026::api::apps::v1::DeploymentStrategy {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::apps::v1::DeploymentStrategy>
for DeploymentStrategyAc {
    fn from_optionable(
        value: k8s_openapi026::api::apps::v1::DeploymentStrategy,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::apps::v1::DeploymentStrategy, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apps::v1::DeploymentStrategy,
    ) -> Result<(), crate::Error> {
