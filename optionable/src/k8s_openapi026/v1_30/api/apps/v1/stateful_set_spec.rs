...
pub struct StatefulSetSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ordinals: <Option<
        ::k8s_openapi026::api::apps::v1::StatefulSetOrdinals,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub persistent_volume_claim_retention_policy: <Option<
        ::k8s_openapi026::api::apps::v1::StatefulSetPersistentVolumeClaimRetentionPolicy,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub template: Option<
        <::k8s_openapi026::api::core::v1::PodTemplateSpec as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub update_strategy: <Option<
        ::k8s_openapi026::api::apps::v1::StatefulSetUpdateStrategy,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub volume_claim_templates: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PersistentVolumeClaim>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::apps::v1::StatefulSetSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::apps::v1::StatefulSetSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::apps::v1::StatefulSetSpec>
for StatefulSetSpecAc {
    fn from_optionable(value: k8s_openapi026::api::apps::v1::StatefulSetSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::apps::v1::StatefulSetSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apps::v1::StatefulSetSpec,
    ) -> Result<(), crate::Error> {
