...
for k8s_openapi026::api::authorization::v1::SelfSubjectAccessReviewSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::authorization::v1::SelfSubjectAccessReviewSpec,
> for SelfSubjectAccessReviewSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::SelfSubjectAccessReviewSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::SelfSubjectAccessReviewSpec,
    ) -> Result<(), crate::Error> {
