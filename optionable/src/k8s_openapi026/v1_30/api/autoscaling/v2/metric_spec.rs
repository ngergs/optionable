...
pub struct MetricSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub external: <Option<
        ::k8s_openapi026::api::autoscaling::v2::ExternalMetricSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub object: <Option<
        ::k8s_openapi026::api::autoscaling::v2::ObjectMetricSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pods: <Option<
        ::k8s_openapi026::api::autoscaling::v2::PodsMetricSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource: <Option<
        ::k8s_openapi026::api::autoscaling::v2::ResourceMetricSource,
    > as crate::Optionable>::Optioned,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::autoscaling::v2::MetricSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::autoscaling::v2::MetricSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::autoscaling::v2::MetricSpec>
for MetricSpecAc {
    fn from_optionable(value: k8s_openapi026::api::autoscaling::v2::MetricSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::autoscaling::v2::MetricSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::MetricSpec,
    ) -> Result<(), crate::Error> {
