...
for k8s_openapi026::api::autoscaling::v2::CrossVersionObjectReference {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::autoscaling::v2::CrossVersionObjectReference,
> for CrossVersionObjectReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::CrossVersionObjectReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::CrossVersionObjectReference,
    ) -> Result<(), crate::Error> {
