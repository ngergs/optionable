...
impl crate::Optionable for k8s_openapi026::api::storage::v1::CSIStorageCapacity {
...
impl crate::OptionableConvert for k8s_openapi026::api::storage::v1::CSIStorageCapacity {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1::CSIStorageCapacity>
for CSIStorageCapacityAc {
    fn from_optionable(
        value: k8s_openapi026::api::storage::v1::CSIStorageCapacity,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::storage::v1::CSIStorageCapacity, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1::CSIStorageCapacity,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for CSIStorageCapacityAc {
    const API_VERSION: &'static str = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Resource>::Scope;
}
impl k8s_openapi026::Metadata for CSIStorageCapacityAc {
    type Ty = <k8s_openapi026::api::storage::v1::CSIStorageCapacity as k8s_openapi026::Metadata>::Ty;
...
fn roundtrip_csistoragecapacityac() {
    crate::testutil::roundtrip_test::<
        k8s_openapi026::api::storage::v1::CSIStorageCapacity,
    >();
}
