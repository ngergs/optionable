...
pub struct CSINodeSpecAc {
    ...
    pub drivers: Option<
        <std::vec::Vec<
            ::k8s_openapi026::api::storage::v1::CSINodeDriver,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::storage::v1::CSINodeSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::storage::v1::CSINodeSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1::CSINodeSpec>
for CSINodeSpecAc {
    fn from_optionable(value: k8s_openapi026::api::storage::v1::CSINodeSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::storage::v1::CSINodeSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1::CSINodeSpec,
    ) -> Result<(), crate::Error> {
