...
pub struct PodFailurePolicyAc {
    ...
    pub rules: Option<
        <std::vec::Vec<
            ::k8s_openapi026::api::batch::v1::PodFailurePolicyRule,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::batch::v1::PodFailurePolicy {
...
impl crate::OptionableConvert for k8s_openapi026::api::batch::v1::PodFailurePolicy {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::batch::v1::PodFailurePolicy>
for PodFailurePolicyAc {
    fn from_optionable(value: k8s_openapi026::api::batch::v1::PodFailurePolicy) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::batch::v1::PodFailurePolicy, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::PodFailurePolicy,
    ) -> Result<(), crate::Error> {
