...
pub struct PriorityLevelConfigurationSpecAc {
    ...
    pub exempt: <Option<
        ::k8s_openapi026::api::flowcontrol::v1::ExemptPriorityLevelConfiguration,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub limited: <Option<
        ::k8s_openapi026::api::flowcontrol::v1::LimitedPriorityLevelConfiguration,
    > as crate::Optionable>::Optioned,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationSpec {
...
> for PriorityLevelConfigurationSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationSpec,
    ) -> Result<(), crate::Error> {
