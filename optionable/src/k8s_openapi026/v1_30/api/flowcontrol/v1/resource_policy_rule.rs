...
impl crate::Optionable for k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule {
...
for k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule>
for ResourcePolicyRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::ResourcePolicyRule,
    ) -> Result<(), crate::Error> {
