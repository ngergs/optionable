...
pub struct FlowSchemaSpecAc {
    ...
    pub distinguisher_method: <Option<
        ::k8s_openapi026::api::flowcontrol::v1beta3::FlowDistinguisherMethod,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub matching_precedence: <Option<i32> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub priority_level_configuration: Option<
        <::k8s_openapi026::api::flowcontrol::v1beta3::PriorityLevelConfigurationReference as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rules: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::flowcontrol::v1beta3::PolicyRulesWithSubjects,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::flowcontrol::v1beta3::FlowSchemaSpec {
...
for k8s_openapi026::api::flowcontrol::v1beta3::FlowSchemaSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::flowcontrol::v1beta3::FlowSchemaSpec>
for FlowSchemaSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::FlowSchemaSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::FlowSchemaSpec,
    ) -> Result<(), crate::Error> {
