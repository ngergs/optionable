...
for k8s_openapi026::api::flowcontrol::v1beta3::ServiceAccountSubject {
...
> for ServiceAccountSubjectAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::ServiceAccountSubject,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::ServiceAccountSubject,
    ) -> Result<(), crate::Error> {
