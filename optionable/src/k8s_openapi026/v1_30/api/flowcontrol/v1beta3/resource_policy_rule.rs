...
for k8s_openapi026::api::flowcontrol::v1beta3::ResourcePolicyRule {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::flowcontrol::v1beta3::ResourcePolicyRule,
> for ResourcePolicyRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::ResourcePolicyRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::ResourcePolicyRule,
    ) -> Result<(), crate::Error> {
