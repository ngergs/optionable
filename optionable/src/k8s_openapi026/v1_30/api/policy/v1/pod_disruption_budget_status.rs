...
impl crate::Optionable for k8s_openapi026::api::policy::v1::PodDisruptionBudgetStatus {
...
for k8s_openapi026::api::policy::v1::PodDisruptionBudgetStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::policy::v1::PodDisruptionBudgetStatus>
for PodDisruptionBudgetStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::policy::v1::PodDisruptionBudgetStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::policy::v1::PodDisruptionBudgetStatus,
    ) -> Result<(), crate::Error> {
