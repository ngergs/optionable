...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule {
...
> for ValidationRuleAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule,
    ) -> Result<(), crate::Error> {
