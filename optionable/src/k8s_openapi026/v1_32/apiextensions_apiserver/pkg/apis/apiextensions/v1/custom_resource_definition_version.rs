...
pub struct CustomResourceDefinitionVersionAc {
    ...
    pub additional_printer_columns: <Option<
        std::vec::Vec<
            ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceColumnDefinition,
        >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schema: <Option<
        ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceValidation,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub selectable_fields: <Option<
        std::vec::Vec<
            ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::SelectableField,
        >,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub subresources: <Option<
        ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceSubresources,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionVersion {
...
impl crate::OptionedConvert<
    k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionVersion,
> for CustomResourceDefinitionVersionAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionVersion,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionVersion,
    ) -> Result<(), crate::Error> {
