...
for k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::ServiceReference {
...
> for ServiceReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::ServiceReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::ServiceReference,
    ) -> Result<(), crate::Error> {
