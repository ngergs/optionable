...
pub struct DeploymentSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub strategy: <Option<
        ::k8s_openapi026::api::apps::v1::DeploymentStrategy,
...
impl crate::Optionable for k8s_openapi026::api::apps::v1::DeploymentSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::apps::v1::DeploymentSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::apps::v1::DeploymentSpec>
for DeploymentSpecAc {
    fn from_optionable(value: k8s_openapi026::api::apps::v1::DeploymentSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::apps::v1::DeploymentSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apps::v1::DeploymentSpec,
    ) -> Result<(), crate::Error> {
