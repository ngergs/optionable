...
for k8s_openapi026::api::apps::v1::RollingUpdateStatefulSetStrategy {
...
> for RollingUpdateStatefulSetStrategyAc {
    fn from_optionable(
        value: k8s_openapi026::api::apps::v1::RollingUpdateStatefulSetStrategy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apps::v1::RollingUpdateStatefulSetStrategy,
    ) -> Result<(), crate::Error> {
