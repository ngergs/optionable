...
pub struct LoadBalancerIngressAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ports: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PortStatus>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::LoadBalancerIngress {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::LoadBalancerIngress {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::LoadBalancerIngress>
for LoadBalancerIngressAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::LoadBalancerIngress,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::LoadBalancerIngress, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::LoadBalancerIngress,
    ) -> Result<(), crate::Error> {
