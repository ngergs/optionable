...
impl crate::Optionable for k8s_openapi026::api::core::v1::WindowsSecurityContextOptions {
...
for k8s_openapi026::api::core::v1::WindowsSecurityContextOptions {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::WindowsSecurityContextOptions>
for WindowsSecurityContextOptionsAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::WindowsSecurityContextOptions,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::WindowsSecurityContextOptions,
    ) -> Result<(), crate::Error> {
