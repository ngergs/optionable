...
pub struct IngressLoadBalancerStatusAc {
    ...
    pub ingress: <Option<
        std::vec::Vec<::k8s_openapi026::api::networking::v1::IngressLoadBalancerIngress>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::networking::v1::IngressLoadBalancerStatus {
...
> for IngressLoadBalancerStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::IngressLoadBalancerStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::IngressLoadBalancerStatus,
    ) -> Result<(), crate::Error> {
