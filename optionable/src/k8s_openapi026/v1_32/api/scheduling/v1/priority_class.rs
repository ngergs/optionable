...
impl crate::Optionable for k8s_openapi026::api::scheduling::v1::PriorityClass {
...
impl crate::OptionableConvert for k8s_openapi026::api::scheduling::v1::PriorityClass {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::scheduling::v1::PriorityClass>
for PriorityClassAc {
    fn from_optionable(
        value: k8s_openapi026::api::scheduling::v1::PriorityClass,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::scheduling::v1::PriorityClass, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::scheduling::v1::PriorityClass,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for PriorityClassAc {
    const API_VERSION: &'static str = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Resource>::Scope;
}
impl k8s_openapi026::Metadata for PriorityClassAc {
    type Ty = <k8s_openapi026::api::scheduling::v1::PriorityClass as k8s_openapi026::Metadata>::Ty;
...
fn roundtrip_priorityclassac() {
    crate::testutil::roundtrip_test::<
        k8s_openapi026::api::scheduling::v1::PriorityClass,
    >();
}
