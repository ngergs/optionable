...
pub struct MutatingAdmissionPolicySpecAc {
    ...
    pub mutations: <Option<
        std::vec::Vec<::k8s_openapi026::api::admissionregistration::v1alpha1::Mutation>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec {
...
> for MutatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
