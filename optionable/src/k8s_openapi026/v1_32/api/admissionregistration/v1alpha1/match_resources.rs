...
pub struct MatchResourcesAc {
    ...
    pub exclude_resource_rules: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
        >,
...
for k8s_openapi026::api::admissionregistration::v1alpha1::MatchResources {
...
> for MatchResourcesAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::MatchResources,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::MatchResources,
    ) -> Result<(), crate::Error> {
