...
for k8s_openapi026::api::admissionregistration::v1beta1::AuditAnnotation {
...
> for AuditAnnotationAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::AuditAnnotation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::AuditAnnotation,
    ) -> Result<(), crate::Error> {
