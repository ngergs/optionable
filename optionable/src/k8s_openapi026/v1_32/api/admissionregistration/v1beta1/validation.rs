...
for k8s_openapi026::api::admissionregistration::v1beta1::Validation {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::admissionregistration::v1beta1::Validation,
> for ValidationAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::Validation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::Validation,
    ) -> Result<(), crate::Error> {
