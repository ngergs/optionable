...
impl crate::Optionable for k8s_openapi026::api::authorization::v1::ResourceRule {
...
impl crate::OptionableConvert for k8s_openapi026::api::authorization::v1::ResourceRule {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::authorization::v1::ResourceRule>
for ResourceRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::ResourceRule,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::authorization::v1::ResourceRule, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::ResourceRule,
    ) -> Result<(), crate::Error> {
