...
for k8s_openapi026::api::batch::v1::PodFailurePolicyOnExitCodesRequirement {
...
> for PodFailurePolicyOnExitCodesRequirementAc {
    fn from_optionable(
        value: k8s_openapi026::api::batch::v1::PodFailurePolicyOnExitCodesRequirement,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::PodFailurePolicyOnExitCodesRequirement,
    ) -> Result<(), crate::Error> {
