...
impl crate::Optionable for k8s_openapi026::api::batch::v1::SuccessPolicyRule {
...
impl crate::OptionableConvert for k8s_openapi026::api::batch::v1::SuccessPolicyRule {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::batch::v1::SuccessPolicyRule>
for SuccessPolicyRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::batch::v1::SuccessPolicyRule,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::batch::v1::SuccessPolicyRule, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::SuccessPolicyRule,
    ) -> Result<(), crate::Error> {
