...
for k8s_openapi026::api::authentication::v1::BoundObjectReference {
...
> for BoundObjectReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::authentication::v1::BoundObjectReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authentication::v1::BoundObjectReference,
    ) -> Result<(), crate::Error> {
