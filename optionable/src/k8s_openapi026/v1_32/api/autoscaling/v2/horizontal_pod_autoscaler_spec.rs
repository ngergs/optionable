...
pub struct HorizontalPodAutoscalerSpecAc {
    ...
    pub behavior: <Option<
        ::k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub max_replicas: Option<i32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metrics: <Option<
        std::vec::Vec<::k8s_openapi026::api::autoscaling::v2::MetricSpec>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerSpec {
...
> for HorizontalPodAutoscalerSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerSpec,
    ) -> Result<(), crate::Error> {
