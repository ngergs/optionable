...
impl crate::Optionable for k8s_openapi026::api::autoscaling::v2::ExternalMetricSource {
...
for k8s_openapi026::api::autoscaling::v2::ExternalMetricSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::autoscaling::v2::ExternalMetricSource>
for ExternalMetricSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::ExternalMetricSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::ExternalMetricSource,
    ) -> Result<(), crate::Error> {
