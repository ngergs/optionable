...
for k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerCondition {
...
> for HorizontalPodAutoscalerConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerCondition,
    ) -> Result<(), crate::Error> {
