...
for k8s_openapi026::api::apiserverinternal::v1alpha1::ServerStorageVersion {
...
> for ServerStorageVersionAc {
    fn from_optionable(
        value: k8s_openapi026::api::apiserverinternal::v1alpha1::ServerStorageVersion,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apiserverinternal::v1alpha1::ServerStorageVersion,
    ) -> Result<(), crate::Error> {
