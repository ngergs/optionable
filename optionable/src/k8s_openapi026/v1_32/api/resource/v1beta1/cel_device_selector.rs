...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::CELDeviceSelector {
...
for k8s_openapi026::api::resource::v1beta1::CELDeviceSelector {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::CELDeviceSelector>
for CELDeviceSelectorAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::CELDeviceSelector,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::CELDeviceSelector,
    ) -> Result<(), crate::Error> {
