...
pub struct ResourceClaimSpecAc {
    ...
    pub devices: <Option<
        ::k8s_openapi026::api::resource::v1beta1::DeviceClaim,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec {
...
for k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec>
for ResourceClaimSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::ResourceClaimSpec,
    ) -> Result<(), crate::Error> {
