...
pub struct DeviceClassSpecAc {
    ...
    pub config: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1beta1::DeviceClassConfiguration>,
...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::DeviceClassSpec {
...
for k8s_openapi026::api::resource::v1beta1::DeviceClassSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::DeviceClassSpec>
for DeviceClassSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::DeviceClassSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1beta1::DeviceClassSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::DeviceClassSpec,
    ) -> Result<(), crate::Error> {
