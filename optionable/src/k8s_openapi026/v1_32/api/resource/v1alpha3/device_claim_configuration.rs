...
for k8s_openapi026::api::resource::v1alpha3::DeviceClaimConfiguration {
...
> for DeviceClaimConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceClaimConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceClaimConfiguration,
    ) -> Result<(), crate::Error> {
