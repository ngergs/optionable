...
for k8s_openapi026::api::resource::v1alpha3::ResourceClaimTemplateSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1alpha3::ResourceClaimTemplateSpec,
> for ResourceClaimTemplateSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::ResourceClaimTemplateSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::ResourceClaimTemplateSpec,
    ) -> Result<(), crate::Error> {
