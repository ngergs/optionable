...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusCause {
...
impl crate::OptionedConvert<
    k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusCause,
> for StatusCauseAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusCause,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusCause,
    ) -> Result<(), crate::Error> {
