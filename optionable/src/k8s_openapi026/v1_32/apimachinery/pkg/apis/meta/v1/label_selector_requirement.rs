...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement {
...
> for LabelSelectorRequirementAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
    ) -> Result<(), crate::Error> {
