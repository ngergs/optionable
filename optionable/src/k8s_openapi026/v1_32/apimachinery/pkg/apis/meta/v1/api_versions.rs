...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions {
...
impl crate::OptionedConvert<
    k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions,
> for APIVersionsAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for APIVersionsAc {
    const API_VERSION: &'static str = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIVersions as k8s_openapi026::Resource>::Scope;
}
