...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry {
...
impl crate::OptionedConvert<
    k8s_openapi026::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry,
> for ManagedFieldsEntryAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry,
    ) -> Result<(), crate::Error> {
