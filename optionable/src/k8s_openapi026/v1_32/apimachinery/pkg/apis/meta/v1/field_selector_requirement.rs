...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement {
...
> for FieldSelectorRequirementAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement,
    ) -> Result<(), crate::Error> {
