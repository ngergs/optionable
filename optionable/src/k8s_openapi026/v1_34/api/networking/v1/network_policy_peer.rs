...
pub struct NetworkPolicyPeerAc {
    ...
    pub ip_block: <Option<
        ::k8s_openapi026::api::networking::v1::IPBlock,
...
impl crate::Optionable for k8s_openapi026::api::networking::v1::NetworkPolicyPeer {
...
for k8s_openapi026::api::networking::v1::NetworkPolicyPeer {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1::NetworkPolicyPeer>
for NetworkPolicyPeerAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::NetworkPolicyPeer,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::networking::v1::NetworkPolicyPeer, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::NetworkPolicyPeer,
    ) -> Result<(), crate::Error> {
