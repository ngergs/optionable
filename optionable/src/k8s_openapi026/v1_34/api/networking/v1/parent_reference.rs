...
impl crate::Optionable for k8s_openapi026::api::networking::v1::ParentReference {
...
impl crate::OptionableConvert for k8s_openapi026::api::networking::v1::ParentReference {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1::ParentReference>
for ParentReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::ParentReference,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::networking::v1::ParentReference, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::ParentReference,
    ) -> Result<(), crate::Error> {
