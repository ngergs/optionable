...
for k8s_openapi026::api::admissionregistration::v1beta1::ParamRef {
...
> for ParamRefAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::ParamRef,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::ParamRef,
    ) -> Result<(), crate::Error> {
