...
for k8s_openapi026::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBindingSpec {
...
> for MutatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
