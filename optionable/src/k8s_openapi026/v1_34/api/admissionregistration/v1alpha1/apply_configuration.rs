...
for k8s_openapi026::api::admissionregistration::v1alpha1::ApplyConfiguration {
...
> for ApplyConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::ApplyConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::ApplyConfiguration,
    ) -> Result<(), crate::Error> {
