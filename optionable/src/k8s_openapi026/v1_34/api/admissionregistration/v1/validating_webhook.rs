...
for k8s_openapi026::api::admissionregistration::v1::ValidatingWebhook {
...
> for ValidatingWebhookAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1::ValidatingWebhook,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1::ValidatingWebhook,
    ) -> Result<(), crate::Error> {
