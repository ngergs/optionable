...
pub struct AllocatedDeviceStatusAc {
    ...
    pub conditions: <Option<
        std::vec::Vec<::k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition>,
    ...
    pub network_data: <Option<
        ::k8s_openapi026::api::resource::v1::NetworkDeviceData,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::resource::v1::AllocatedDeviceStatus {
...
for k8s_openapi026::api::resource::v1::AllocatedDeviceStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::AllocatedDeviceStatus>
for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::AllocatedDeviceStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1::AllocatedDeviceStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
