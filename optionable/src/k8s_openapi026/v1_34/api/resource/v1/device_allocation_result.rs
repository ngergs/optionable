...
pub struct DeviceAllocationResultAc {
    ...
    pub config: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1::DeviceAllocationConfiguration>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub results: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1::DeviceRequestAllocationResult>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1::DeviceAllocationResult {
...
for k8s_openapi026::api::resource::v1::DeviceAllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::DeviceAllocationResult>
for DeviceAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::DeviceAllocationResult,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1::DeviceAllocationResult,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::DeviceAllocationResult,
    ) -> Result<(), crate::Error> {
