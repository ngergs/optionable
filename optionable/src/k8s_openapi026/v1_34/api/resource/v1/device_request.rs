...
pub struct DeviceRequestAc {
    ...
    pub exactly: <Option<
        ::k8s_openapi026::api::resource::v1::ExactDeviceRequest,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub first_available: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1::DeviceSubRequest>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<<std::string::String as crate::Optionable>::Optioned>,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1::DeviceRequest {
...
impl crate::OptionableConvert for k8s_openapi026::api::resource::v1::DeviceRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::DeviceRequest>
for DeviceRequestAc {
    fn from_optionable(value: k8s_openapi026::api::resource::v1::DeviceRequest) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1::DeviceRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::DeviceRequest,
    ) -> Result<(), crate::Error> {
