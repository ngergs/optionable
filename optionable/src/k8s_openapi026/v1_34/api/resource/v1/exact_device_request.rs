...
pub struct ExactDeviceRequestAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capacity: <Option<
        ::k8s_openapi026::api::resource::v1::CapacityRequirements,
    ...
    pub selectors: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1::DeviceSelector>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tolerations: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1::DeviceToleration>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1::ExactDeviceRequest {
...
impl crate::OptionableConvert for k8s_openapi026::api::resource::v1::ExactDeviceRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::ExactDeviceRequest>
for ExactDeviceRequestAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::ExactDeviceRequest,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1::ExactDeviceRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::ExactDeviceRequest,
    ) -> Result<(), crate::Error> {
