...
impl crate::Optionable for k8s_openapi026::api::resource::v1::CELDeviceSelector {
...
impl crate::OptionableConvert for k8s_openapi026::api::resource::v1::CELDeviceSelector {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::CELDeviceSelector>
for CELDeviceSelectorAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::CELDeviceSelector,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1::CELDeviceSelector, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::CELDeviceSelector,
    ) -> Result<(), crate::Error> {
