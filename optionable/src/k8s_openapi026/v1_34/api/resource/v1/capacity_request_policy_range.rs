...
for k8s_openapi026::api::resource::v1::CapacityRequestPolicyRange {
...
> for CapacityRequestPolicyRangeAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::CapacityRequestPolicyRange,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::CapacityRequestPolicyRange,
    ) -> Result<(), crate::Error> {
