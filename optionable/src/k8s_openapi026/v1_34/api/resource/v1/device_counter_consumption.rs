...
pub struct DeviceCounterConsumptionAc {
    ...
    pub counters: Option<
        <std::collections::BTreeMap<
            std::string::String,
            ::k8s_openapi026::api::resource::v1::Counter,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1::DeviceCounterConsumption {
...
for k8s_openapi026::api::resource::v1::DeviceCounterConsumption {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1::DeviceCounterConsumption>
for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1::DeviceCounterConsumption,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
