...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta2::CELDeviceSelector {
...
for k8s_openapi026::api::resource::v1beta2::CELDeviceSelector {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta2::CELDeviceSelector>
for CELDeviceSelectorAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::CELDeviceSelector,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::CELDeviceSelector,
    ) -> Result<(), crate::Error> {
