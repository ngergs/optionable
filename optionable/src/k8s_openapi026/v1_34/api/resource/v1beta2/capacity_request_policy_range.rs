...
for k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicyRange {
...
> for CapacityRequestPolicyRangeAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicyRange,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicyRange,
    ) -> Result<(), crate::Error> {
