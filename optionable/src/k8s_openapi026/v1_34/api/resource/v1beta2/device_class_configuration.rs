...
for k8s_openapi026::api::resource::v1beta2::DeviceClassConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1beta2::DeviceClassConfiguration,
> for DeviceClassConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::DeviceClassConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::DeviceClassConfiguration,
    ) -> Result<(), crate::Error> {
