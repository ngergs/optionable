...
pub struct CapacityRequestPolicyAc {
    ...
    pub valid_range: <Option<
        ::k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicyRange,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicy {
...
> for CapacityRequestPolicyAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::CapacityRequestPolicy,
    ) -> Result<(), crate::Error> {
