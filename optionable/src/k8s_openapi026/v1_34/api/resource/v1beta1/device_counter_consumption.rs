...
for k8s_openapi026::api::resource::v1beta1::DeviceCounterConsumption {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1beta1::DeviceCounterConsumption,
> for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
