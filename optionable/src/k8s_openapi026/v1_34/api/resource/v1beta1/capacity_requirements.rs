...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::CapacityRequirements {
...
for k8s_openapi026::api::resource::v1beta1::CapacityRequirements {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::CapacityRequirements>
for CapacityRequirementsAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::CapacityRequirements,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::CapacityRequirements,
    ) -> Result<(), crate::Error> {
