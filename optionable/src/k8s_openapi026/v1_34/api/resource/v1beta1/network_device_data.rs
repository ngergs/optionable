...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::NetworkDeviceData {
...
for k8s_openapi026::api::resource::v1beta1::NetworkDeviceData {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::NetworkDeviceData>
for NetworkDeviceDataAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::NetworkDeviceData,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1beta1::NetworkDeviceData,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::NetworkDeviceData,
    ) -> Result<(), crate::Error> {
