...
pub struct AllocationResultAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: <Option<
        ::k8s_openapi026::api::resource::v1beta1::DeviceAllocationResult,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::AllocationResult {
...
for k8s_openapi026::api::resource::v1beta1::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::AllocationResult,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1beta1::AllocationResult, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::AllocationResult,
    ) -> Result<(), crate::Error> {
