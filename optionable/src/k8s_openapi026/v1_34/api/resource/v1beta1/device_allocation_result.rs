...
pub struct DeviceAllocationResultAc {
    ...
    pub config: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::resource::v1beta1::DeviceAllocationConfiguration,
        >,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub results: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::resource::v1beta1::DeviceRequestAllocationResult,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::resource::v1beta1::DeviceAllocationResult {
...
> for DeviceAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::DeviceAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::DeviceAllocationResult,
    ) -> Result<(), crate::Error> {
