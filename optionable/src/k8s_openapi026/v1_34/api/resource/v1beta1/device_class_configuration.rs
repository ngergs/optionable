...
for k8s_openapi026::api::resource::v1beta1::DeviceClassConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1beta1::DeviceClassConfiguration,
> for DeviceClassConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::DeviceClassConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::DeviceClassConfiguration,
    ) -> Result<(), crate::Error> {
