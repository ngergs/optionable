...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha3::DeviceTaintSelector {
...
for k8s_openapi026::api::resource::v1alpha3::DeviceTaintSelector {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha3::DeviceTaintSelector>
for DeviceTaintSelectorAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceTaintSelector,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceTaintSelector,
    ) -> Result<(), crate::Error> {
