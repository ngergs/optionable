...
for k8s_openapi026::api::core::v1::ContainerExtendedResourceRequest {
...
> for ContainerExtendedResourceRequestAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ContainerExtendedResourceRequest,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ContainerExtendedResourceRequest,
    ) -> Result<(), crate::Error> {
