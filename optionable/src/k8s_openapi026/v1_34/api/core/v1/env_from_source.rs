...
pub struct EnvFromSourceAc {
    ...
    pub config_map_ref: <Option<
        ::k8s_openapi026::api::core::v1::ConfigMapEnvSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub prefix: <Option<std::string::String> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret_ref: <Option<
        ::k8s_openapi026::api::core::v1::SecretEnvSource,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::EnvFromSource {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::EnvFromSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::EnvFromSource>
for EnvFromSourceAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::EnvFromSource) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::EnvFromSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::EnvFromSource,
    ) -> Result<(), crate::Error> {
