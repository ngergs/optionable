...
pub struct EphemeralContainerAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub env: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::EnvVar>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub env_from: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::EnvFromSource>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub lifecycle: <Option<
        ::k8s_openapi026::api::core::v1::Lifecycle,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub liveness_probe: <Option<
        ::k8s_openapi026::api::core::v1::Probe,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<<std::string::String as crate::Optionable>::Optioned>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ports: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::ContainerPort>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub resize_policy: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::ContainerResizePolicy>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub restart_policy_rules: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::ContainerRestartRule>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_context: <Option<
        ::k8s_openapi026::api::core::v1::SecurityContext,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub volume_devices: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::VolumeDevice>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub volume_mounts: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::VolumeMount>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub working_dir: <Option<std::string::String> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::EphemeralContainer {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::EphemeralContainer {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::EphemeralContainer>
for EphemeralContainerAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::EphemeralContainer,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::EphemeralContainer, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::EphemeralContainer,
    ) -> Result<(), crate::Error> {
