...
pub struct PodExtendedResourceClaimStatusAc {
    ...
    pub request_mappings: Option<
        <std::vec::Vec<
            ::k8s_openapi026::api::core::v1::ContainerExtendedResourceRequest,
...
for k8s_openapi026::api::core::v1::PodExtendedResourceClaimStatus {
...
> for PodExtendedResourceClaimStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PodExtendedResourceClaimStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PodExtendedResourceClaimStatus,
    ) -> Result<(), crate::Error> {
