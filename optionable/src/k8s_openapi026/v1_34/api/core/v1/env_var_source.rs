...
pub struct EnvVarSourceAc {
    ...
    pub config_map_key_ref: <Option<
        ::k8s_openapi026::api::core::v1::ConfigMapKeySelector,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub field_ref: <Option<
        ::k8s_openapi026::api::core::v1::ObjectFieldSelector,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub file_key_ref: <Option<
        ::k8s_openapi026::api::core::v1::FileKeySelector,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_field_ref: <Option<
        ::k8s_openapi026::api::core::v1::ResourceFieldSelector,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret_key_ref: <Option<
        ::k8s_openapi026::api::core::v1::SecretKeySelector,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::EnvVarSource {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::EnvVarSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::EnvVarSource>
for EnvVarSourceAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::EnvVarSource) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::EnvVarSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::EnvVarSource,
    ) -> Result<(), crate::Error> {
