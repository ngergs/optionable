...
pub struct ScaleIOPersistentVolumeSourceAc {
    ...
    pub secret_ref: Option<
        <::k8s_openapi026::api::core::v1::SecretReference as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource {
...
for k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource>
for ScaleIOPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
