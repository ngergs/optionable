...
for k8s_openapi026::api::core::v1::AWSElasticBlockStoreVolumeSource {
...
> for AWSElasticBlockStoreVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::AWSElasticBlockStoreVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::AWSElasticBlockStoreVolumeSource,
    ) -> Result<(), crate::Error> {
