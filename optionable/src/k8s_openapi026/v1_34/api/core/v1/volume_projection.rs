...
pub struct VolumeProjectionAc {
    ...
    pub cluster_trust_bundle: <Option<
        ::k8s_openapi026::api::core::v1::ClusterTrustBundleProjection,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub config_map: <Option<
        ::k8s_openapi026::api::core::v1::ConfigMapProjection,
    > as crate::Optionable>::Optioned,
    #[serde(rename = "downwardAPI")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub downward_api: <Option<
        ::k8s_openapi026::api::core::v1::DownwardAPIProjection,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pod_certificate: <Option<
        ::k8s_openapi026::api::core::v1::PodCertificateProjection,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret: <Option<
        ::k8s_openapi026::api::core::v1::SecretProjection,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service_account_token: <Option<
        ::k8s_openapi026::api::core::v1::ServiceAccountTokenProjection,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::VolumeProjection {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::VolumeProjection {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::VolumeProjection>
for VolumeProjectionAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::VolumeProjection) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::VolumeProjection, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::VolumeProjection,
    ) -> Result<(), crate::Error> {
