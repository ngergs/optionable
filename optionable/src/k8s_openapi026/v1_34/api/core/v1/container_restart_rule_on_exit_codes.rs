...
for k8s_openapi026::api::core::v1::ContainerRestartRuleOnExitCodes {
...
> for ContainerRestartRuleOnExitCodesAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ContainerRestartRuleOnExitCodes,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ContainerRestartRuleOnExitCodes,
    ) -> Result<(), crate::Error> {
