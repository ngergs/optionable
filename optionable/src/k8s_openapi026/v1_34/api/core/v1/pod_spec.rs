...
pub struct PodSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub affinity: <Option<
        ::k8s_openapi026::api::core::v1::Affinity,
    ...
    pub containers: Option<
        <std::vec::Vec<
            ::k8s_openapi026::api::core::v1::Container,
        > as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dns_config: <Option<
        ::k8s_openapi026::api::core::v1::PodDNSConfig,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub ephemeral_containers: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::EphemeralContainer>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub host_aliases: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::HostAlias>,
    > as crate::Optionable>::Optioned,
    ...
    pub init_containers: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::Container>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub os: <Option<
        ::k8s_openapi026::api::core::v1::PodOS,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub overhead: <Option<
    ...
    pub readiness_gates: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodReadinessGate>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_claims: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodResourceClaim>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resources: <Option<
        ::k8s_openapi026::api::core::v1::ResourceRequirements,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub scheduling_gates: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodSchedulingGate>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_context: <Option<
        ::k8s_openapi026::api::core::v1::PodSecurityContext,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub tolerations: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::Toleration>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub topology_spread_constraints: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::TopologySpreadConstraint>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub volumes: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::Volume>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::PodSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::PodSpec {
    ...
    fn try_from_optioned(value: PodSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            hostname_override: crate::OptionableConvert::try_from_optioned(
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PodSpec> for PodSpecAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::PodSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PodSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PodSpec,
    ) -> Result<(), crate::Error> {
