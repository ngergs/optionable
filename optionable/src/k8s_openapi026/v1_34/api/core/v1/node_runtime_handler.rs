...
pub struct NodeRuntimeHandlerAc {
    ...
    pub features: <Option<
        ::k8s_openapi026::api::core::v1::NodeRuntimeHandlerFeatures,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: <Option<std::string::String> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::NodeRuntimeHandler {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::NodeRuntimeHandler {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::NodeRuntimeHandler>
for NodeRuntimeHandlerAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::NodeRuntimeHandler,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::NodeRuntimeHandler, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::NodeRuntimeHandler,
    ) -> Result<(), crate::Error> {
