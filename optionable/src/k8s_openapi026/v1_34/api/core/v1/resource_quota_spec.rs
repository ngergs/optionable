...
pub struct ResourceQuotaSpecAc {
    ...
    pub scope_selector: <Option<
        ::k8s_openapi026::api::core::v1::ScopeSelector,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scopes: <Option<
...
impl crate::Optionable for k8s_openapi026::api::core::v1::ResourceQuotaSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::ResourceQuotaSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ResourceQuotaSpec>
for ResourceQuotaSpecAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::ResourceQuotaSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::ResourceQuotaSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ResourceQuotaSpec,
    ) -> Result<(), crate::Error> {
