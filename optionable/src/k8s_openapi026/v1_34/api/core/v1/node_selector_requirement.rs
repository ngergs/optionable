...
impl crate::Optionable for k8s_openapi026::api::core::v1::NodeSelectorRequirement {
...
for k8s_openapi026::api::core::v1::NodeSelectorRequirement {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::NodeSelectorRequirement>
for NodeSelectorRequirementAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::NodeSelectorRequirement,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::NodeSelectorRequirement, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::NodeSelectorRequirement,
    ) -> Result<(), crate::Error> {
