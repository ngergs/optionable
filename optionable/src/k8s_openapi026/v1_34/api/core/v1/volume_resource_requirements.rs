...
impl crate::Optionable for k8s_openapi026::api::core::v1::VolumeResourceRequirements {
...
for k8s_openapi026::api::core::v1::VolumeResourceRequirements {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::VolumeResourceRequirements>
for VolumeResourceRequirementsAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::VolumeResourceRequirements,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::VolumeResourceRequirements,
    ) -> Result<(), crate::Error> {
