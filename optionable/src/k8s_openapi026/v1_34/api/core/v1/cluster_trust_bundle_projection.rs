...
impl crate::Optionable for k8s_openapi026::api::core::v1::ClusterTrustBundleProjection {
...
for k8s_openapi026::api::core::v1::ClusterTrustBundleProjection {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ClusterTrustBundleProjection>
for ClusterTrustBundleProjectionAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ClusterTrustBundleProjection,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ClusterTrustBundleProjection,
    ) -> Result<(), crate::Error> {
