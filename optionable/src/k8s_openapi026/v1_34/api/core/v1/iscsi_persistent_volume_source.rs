...
impl crate::Optionable for k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource {
...
for k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource>
for ISCSIPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
