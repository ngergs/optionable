...
pub struct PodDNSConfigAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub options: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodDNSConfigOption>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub searches: <Option<
        std::vec::Vec<std::string::String>,
...
impl crate::Optionable for k8s_openapi026::api::core::v1::PodDNSConfig {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::PodDNSConfig {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PodDNSConfig>
for PodDNSConfigAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::PodDNSConfig) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PodDNSConfig, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PodDNSConfig,
    ) -> Result<(), crate::Error> {
