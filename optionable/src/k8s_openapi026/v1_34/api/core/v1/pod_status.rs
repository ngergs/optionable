...
pub struct PodStatusAc {
    ...
    pub conditions: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodCondition>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub container_statuses: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::ContainerStatus>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub extended_resource_claim_status: <Option<
        ::k8s_openapi026::api::core::v1::PodExtendedResourceClaimStatus,
    > as crate::Optionable>::Optioned,
    #[serde(rename = "hostIP")]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub host_ips: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::HostIP>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pod_ips: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodIP>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub resource_claim_statuses: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::PodResourceClaimStatus>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::core::v1::PodStatus {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::PodStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PodStatus> for PodStatusAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::PodStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PodStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PodStatus,
    ) -> Result<(), crate::Error> {
