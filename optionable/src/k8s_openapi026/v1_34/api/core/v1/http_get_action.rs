...
pub struct HTTPGetActionAc {
    ...
    pub http_headers: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::HTTPHeader>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub path: <Option<std::string::String> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub port: Option<
        <::k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scheme: <Option<std::string::String> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::HTTPGetAction {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::HTTPGetAction {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::HTTPGetAction>
for HTTPGetActionAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::HTTPGetAction) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::HTTPGetAction, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::HTTPGetAction,
    ) -> Result<(), crate::Error> {
