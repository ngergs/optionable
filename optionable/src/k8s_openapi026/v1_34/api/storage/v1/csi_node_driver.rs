...
pub struct CSINodeDriverAc {
    ...
    pub allocatable: <Option<
        ::k8s_openapi026::api::storage::v1::VolumeNodeResources,
...
impl crate::Optionable for k8s_openapi026::api::storage::v1::CSINodeDriver {
...
impl crate::OptionableConvert for k8s_openapi026::api::storage::v1::CSINodeDriver {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1::CSINodeDriver>
for CSINodeDriverAc {
    fn from_optionable(value: k8s_openapi026::api::storage::v1::CSINodeDriver) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::storage::v1::CSINodeDriver, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1::CSINodeDriver,
    ) -> Result<(), crate::Error> {
