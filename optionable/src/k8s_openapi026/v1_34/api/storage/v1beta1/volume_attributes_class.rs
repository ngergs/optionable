...
impl crate::Optionable for k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass {
...
for k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass>
for VolumeAttributesClassAc {
    fn from_optionable(
        value: k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for VolumeAttributesClassAc {
    const API_VERSION: &'static str = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Resource>::Scope;
}
impl k8s_openapi026::Metadata for VolumeAttributesClassAc {
    type Ty = <k8s_openapi026::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi026::Metadata>::Ty;
