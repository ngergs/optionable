...
for k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestStatus {
...
> for PodCertificateRequestStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestStatus,
    ) -> Result<(), crate::Error> {
