...
pub struct PodCertificateRequestSpecAc {
    ...
    pub pkix_public_key: Option<
        <::k8s_openapi026::ByteString as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestSpec,
> for PodCertificateRequestSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Result<(), crate::Error> {
