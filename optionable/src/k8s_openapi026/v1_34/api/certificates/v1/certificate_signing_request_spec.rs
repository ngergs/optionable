...
pub struct CertificateSigningRequestSpecAc {
    ...
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub request: Option<<::k8s_openapi026::ByteString as crate::Optionable>::Optioned>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::api::certificates::v1::CertificateSigningRequestSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::certificates::v1::CertificateSigningRequestSpec,
> for CertificateSigningRequestSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Result<(), crate::Error> {
