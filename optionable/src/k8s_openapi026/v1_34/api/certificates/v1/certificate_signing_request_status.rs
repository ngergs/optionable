...
pub struct CertificateSigningRequestStatusAc {
    ...
    pub certificate: <Option<
        ::k8s_openapi026::ByteString,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub conditions: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::certificates::v1::CertificateSigningRequestCondition,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::certificates::v1::CertificateSigningRequestStatus {
...
> for CertificateSigningRequestStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::certificates::v1::CertificateSigningRequestStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::certificates::v1::CertificateSigningRequestStatus,
    ) -> Result<(), crate::Error> {
