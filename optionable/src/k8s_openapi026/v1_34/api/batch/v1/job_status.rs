...
pub struct JobStatusAc {
    ...
    pub conditions: <Option<
        std::vec::Vec<::k8s_openapi026::api::batch::v1::JobCondition>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub uncounted_terminated_pods: <Option<
        ::k8s_openapi026::api::batch::v1::UncountedTerminatedPods,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::batch::v1::JobStatus {
...
impl crate::OptionableConvert for k8s_openapi026::api::batch::v1::JobStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::batch::v1::JobStatus> for JobStatusAc {
    fn from_optionable(value: k8s_openapi026::api::batch::v1::JobStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::batch::v1::JobStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::JobStatus,
    ) -> Result<(), crate::Error> {
