...
pub struct CronJobSpecAc {
    ...
    pub job_template: Option<
        <::k8s_openapi026::api::batch::v1::JobTemplateSpec as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::batch::v1::CronJobSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::batch::v1::CronJobSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::batch::v1::CronJobSpec>
for CronJobSpecAc {
    fn from_optionable(value: k8s_openapi026::api::batch::v1::CronJobSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::batch::v1::CronJobSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::CronJobSpec,
    ) -> Result<(), crate::Error> {
