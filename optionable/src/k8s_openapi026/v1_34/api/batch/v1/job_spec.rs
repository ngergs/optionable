...
pub struct JobSpecAc {
    ...
    pub pod_failure_policy: <Option<
        ::k8s_openapi026::api::batch::v1::PodFailurePolicy,
    ...
    pub success_policy: <Option<
        ::k8s_openapi026::api::batch::v1::SuccessPolicy,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::batch::v1::JobSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::batch::v1::JobSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::batch::v1::JobSpec> for JobSpecAc {
    fn from_optionable(value: k8s_openapi026::api::batch::v1::JobSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::batch::v1::JobSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::batch::v1::JobSpec,
    ) -> Result<(), crate::Error> {
