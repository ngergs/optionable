...
pub struct TokenRequestStatusAc {
    ...
    pub expiration_timestamp: Option<
        <::k8s_openapi026::apimachinery::pkg::apis::meta::v1::Time as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub token: Option<<std::string::String as crate::Optionable>::Optioned>,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::authentication::v1::TokenRequestStatus {
...
for k8s_openapi026::api::authentication::v1::TokenRequestStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::authentication::v1::TokenRequestStatus>
for TokenRequestStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::authentication::v1::TokenRequestStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authentication::v1::TokenRequestStatus,
    ) -> Result<(), crate::Error> {
