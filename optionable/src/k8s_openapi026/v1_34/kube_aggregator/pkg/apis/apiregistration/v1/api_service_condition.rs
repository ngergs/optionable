...
for k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition {
...
> for APIServiceConditionAc {
    fn from_optionable(
        value: k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition,
    ) -> Result<(), crate::Error> {
