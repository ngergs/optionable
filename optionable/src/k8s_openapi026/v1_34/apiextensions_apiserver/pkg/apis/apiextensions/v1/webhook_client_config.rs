...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig {
...
> for WebhookClientConfigAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
    ) -> Result<(), crate::Error> {
