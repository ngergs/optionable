...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::DeleteOptions {
...
> for DeleteOptionsAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::DeleteOptions,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::DeleteOptions,
    ) -> Result<(), crate::Error> {
