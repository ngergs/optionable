...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelector {
...
> for LabelSelectorAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelector,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelector,
    ) -> Result<(), crate::Error> {
