...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::OwnerReference {
...
> for OwnerReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::OwnerReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::OwnerReference,
    ) -> Result<(), crate::Error> {
