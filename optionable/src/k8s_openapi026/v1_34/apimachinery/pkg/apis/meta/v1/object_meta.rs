...
pub struct ObjectMetaAc {
    ...
    pub owner_references: <Option<
        std::vec::Vec<
            ::k8s_openapi026::apimachinery::pkg::apis::meta::v1::OwnerReference,
        >,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::ObjectMeta {
...
> for ObjectMetaAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::ObjectMeta,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::ObjectMeta,
    ) -> Result<(), crate::Error> {
