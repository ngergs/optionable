...
impl crate::Optionable for k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString {
...
for k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString>
for IntOrStringAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::util::intstr::IntOrString,
    ) -> Result<(), crate::Error> {
