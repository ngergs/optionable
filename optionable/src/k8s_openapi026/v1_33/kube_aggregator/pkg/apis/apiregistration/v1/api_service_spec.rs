...
pub struct APIServiceSpecAc {
    ...
    pub ca_bundle: <Option<::k8s_openapi026::ByteString> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: <Option<
        ::k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::ServiceReference,
...
for k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec {
...
> for APIServiceSpecAc {
    fn from_optionable(
        value: k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Result<(), crate::Error> {
