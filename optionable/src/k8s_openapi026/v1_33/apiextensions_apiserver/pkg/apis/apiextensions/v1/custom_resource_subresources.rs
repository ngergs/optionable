...
pub struct CustomResourceSubresourcesAc {
    ...
    pub scale: <Option<
        ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceSubresourceScale,
...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceSubresources {
...
> for CustomResourceSubresourcesAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceSubresources,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceSubresources,
    ) -> Result<(), crate::Error> {
