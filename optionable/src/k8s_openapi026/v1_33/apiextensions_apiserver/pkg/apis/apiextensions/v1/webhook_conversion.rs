...
pub struct WebhookConversionAc {
    ...
    pub client_config: <Option<
        ::k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookConversion {
...
> for WebhookConversionAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookConversion,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookConversion,
    ) -> Result<(), crate::Error> {
