...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ExternalDocumentation {
...
> for ExternalDocumentationAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ExternalDocumentation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::ExternalDocumentation,
    ) -> Result<(), crate::Error> {
