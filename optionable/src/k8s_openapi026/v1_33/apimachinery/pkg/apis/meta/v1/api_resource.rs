...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIResource {
...
> for APIResourceAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIResource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::APIResource,
    ) -> Result<(), crate::Error> {
