...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery {
...
> for GroupVersionForDiscoveryAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery,
    ) -> Result<(), crate::Error> {
