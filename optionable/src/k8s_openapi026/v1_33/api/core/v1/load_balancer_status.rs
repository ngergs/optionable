...
pub struct LoadBalancerStatusAc {
    ...
    pub ingress: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::LoadBalancerIngress>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::LoadBalancerStatus {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::LoadBalancerStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::LoadBalancerStatus>
for LoadBalancerStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::LoadBalancerStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::LoadBalancerStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::LoadBalancerStatus,
    ) -> Result<(), crate::Error> {
