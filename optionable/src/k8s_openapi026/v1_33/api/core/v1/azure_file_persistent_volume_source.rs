...
for k8s_openapi026::api::core::v1::AzureFilePersistentVolumeSource {
...
> for AzureFilePersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::AzureFilePersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::AzureFilePersistentVolumeSource,
    ) -> Result<(), crate::Error> {
