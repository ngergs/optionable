...
pub struct SessionAffinityConfigAc {
    ...
    pub client_ip: <Option<
        ::k8s_openapi026::api::core::v1::ClientIPConfig,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::SessionAffinityConfig {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::SessionAffinityConfig {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::SessionAffinityConfig>
for SessionAffinityConfigAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::SessionAffinityConfig,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::SessionAffinityConfig, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::SessionAffinityConfig,
    ) -> Result<(), crate::Error> {
