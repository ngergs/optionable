...
pub struct NodeSelectorAc {
    ...
    pub node_selector_terms: Option<
        <std::vec::Vec<
            ::k8s_openapi026::api::core::v1::NodeSelectorTerm,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::NodeSelector {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::NodeSelector {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::NodeSelector>
for NodeSelectorAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::NodeSelector) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::NodeSelector, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::NodeSelector,
    ) -> Result<(), crate::Error> {
