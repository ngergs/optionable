...
pub struct PersistentVolumeSpecAc {
    ...
    pub azure_file: <Option<
        ::k8s_openapi026::api::core::v1::AzureFilePersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capacity: <Option<
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cephfs: <Option<
        ::k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cinder: <Option<
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub csi: <Option<
        ::k8s_openapi026::api::core::v1::CSIPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fc: <Option<
    ...
    pub flex_volume: <Option<
        ::k8s_openapi026::api::core::v1::FlexPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flocker: <Option<
    ...
    pub glusterfs: <Option<
        ::k8s_openapi026::api::core::v1::GlusterfsPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub iscsi: <Option<
        ::k8s_openapi026::api::core::v1::ISCSIPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub local: <Option<
        ::k8s_openapi026::api::core::v1::LocalVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub node_affinity: <Option<
        ::k8s_openapi026::api::core::v1::VolumeNodeAffinity,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rbd: <Option<
        ::k8s_openapi026::api::core::v1::RBDPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(rename = "scaleIO")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scale_io: <Option<
        ::k8s_openapi026::api::core::v1::ScaleIOPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub storage_class_name: <Option<std::string::String> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub storageos: <Option<
        ::k8s_openapi026::api::core::v1::StorageOSPersistentVolumeSource,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::core::v1::PersistentVolumeSpec {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::PersistentVolumeSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PersistentVolumeSpec>
for PersistentVolumeSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PersistentVolumeSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PersistentVolumeSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PersistentVolumeSpec,
    ) -> Result<(), crate::Error> {
