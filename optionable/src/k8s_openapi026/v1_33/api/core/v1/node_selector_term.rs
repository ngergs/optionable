...
pub struct NodeSelectorTermAc {
    ...
    pub match_expressions: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::NodeSelectorRequirement>,
...
impl crate::Optionable for k8s_openapi026::api::core::v1::NodeSelectorTerm {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::NodeSelectorTerm {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::NodeSelectorTerm>
for NodeSelectorTermAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::NodeSelectorTerm) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::NodeSelectorTerm, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::NodeSelectorTerm,
    ) -> Result<(), crate::Error> {
