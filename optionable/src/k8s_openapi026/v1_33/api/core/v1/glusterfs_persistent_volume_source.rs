...
for k8s_openapi026::api::core::v1::GlusterfsPersistentVolumeSource {
...
> for GlusterfsPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::GlusterfsPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::GlusterfsPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
