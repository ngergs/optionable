...
pub struct TopologySelectorTermAc {
    ...
    pub match_label_expressions: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::TopologySelectorLabelRequirement>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::TopologySelectorTerm {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::TopologySelectorTerm {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::TopologySelectorTerm>
for TopologySelectorTermAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::TopologySelectorTerm,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::TopologySelectorTerm, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::TopologySelectorTerm,
    ) -> Result<(), crate::Error> {
