...
pub struct ReplicationControllerStatusAc {
    ...
    pub conditions: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::ReplicationControllerCondition>,
...
impl crate::Optionable for k8s_openapi026::api::core::v1::ReplicationControllerStatus {
...
for k8s_openapi026::api::core::v1::ReplicationControllerStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ReplicationControllerStatus>
for ReplicationControllerStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ReplicationControllerStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ReplicationControllerStatus,
    ) -> Result<(), crate::Error> {
