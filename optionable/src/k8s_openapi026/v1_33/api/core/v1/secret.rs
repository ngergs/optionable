...
impl crate::Optionable for k8s_openapi026::api::core::v1::Secret {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::Secret {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::Secret> for SecretAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::Secret) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::Secret, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::Secret,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for SecretAc {
    const API_VERSION: &'static str = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Resource>::Scope;
}
impl k8s_openapi026::Metadata for SecretAc {
    type Ty = <k8s_openapi026::api::core::v1::Secret as k8s_openapi026::Metadata>::Ty;
...
fn roundtrip_secretac() {
    crate::testutil::roundtrip_test::<k8s_openapi026::api::core::v1::Secret>();
}
