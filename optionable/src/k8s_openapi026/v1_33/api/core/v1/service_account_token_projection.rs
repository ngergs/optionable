...
impl crate::Optionable for k8s_openapi026::api::core::v1::ServiceAccountTokenProjection {
...
for k8s_openapi026::api::core::v1::ServiceAccountTokenProjection {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ServiceAccountTokenProjection>
for ServiceAccountTokenProjectionAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::ServiceAccountTokenProjection,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ServiceAccountTokenProjection,
    ) -> Result<(), crate::Error> {
