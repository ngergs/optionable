...
for k8s_openapi026::api::storagemigration::v1alpha1::MigrationCondition {
...
> for MigrationConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::storagemigration::v1alpha1::MigrationCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storagemigration::v1alpha1::MigrationCondition,
    ) -> Result<(), crate::Error> {
