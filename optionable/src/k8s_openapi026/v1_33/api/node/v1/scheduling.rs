...
impl crate::Optionable for k8s_openapi026::api::node::v1::Scheduling {
...
impl crate::OptionableConvert for k8s_openapi026::api::node::v1::Scheduling {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::node::v1::Scheduling> for SchedulingAc {
    fn from_optionable(value: k8s_openapi026::api::node::v1::Scheduling) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::node::v1::Scheduling, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::node::v1::Scheduling,
    ) -> Result<(), crate::Error> {
