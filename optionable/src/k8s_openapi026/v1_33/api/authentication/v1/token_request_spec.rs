...
pub struct TokenRequestSpecAc {
    ...
    pub bound_object_ref: <Option<
        ::k8s_openapi026::api::authentication::v1::BoundObjectReference,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expiration_seconds: <Option<i64> as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::authentication::v1::TokenRequestSpec {
...
for k8s_openapi026::api::authentication::v1::TokenRequestSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::authentication::v1::TokenRequestSpec>
for TokenRequestSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::authentication::v1::TokenRequestSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::authentication::v1::TokenRequestSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authentication::v1::TokenRequestSpec,
    ) -> Result<(), crate::Error> {
