...
for k8s_openapi026::api::coordination::v1beta1::LeaseCandidateSpec {
...
> for LeaseCandidateSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::coordination::v1beta1::LeaseCandidateSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::coordination::v1beta1::LeaseCandidateSpec,
    ) -> Result<(), crate::Error> {
