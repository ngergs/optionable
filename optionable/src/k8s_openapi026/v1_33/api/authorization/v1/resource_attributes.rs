...
pub struct ResourceAttributesAc {
    ...
    pub label_selector: <Option<
        ::k8s_openapi026::api::authorization::v1::LabelSelectorAttributes,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::authorization::v1::ResourceAttributes {
...
for k8s_openapi026::api::authorization::v1::ResourceAttributes {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::authorization::v1::ResourceAttributes>
for ResourceAttributesAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::ResourceAttributes,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::authorization::v1::ResourceAttributes,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::ResourceAttributes,
    ) -> Result<(), crate::Error> {
