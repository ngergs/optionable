...
pub struct LabelSelectorAttributesAc {
    ...
    pub requirements: <Option<
        std::vec::Vec<
            ::k8s_openapi026::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::authorization::v1::LabelSelectorAttributes {
...
> for LabelSelectorAttributesAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::LabelSelectorAttributes,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::LabelSelectorAttributes,
    ) -> Result<(), crate::Error> {
