...
pub struct IngressLoadBalancerIngressAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ports: <Option<
        std::vec::Vec<::k8s_openapi026::api::networking::v1::IngressPortStatus>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::networking::v1::IngressLoadBalancerIngress {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::networking::v1::IngressLoadBalancerIngress,
> for IngressLoadBalancerIngressAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::IngressLoadBalancerIngress,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::IngressLoadBalancerIngress,
    ) -> Result<(), crate::Error> {
