...
pub struct HTTPIngressPathAc {
    ...
    pub backend: Option<
        <::k8s_openapi026::api::networking::v1::IngressBackend as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::networking::v1::HTTPIngressPath {
...
impl crate::OptionableConvert for k8s_openapi026::api::networking::v1::HTTPIngressPath {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::networking::v1::HTTPIngressPath>
for HTTPIngressPathAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::HTTPIngressPath,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::networking::v1::HTTPIngressPath, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::HTTPIngressPath,
    ) -> Result<(), crate::Error> {
