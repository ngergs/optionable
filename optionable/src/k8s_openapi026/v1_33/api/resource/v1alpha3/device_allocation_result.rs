...
for k8s_openapi026::api::resource::v1alpha3::DeviceAllocationResult {
...
> for DeviceAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceAllocationResult,
    ) -> Result<(), crate::Error> {
