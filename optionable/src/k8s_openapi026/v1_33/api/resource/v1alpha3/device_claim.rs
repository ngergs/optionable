...
pub struct DeviceClaimAc {
    ...
    pub config: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::resource::v1alpha3::DeviceClaimConfiguration,
        >,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub constraints: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1alpha3::DeviceConstraint>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requests: <Option<
        std::vec::Vec<::k8s_openapi026::api::resource::v1alpha3::DeviceRequest>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha3::DeviceClaim {
...
impl crate::OptionableConvert for k8s_openapi026::api::resource::v1alpha3::DeviceClaim {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha3::DeviceClaim>
for DeviceClaimAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceClaim,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1alpha3::DeviceClaim, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceClaim,
    ) -> Result<(), crate::Error> {
