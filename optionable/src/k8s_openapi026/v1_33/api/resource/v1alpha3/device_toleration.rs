...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha3::DeviceToleration {
...
for k8s_openapi026::api::resource::v1alpha3::DeviceToleration {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha3::DeviceToleration>
for DeviceTolerationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceToleration,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::resource::v1alpha3::DeviceToleration,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceToleration,
    ) -> Result<(), crate::Error> {
