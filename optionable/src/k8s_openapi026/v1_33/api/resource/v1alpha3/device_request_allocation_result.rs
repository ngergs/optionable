...
for k8s_openapi026::api::resource::v1alpha3::DeviceRequestAllocationResult {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1alpha3::DeviceRequestAllocationResult,
> for DeviceRequestAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::DeviceRequestAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::DeviceRequestAllocationResult,
    ) -> Result<(), crate::Error> {
