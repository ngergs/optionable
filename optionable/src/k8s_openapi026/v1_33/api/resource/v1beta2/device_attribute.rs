...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta2::DeviceAttribute {
...
for k8s_openapi026::api::resource::v1beta2::DeviceAttribute {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta2::DeviceAttribute>
for DeviceAttributeAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::DeviceAttribute,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1beta2::DeviceAttribute, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::DeviceAttribute,
    ) -> Result<(), crate::Error> {
