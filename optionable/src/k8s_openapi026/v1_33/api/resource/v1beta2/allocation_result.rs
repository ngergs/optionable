...
pub struct AllocationResultAc {
    ...
    pub devices: <Option<
        ::k8s_openapi026::api::resource::v1beta2::DeviceAllocationResult,
...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta2::AllocationResult {
...
for k8s_openapi026::api::resource::v1beta2::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta2::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::AllocationResult,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1beta2::AllocationResult, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::AllocationResult,
    ) -> Result<(), crate::Error> {
