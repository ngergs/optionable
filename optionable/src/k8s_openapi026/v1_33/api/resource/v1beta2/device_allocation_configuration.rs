...
for k8s_openapi026::api::resource::v1beta2::DeviceAllocationConfiguration {
...
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta2::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta2::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
