...
for k8s_openapi026::api::resource::v1beta1::OpaqueDeviceConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1beta1::OpaqueDeviceConfiguration,
> for OpaqueDeviceConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::OpaqueDeviceConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::OpaqueDeviceConfiguration,
    ) -> Result<(), crate::Error> {
