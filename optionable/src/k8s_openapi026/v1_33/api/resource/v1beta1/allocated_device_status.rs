...
for k8s_openapi026::api::resource::v1beta1::AllocatedDeviceStatus {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1beta1::AllocatedDeviceStatus,
> for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::AllocatedDeviceStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
