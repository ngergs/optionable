...
impl crate::Optionable for k8s_openapi026::api::resource::v1beta1::DeviceToleration {
...
for k8s_openapi026::api::resource::v1beta1::DeviceToleration {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1beta1::DeviceToleration>
for DeviceTolerationAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1beta1::DeviceToleration,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::resource::v1beta1::DeviceToleration, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1beta1::DeviceToleration,
    ) -> Result<(), crate::Error> {
