...
impl crate::Optionable for k8s_openapi026::api::storage::v1::TokenRequest {
...
impl crate::OptionableConvert for k8s_openapi026::api::storage::v1::TokenRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1::TokenRequest>
for TokenRequestAc {
    fn from_optionable(value: k8s_openapi026::api::storage::v1::TokenRequest) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::storage::v1::TokenRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1::TokenRequest,
    ) -> Result<(), crate::Error> {
