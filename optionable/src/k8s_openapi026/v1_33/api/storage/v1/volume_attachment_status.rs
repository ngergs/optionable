...
pub struct VolumeAttachmentStatusAc {
    ...
    pub attach_error: <Option<
        ::k8s_openapi026::api::storage::v1::VolumeError,
...
impl crate::Optionable for k8s_openapi026::api::storage::v1::VolumeAttachmentStatus {
...
for k8s_openapi026::api::storage::v1::VolumeAttachmentStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::storage::v1::VolumeAttachmentStatus>
for VolumeAttachmentStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::storage::v1::VolumeAttachmentStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::storage::v1::VolumeAttachmentStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1::VolumeAttachmentStatus,
    ) -> Result<(), crate::Error> {
