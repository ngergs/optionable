...
for k8s_openapi026::api::flowcontrol::v1::FlowDistinguisherMethod {
...
> for FlowDistinguisherMethodAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Result<(), crate::Error> {
