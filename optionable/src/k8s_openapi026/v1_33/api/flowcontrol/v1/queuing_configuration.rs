...
impl crate::Optionable for k8s_openapi026::api::flowcontrol::v1::QueuingConfiguration {
...
for k8s_openapi026::api::flowcontrol::v1::QueuingConfiguration {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::flowcontrol::v1::QueuingConfiguration>
for QueuingConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::QueuingConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::QueuingConfiguration,
    ) -> Result<(), crate::Error> {
