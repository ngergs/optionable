...
for k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationCondition {
...
> for PriorityLevelConfigurationConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::PriorityLevelConfigurationCondition,
    ) -> Result<(), crate::Error> {
