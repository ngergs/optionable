...
for k8s_openapi026::api::autoscaling::v1::HorizontalPodAutoscalerStatus {
...
> for HorizontalPodAutoscalerStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v1::HorizontalPodAutoscalerStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v1::HorizontalPodAutoscalerStatus,
    ) -> Result<(), crate::Error> {
