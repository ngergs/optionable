...
pub struct ObjectMetricSourceAc {
    ...
    pub described_object: Option<
        <::k8s_openapi026::api::autoscaling::v2::CrossVersionObjectReference as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metric: Option<
        <::k8s_openapi026::api::autoscaling::v2::MetricIdentifier as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target: Option<
...
impl crate::Optionable for k8s_openapi026::api::autoscaling::v2::ObjectMetricSource {
...
for k8s_openapi026::api::autoscaling::v2::ObjectMetricSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::autoscaling::v2::ObjectMetricSource>
for ObjectMetricSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::ObjectMetricSource,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::autoscaling::v2::ObjectMetricSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::ObjectMetricSource,
    ) -> Result<(), crate::Error> {
