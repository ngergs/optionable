...
pub struct HorizontalPodAutoscalerBehaviorAc {
    ...
    pub scale_down: <Option<
        ::k8s_openapi026::api::autoscaling::v2::HPAScalingRules,
...
for k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerBehavior {
...
> for HorizontalPodAutoscalerBehaviorAc {
    fn from_optionable(
        value: k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
    ) -> Result<(), crate::Error> {
