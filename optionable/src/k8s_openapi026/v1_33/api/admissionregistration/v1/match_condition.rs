...
for k8s_openapi026::api::admissionregistration::v1::MatchCondition {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::admissionregistration::v1::MatchCondition,
> for MatchConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1::MatchCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1::MatchCondition,
    ) -> Result<(), crate::Error> {
