...
for k8s_openapi026::api::admissionregistration::v1alpha1::JSONPatch {
...
> for JSONPatchAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::JSONPatch,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::JSONPatch,
    ) -> Result<(), crate::Error> {
