...
pub struct ValidatingAdmissionPolicySpecAc {
    ...
    pub audit_annotations: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::admissionregistration::v1beta1::AuditAnnotation,
        >,
    ...
    pub match_conditions: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::admissionregistration::v1beta1::MatchCondition,
        >,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub param_kind: <Option<
        ::k8s_openapi026::api::admissionregistration::v1beta1::ParamKind,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub validations: <Option<
        std::vec::Vec<::k8s_openapi026::api::admissionregistration::v1beta1::Validation>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub variables: <Option<
        std::vec::Vec<::k8s_openapi026::api::admissionregistration::v1beta1::Variable>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec {
...
> for ValidatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
