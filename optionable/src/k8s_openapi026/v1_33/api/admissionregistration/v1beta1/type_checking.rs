...
pub struct TypeCheckingAc {
    ...
    pub expression_warnings: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::admissionregistration::v1beta1::ExpressionWarning,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::admissionregistration::v1beta1::TypeChecking {
...
> for TypeCheckingAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1beta1::TypeChecking,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1beta1::TypeChecking,
    ) -> Result<(), crate::Error> {
