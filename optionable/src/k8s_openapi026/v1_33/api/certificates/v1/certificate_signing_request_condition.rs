...
for k8s_openapi026::api::certificates::v1::CertificateSigningRequestCondition {
...
> for CertificateSigningRequestConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::certificates::v1::CertificateSigningRequestCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::certificates::v1::CertificateSigningRequestCondition,
    ) -> Result<(), crate::Error> {
