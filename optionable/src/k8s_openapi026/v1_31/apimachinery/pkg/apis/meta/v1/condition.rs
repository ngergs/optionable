...
impl crate::Optionable for k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition {
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition>
for ConditionAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::Condition,
    ) -> Result<(), crate::Error> {
