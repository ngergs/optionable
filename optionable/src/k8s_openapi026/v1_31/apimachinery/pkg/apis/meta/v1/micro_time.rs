...
impl crate::Optionable for k8s_openapi026::apimachinery::pkg::apis::meta::v1::MicroTime {
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::MicroTime {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::apimachinery::pkg::apis::meta::v1::MicroTime>
for MicroTimeAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::MicroTime,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::MicroTime,
    ) -> Result<(), crate::Error> {
