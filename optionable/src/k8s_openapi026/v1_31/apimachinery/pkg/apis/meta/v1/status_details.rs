...
pub struct StatusDetailsAc {
    ...
    pub causes: <Option<
        std::vec::Vec<::k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusCause>,
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusDetails {
...
> for StatusDetailsAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusDetails,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::StatusDetails,
    ) -> Result<(), crate::Error> {
