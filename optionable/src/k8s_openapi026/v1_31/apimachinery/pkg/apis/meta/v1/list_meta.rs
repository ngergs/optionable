...
impl crate::Optionable for k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta {
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta>
for ListMetaAc {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::ListMeta,
    ) -> Result<(), crate::Error> {
