...
impl crate::Optionable for k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1 {
...
for k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1 {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1>
for FieldsV1Ac {
    fn from_optionable(
        value: k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apimachinery::pkg::apis::meta::v1::FieldsV1,
    ) -> Result<(), crate::Error> {
