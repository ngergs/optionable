...
for k8s_openapi026::api::authentication::v1alpha1::SelfSubjectReviewStatus {
...
> for SelfSubjectReviewStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::authentication::v1alpha1::SelfSubjectReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authentication::v1alpha1::SelfSubjectReviewStatus,
    ) -> Result<(), crate::Error> {
