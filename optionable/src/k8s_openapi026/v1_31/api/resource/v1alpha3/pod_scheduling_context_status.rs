...
pub struct PodSchedulingContextStatusAc {
    ...
    pub resource_claims: <Option<
        std::vec::Vec<
            ::k8s_openapi026::api::resource::v1alpha3::ResourceClaimSchedulingStatus,
        >,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextStatus {
...
> for PodSchedulingContextStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextStatus,
    ) -> Result<(), crate::Error> {
