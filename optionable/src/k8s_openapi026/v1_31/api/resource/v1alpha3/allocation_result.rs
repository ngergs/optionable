...
pub struct AllocationResultAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: <Option<
        ::k8s_openapi026::api::resource::v1alpha3::DeviceAllocationResult,
...
impl crate::Optionable for k8s_openapi026::api::resource::v1alpha3::AllocationResult {
...
for k8s_openapi026::api::resource::v1alpha3::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::resource::v1alpha3::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::AllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::AllocationResult,
    ) -> Result<(), crate::Error> {
