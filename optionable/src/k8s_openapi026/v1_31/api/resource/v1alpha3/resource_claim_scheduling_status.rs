...
for k8s_openapi026::api::resource::v1alpha3::ResourceClaimSchedulingStatus {
...
> for ResourceClaimSchedulingStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::ResourceClaimSchedulingStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::ResourceClaimSchedulingStatus,
    ) -> Result<(), crate::Error> {
