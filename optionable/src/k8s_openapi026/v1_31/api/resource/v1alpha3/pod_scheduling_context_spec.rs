...
for k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextSpec,
> for PodSchedulingContextSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::resource::v1alpha3::PodSchedulingContextSpec,
    ) -> Result<(), crate::Error> {
