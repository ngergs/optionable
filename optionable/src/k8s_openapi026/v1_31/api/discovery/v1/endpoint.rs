...
pub struct EndpointAc {
    ...
    pub conditions: <Option<
        ::k8s_openapi026::api::discovery::v1::EndpointConditions,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hints: <Option<
        ::k8s_openapi026::api::discovery::v1::EndpointHints,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::discovery::v1::Endpoint {
...
impl crate::OptionableConvert for k8s_openapi026::api::discovery::v1::Endpoint {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::discovery::v1::Endpoint>
for EndpointAc {
    fn from_optionable(value: k8s_openapi026::api::discovery::v1::Endpoint) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::discovery::v1::Endpoint, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::discovery::v1::Endpoint,
    ) -> Result<(), crate::Error> {
