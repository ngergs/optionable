...
for k8s_openapi026::api::core::v1::PersistentVolumeClaimVolumeSource {
...
> for PersistentVolumeClaimVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PersistentVolumeClaimVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PersistentVolumeClaimVolumeSource,
    ) -> Result<(), crate::Error> {
