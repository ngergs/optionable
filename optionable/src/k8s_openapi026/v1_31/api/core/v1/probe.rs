...
pub struct ProbeAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub grpc: <Option<
        ::k8s_openapi026::api::core::v1::GRPCAction,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub http_get: <Option<
...
impl crate::Optionable for k8s_openapi026::api::core::v1::Probe {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::Probe {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::Probe> for ProbeAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::Probe) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::Probe, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::Probe,
    ) -> Result<(), crate::Error> {
