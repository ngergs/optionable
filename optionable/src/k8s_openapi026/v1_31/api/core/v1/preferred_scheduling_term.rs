...
pub struct PreferredSchedulingTermAc {
    ...
    pub preference: Option<
        <::k8s_openapi026::api::core::v1::NodeSelectorTerm as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub weight: Option<i32>,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi026::api::core::v1::PreferredSchedulingTerm {
...
for k8s_openapi026::api::core::v1::PreferredSchedulingTerm {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PreferredSchedulingTerm>
for PreferredSchedulingTermAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PreferredSchedulingTerm,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PreferredSchedulingTerm, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PreferredSchedulingTerm,
    ) -> Result<(), crate::Error> {
