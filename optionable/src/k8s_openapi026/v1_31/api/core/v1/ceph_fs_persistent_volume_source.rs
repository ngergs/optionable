...
impl crate::Optionable for k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource {
...
for k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource>
for CephFSPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::CephFSPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
