...
pub struct PodSecurityContextAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sysctls: <Option<
        std::vec::Vec<::k8s_openapi026::api::core::v1::Sysctl>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi026::api::core::v1::PodSecurityContext {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::PodSecurityContext {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::PodSecurityContext>
for PodSecurityContextAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::PodSecurityContext,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::PodSecurityContext, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::PodSecurityContext,
    ) -> Result<(), crate::Error> {
