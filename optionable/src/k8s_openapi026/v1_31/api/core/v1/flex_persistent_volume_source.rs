...
impl crate::Optionable for k8s_openapi026::api::core::v1::FlexPersistentVolumeSource {
...
for k8s_openapi026::api::core::v1::FlexPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::FlexPersistentVolumeSource>
for FlexPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi026::api::core::v1::FlexPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::FlexPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
