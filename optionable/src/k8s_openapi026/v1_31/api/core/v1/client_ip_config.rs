...
impl crate::Optionable for k8s_openapi026::api::core::v1::ClientIPConfig {
...
impl crate::OptionableConvert for k8s_openapi026::api::core::v1::ClientIPConfig {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::core::v1::ClientIPConfig>
for ClientIPConfigAc {
    fn from_optionable(value: k8s_openapi026::api::core::v1::ClientIPConfig) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::core::v1::ClientIPConfig, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::core::v1::ClientIPConfig,
    ) -> Result<(), crate::Error> {
