...
for k8s_openapi026::api::networking::v1::NetworkPolicyIngressRule {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::networking::v1::NetworkPolicyIngressRule,
> for NetworkPolicyIngressRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::networking::v1::NetworkPolicyIngressRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::networking::v1::NetworkPolicyIngressRule,
    ) -> Result<(), crate::Error> {
