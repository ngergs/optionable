...
pub struct StorageVersionMigrationSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource: Option<
        <::k8s_openapi026::api::storagemigration::v1alpha1::GroupVersionResource as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::storagemigration::v1alpha1::StorageVersionMigrationSpec {
...
> for StorageVersionMigrationSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::storagemigration::v1alpha1::StorageVersionMigrationSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storagemigration::v1alpha1::StorageVersionMigrationSpec,
    ) -> Result<(), crate::Error> {
