...
for k8s_openapi026::api::authorization::v1::SubjectAccessReviewSpec {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::authorization::v1::SubjectAccessReviewSpec,
> for SubjectAccessReviewSpecAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::SubjectAccessReviewSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::SubjectAccessReviewSpec,
    ) -> Result<(), crate::Error> {
