...
for k8s_openapi026::api::authorization::v1::SubjectAccessReviewStatus {
...
> for SubjectAccessReviewStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::authorization::v1::SubjectAccessReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::authorization::v1::SubjectAccessReviewStatus,
    ) -> Result<(), crate::Error> {
