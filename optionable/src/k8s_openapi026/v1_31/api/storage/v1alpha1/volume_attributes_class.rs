...
for k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass,
> for VolumeAttributesClassAc {
    fn from_optionable(
        value: k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi026::Resource for VolumeAttributesClassAc {
    const API_VERSION: &'static str = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Resource>::Scope;
}
impl k8s_openapi026::Metadata for VolumeAttributesClassAc {
    type Ty = <k8s_openapi026::api::storage::v1alpha1::VolumeAttributesClass as k8s_openapi026::Metadata>::Ty;
