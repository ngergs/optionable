...
for k8s_openapi026::api::flowcontrol::v1beta3::PriorityLevelConfigurationReference {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::flowcontrol::v1beta3::PriorityLevelConfigurationReference,
> for PriorityLevelConfigurationReferenceAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::PriorityLevelConfigurationReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::PriorityLevelConfigurationReference,
    ) -> Result<(), crate::Error> {
