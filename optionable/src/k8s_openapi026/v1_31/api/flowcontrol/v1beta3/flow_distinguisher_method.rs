...
for k8s_openapi026::api::flowcontrol::v1beta3::FlowDistinguisherMethod {
...
> for FlowDistinguisherMethodAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::FlowDistinguisherMethod,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::FlowDistinguisherMethod,
    ) -> Result<(), crate::Error> {
