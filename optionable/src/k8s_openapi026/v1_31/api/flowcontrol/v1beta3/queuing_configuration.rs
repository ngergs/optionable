...
for k8s_openapi026::api::flowcontrol::v1beta3::QueuingConfiguration {
...
> for QueuingConfigurationAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1beta3::QueuingConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1beta3::QueuingConfiguration,
    ) -> Result<(), crate::Error> {
