...
impl crate::Optionable for k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule {
...
for k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule>
for NonResourcePolicyRuleAc {
    fn from_optionable(
        value: k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::flowcontrol::v1::NonResourcePolicyRule,
    ) -> Result<(), crate::Error> {
