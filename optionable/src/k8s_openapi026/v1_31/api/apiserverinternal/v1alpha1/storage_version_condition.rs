...
for k8s_openapi026::api::apiserverinternal::v1alpha1::StorageVersionCondition {
...
> for StorageVersionConditionAc {
    fn from_optionable(
        value: k8s_openapi026::api::apiserverinternal::v1alpha1::StorageVersionCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apiserverinternal::v1alpha1::StorageVersionCondition,
    ) -> Result<(), crate::Error> {
