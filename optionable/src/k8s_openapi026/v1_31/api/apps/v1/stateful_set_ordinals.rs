...
impl crate::Optionable for k8s_openapi026::api::apps::v1::StatefulSetOrdinals {
...
impl crate::OptionableConvert for k8s_openapi026::api::apps::v1::StatefulSetOrdinals {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi026::api::apps::v1::StatefulSetOrdinals>
for StatefulSetOrdinalsAc {
    fn from_optionable(
        value: k8s_openapi026::api::apps::v1::StatefulSetOrdinals,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi026::api::apps::v1::StatefulSetOrdinals, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::apps::v1::StatefulSetOrdinals,
    ) -> Result<(), crate::Error> {
