...
pub struct ValidatingAdmissionPolicyStatusAc {
    ...
    pub type_checking: <Option<
        ::k8s_openapi026::api::admissionregistration::v1alpha1::TypeChecking,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus {
...
> for ValidatingAdmissionPolicyStatusAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus,
    ) -> Result<(), crate::Error> {
