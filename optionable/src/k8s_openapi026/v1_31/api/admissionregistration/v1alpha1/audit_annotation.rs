...
for k8s_openapi026::api::admissionregistration::v1alpha1::AuditAnnotation {
...
> for AuditAnnotationAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1alpha1::AuditAnnotation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1alpha1::AuditAnnotation,
    ) -> Result<(), crate::Error> {
