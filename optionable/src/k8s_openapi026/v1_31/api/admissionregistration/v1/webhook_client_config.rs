...
pub struct WebhookClientConfigAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: <Option<
        ::k8s_openapi026::api::admissionregistration::v1::ServiceReference,
...
for k8s_openapi026::api::admissionregistration::v1::WebhookClientConfig {
...
impl crate::OptionedConvert<
    k8s_openapi026::api::admissionregistration::v1::WebhookClientConfig,
> for WebhookClientConfigAc {
    fn from_optionable(
        value: k8s_openapi026::api::admissionregistration::v1::WebhookClientConfig,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::api::admissionregistration::v1::WebhookClientConfig,
    ) -> Result<(), crate::Error> {
