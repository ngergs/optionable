...
for k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrBool {
...
> for JSONSchemaPropsOrBoolAc {
    fn from_optionable(
        value: k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrBool,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi026::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrBool,
    ) -> Result<(), crate::Error> {
