...
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule {
...
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule {
    ...
    fn merge(&mut self, other: ValidationRuleAc) -> Result<(), crate::Error> {
        ...
        } else if let Some(self_value) = self.message_expression.as_mut()
            && let Some(other_value) = other.message_expression
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        } else if let Some(self_value) = self.optional_old_self.as_mut()
            && let Some(other_value) = other.optional_old_self
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
impl crate::OptionedConvert<
    k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule,
> for ValidationRuleAc {
    fn from_optionable(
        value: k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ValidationRule,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ValidationRuleAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.field_path, other.field_path);
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.rule, other.rule);
    }
}
