...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery {
...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery {
    ...
    fn merge(&mut self, other: GroupVersionForDiscoveryAc) -> Result<(), crate::Error> {
        ...
        if let Some(other_value) = other.version {
            self.version = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
        Ok(())
    }
}
...
impl crate::OptionedConvert<
    k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery,
> for GroupVersionForDiscoveryAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for GroupVersionForDiscoveryAc {
