...
for k8s_openapi028::api::flowcontrol::v1::ExemptPriorityLevelConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::ExemptPriorityLevelConfiguration,
> for ExemptPriorityLevelConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::ExemptPriorityLevelConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::ExemptPriorityLevelConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ExemptPriorityLevelConfigurationAc {
