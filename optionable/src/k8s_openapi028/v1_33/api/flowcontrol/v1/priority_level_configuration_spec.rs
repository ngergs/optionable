...
pub struct PriorityLevelConfigurationSpecAc {
    ...
    pub exempt: Option<
        <::k8s_openapi028::api::flowcontrol::v1::ExemptPriorityLevelConfiguration as crate::Optionable>::Optioned,
    >,
    /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub limited: Option<
        <::k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationSpec,
> for PriorityLevelConfigurationSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PriorityLevelConfigurationSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.exempt, other.exempt);
        k8s_openapi028::DeepMerge::merge_from(&mut self.limited, other.limited);
