...
pub struct DeviceAllocationConfigurationAc {
    ...
    pub opaque: Option<
        <::k8s_openapi028::api::resource::v1alpha3::OpaqueDeviceConfiguration as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1alpha3::DeviceAllocationConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1alpha3::DeviceAllocationConfiguration,
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceAllocationConfigurationAc {
