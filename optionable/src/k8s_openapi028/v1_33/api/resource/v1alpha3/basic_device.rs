...
pub struct BasicDeviceAc {
    ...
    pub attributes: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1alpha3::DeviceAttribute as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub consumes_counters: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1alpha3::DeviceCounterConsumption as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub taints: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1alpha3::DeviceTaint as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::BasicDevice {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1alpha3::BasicDevice {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::BasicDevice>
for BasicDeviceAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::BasicDevice,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1alpha3::BasicDevice, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::BasicDevice,
    ) -> Result<(), crate::Error> {
