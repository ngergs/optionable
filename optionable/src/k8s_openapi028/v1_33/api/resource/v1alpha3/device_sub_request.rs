...
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest {
...
for k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest>
for DeviceSubRequestAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceSubRequest,
    ) -> Result<(), crate::Error> {
