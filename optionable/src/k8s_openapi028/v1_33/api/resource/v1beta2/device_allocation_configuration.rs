...
pub struct DeviceAllocationConfigurationAc {
    ...
    pub opaque: Option<
        <::k8s_openapi028::api::resource::v1beta2::OpaqueDeviceConfiguration as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1beta2::DeviceAllocationConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceAllocationConfiguration,
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
