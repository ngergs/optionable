...
for k8s_openapi028::api::resource::v1beta2::ResourceClaimConsumerReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::ResourceClaimConsumerReference,
> for ResourceClaimConsumerReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::ResourceClaimConsumerReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::ResourceClaimConsumerReference,
    ) -> Result<(), crate::Error> {
