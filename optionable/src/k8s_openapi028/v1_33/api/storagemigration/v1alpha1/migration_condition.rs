...
for k8s_openapi028::api::storagemigration::v1alpha1::MigrationCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::storagemigration::v1alpha1::MigrationCondition,
> for MigrationConditionAc {
    fn from_optionable(
        value: k8s_openapi028::api::storagemigration::v1alpha1::MigrationCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storagemigration::v1alpha1::MigrationCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MigrationConditionAc {
