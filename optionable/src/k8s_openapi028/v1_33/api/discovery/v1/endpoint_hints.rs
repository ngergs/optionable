...
pub struct EndpointHintsAc {
    ...
    pub for_nodes: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::discovery::v1::ForNode as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub for_zones: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::discovery::v1::ForZone as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::discovery::v1::EndpointHints {
...
impl crate::OptionableConvert for k8s_openapi028::api::discovery::v1::EndpointHints {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::discovery::v1::EndpointHints>
for EndpointHintsAc {
    fn from_optionable(
        value: k8s_openapi028::api::discovery::v1::EndpointHints,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::discovery::v1::EndpointHints, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::discovery::v1::EndpointHints,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for EndpointHintsAc {
