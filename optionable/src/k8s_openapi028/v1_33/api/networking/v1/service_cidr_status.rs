...
impl crate::Optionable for k8s_openapi028::api::networking::v1::ServiceCIDRStatus {
...
for k8s_openapi028::api::networking::v1::ServiceCIDRStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::ServiceCIDRStatus>
for ServiceCIDRStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::ServiceCIDRStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::networking::v1::ServiceCIDRStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::ServiceCIDRStatus,
    ) -> Result<(), crate::Error> {
