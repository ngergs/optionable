...
for k8s_openapi028::api::networking::v1::IngressClassParametersReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::networking::v1::IngressClassParametersReference,
> for IngressClassParametersReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::IngressClassParametersReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::IngressClassParametersReference,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for IngressClassParametersReferenceAc {
