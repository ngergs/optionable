...
pub struct IngressStatusAc {
    ...
    pub load_balancer: Option<
        <::k8s_openapi028::api::networking::v1::IngressLoadBalancerStatus as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::networking::v1::IngressStatus {
...
impl crate::OptionableConvert for k8s_openapi028::api::networking::v1::IngressStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::IngressStatus>
for IngressStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::IngressStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::networking::v1::IngressStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::IngressStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for IngressStatusAc {
