...
for k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerCondition,
> for HorizontalPodAutoscalerConditionAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HorizontalPodAutoscalerConditionAc {
...
impl crate::merge::MapKeysEq for HorizontalPodAutoscalerConditionAc {
