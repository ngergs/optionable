...
pub struct NodeDaemonEndpointsAc {
    ...
    pub kubelet_endpoint: Option<
        <::k8s_openapi028::api::core::v1::DaemonEndpoint as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::NodeDaemonEndpoints {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::NodeDaemonEndpoints {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::NodeDaemonEndpoints>
for NodeDaemonEndpointsAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::NodeDaemonEndpoints,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::NodeDaemonEndpoints, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::NodeDaemonEndpoints,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NodeDaemonEndpointsAc {
