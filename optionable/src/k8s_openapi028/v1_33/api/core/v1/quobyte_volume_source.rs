...
impl crate::Optionable for k8s_openapi028::api::core::v1::QuobyteVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::QuobyteVolumeSource {
    ...
    fn merge(&mut self, other: QuobyteVolumeSourceAc) -> Result<(), crate::Error> {
        ...
        } else if let Some(self_value) = self.tenant.as_mut()
            && let Some(other_value) = other.tenant
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::QuobyteVolumeSource>
for QuobyteVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::QuobyteVolumeSource,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::QuobyteVolumeSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::QuobyteVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for QuobyteVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.registry, other.registry);
        k8s_openapi028::DeepMerge::merge_from(&mut self.tenant, other.tenant);
        k8s_openapi028::DeepMerge::merge_from(&mut self.user, other.user);
        k8s_openapi028::DeepMerge::merge_from(&mut self.volume, other.volume);
    }
}
