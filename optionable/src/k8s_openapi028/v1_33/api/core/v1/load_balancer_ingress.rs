...
pub struct LoadBalancerIngressAc {
    ...
    pub ports: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PortStatus as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::LoadBalancerIngress {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::LoadBalancerIngress {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::LoadBalancerIngress>
for LoadBalancerIngressAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::LoadBalancerIngress,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::LoadBalancerIngress, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::LoadBalancerIngress,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for LoadBalancerIngressAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.ip_mode, other.ip_mode);
