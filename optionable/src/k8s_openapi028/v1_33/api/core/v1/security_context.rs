...
pub struct SecurityContextAc {
    ...
    pub capabilities: Option<
        <::k8s_openapi028::api::core::v1::Capabilities as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::SecurityContext {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::SecurityContext {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::SecurityContext>
for SecurityContextAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::SecurityContext) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::SecurityContext, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::SecurityContext,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SecurityContextAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.privileged, other.privileged);
        k8s_openapi028::DeepMerge::merge_from(&mut self.proc_mount, other.proc_mount);
        k8s_openapi028::DeepMerge::merge_from(
