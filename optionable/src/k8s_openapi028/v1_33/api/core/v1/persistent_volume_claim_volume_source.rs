...
for k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource {
...
for k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource {
    ...
    fn merge(
        ...
        if let Some(other_value) = other.claim_name {
            self.claim_name = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
...
impl crate::OptionedConvert<
    k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource,
> for PersistentVolumeClaimVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PersistentVolumeClaimVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.claim_name, other.claim_name);
