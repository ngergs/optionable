...
pub struct MutatingAdmissionPolicyBindingSpecAc {
    ...
    pub param_ref: Option<
        <::k8s_openapi028::api::admissionregistration::v1alpha1::ParamRef as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicyBindingSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicyBindingSpec,
> for MutatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MutatingAdmissionPolicyBindingSpecAc {
    fn merge_from(&mut self, other: Self) {
        self.match_resources = other.match_resources;
        k8s_openapi028::DeepMerge::merge_from(&mut self.param_ref, other.param_ref);
