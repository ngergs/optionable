...
for k8s_openapi028::api::admissionregistration::v1alpha1::JSONPatch {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::JSONPatch,
> for JSONPatchAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::JSONPatch,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::JSONPatch,
    ) -> Result<(), crate::Error> {
