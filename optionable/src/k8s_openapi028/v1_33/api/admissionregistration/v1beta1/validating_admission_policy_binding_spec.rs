...
for k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyBindingSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyBindingSpec,
> for ValidatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
