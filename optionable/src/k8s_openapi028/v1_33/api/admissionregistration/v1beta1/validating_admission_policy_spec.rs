...
pub struct ValidatingAdmissionPolicySpecAc {
    ...
    pub audit_annotations: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1beta1::AuditAnnotation as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub match_conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1beta1::MatchCondition as crate::Optionable>::Optioned,
        >,
    >,
    /// MatchConstraints specifies what resources this policy is designed to validate. The AdmissionPolicy cares about a request if it matches _all_ Constraints. However, in order to prevent clusters from being put into an unstable state that cannot be recovered from via the API ValidatingAdmissionPolicy cannot match ValidatingAdmissionPolicy and ValidatingAdmissionPolicyBinding. Required.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub match_constraints: Option<
        <::k8s_openapi028::api::admissionregistration::v1beta1::MatchResources as crate::Optionable>::Optioned,
    >,
    /// ParamKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If ParamKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in ValidatingAdmissionPolicyBinding, the params variable will be null.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub param_kind: Option<
        <::k8s_openapi028::api::admissionregistration::v1beta1::ParamKind as crate::Optionable>::Optioned,
    >,
    /// Validations contain CEL expressions which is used to apply the validation. Validations and AuditAnnotations may not both be empty; a minimum of one Validations or AuditAnnotations is required.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub validations: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1beta1::Validation as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub variables: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1beta1::Variable as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec,
> for ValidatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::ValidatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ValidatingAdmissionPolicySpecAc {
