...
for k8s_openapi028::api::admissionregistration::v1beta1::AuditAnnotation {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::AuditAnnotation,
> for AuditAnnotationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::AuditAnnotation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::AuditAnnotation,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for AuditAnnotationAc {
