...
impl crate::Optionable for k8s_openapi028::api::admissionregistration::v1::ParamKind {
...
for k8s_openapi028::api::admissionregistration::v1::ParamKind {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::admissionregistration::v1::ParamKind>
for ParamKindAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::ParamKind,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::admissionregistration::v1::ParamKind,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::ParamKind,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ParamKindAc {
