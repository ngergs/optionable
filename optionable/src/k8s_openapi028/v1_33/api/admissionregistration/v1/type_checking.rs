...
pub struct TypeCheckingAc {
    ...
    pub expression_warnings: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1::ExpressionWarning as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::admissionregistration::v1::TypeChecking {
...
for k8s_openapi028::api::admissionregistration::v1::TypeChecking {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::admissionregistration::v1::TypeChecking>
for TypeCheckingAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::TypeChecking,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::admissionregistration::v1::TypeChecking,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::TypeChecking,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for TypeCheckingAc {
