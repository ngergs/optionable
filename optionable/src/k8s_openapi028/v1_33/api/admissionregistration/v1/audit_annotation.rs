...
for k8s_openapi028::api::admissionregistration::v1::AuditAnnotation {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::AuditAnnotation,
> for AuditAnnotationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::AuditAnnotation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::AuditAnnotation,
    ) -> Result<(), crate::Error> {
