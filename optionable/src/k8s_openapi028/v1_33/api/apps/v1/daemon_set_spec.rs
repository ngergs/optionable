...
pub struct DaemonSetSpecAc {
    ...
    pub update_strategy: Option<
        <::k8s_openapi028::api::apps::v1::DaemonSetUpdateStrategy as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::apps::v1::DaemonSetSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::apps::v1::DaemonSetSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::apps::v1::DaemonSetSpec>
for DaemonSetSpecAc {
    fn from_optionable(value: k8s_openapi028::api::apps::v1::DaemonSetSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::apps::v1::DaemonSetSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apps::v1::DaemonSetSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DaemonSetSpecAc {
