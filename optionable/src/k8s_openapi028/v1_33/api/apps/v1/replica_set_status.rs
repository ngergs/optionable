...
pub struct ReplicaSetStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::apps::v1::ReplicaSetCondition as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::apps::v1::ReplicaSetStatus {
...
impl crate::OptionableConvert for k8s_openapi028::api::apps::v1::ReplicaSetStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::apps::v1::ReplicaSetStatus>
for ReplicaSetStatusAc {
    fn from_optionable(value: k8s_openapi028::api::apps::v1::ReplicaSetStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::apps::v1::ReplicaSetStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apps::v1::ReplicaSetStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ReplicaSetStatusAc {
