...
pub struct HorizontalPodAutoscalerBehaviorAc {
    ...
    pub scale_down: Option<
        <::k8s_openapi028::api::autoscaling::v2::HPAScalingRules as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerBehavior {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
> for HorizontalPodAutoscalerBehaviorAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerBehavior,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HorizontalPodAutoscalerBehaviorAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.scale_down, other.scale_down);
        k8s_openapi028::DeepMerge::merge_from(&mut self.scale_up, other.scale_up);
    }
}
