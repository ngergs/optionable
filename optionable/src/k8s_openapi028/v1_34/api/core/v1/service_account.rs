...
impl crate::Optionable for k8s_openapi028::api::core::v1::ServiceAccount {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::ServiceAccount {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ServiceAccount>
for ServiceAccountAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::ServiceAccount) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::ServiceAccount, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ServiceAccount,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::Resource for ServiceAccountAc {
    const API_VERSION: &'static str = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Resource>::Scope;
}
impl k8s_openapi028::Metadata for ServiceAccountAc {
    type Ty = <k8s_openapi028::api::core::v1::ServiceAccount as k8s_openapi028::Metadata>::Ty;
...
fn roundtrip_serviceaccountac() {
    crate::testutil::roundtrip_test::<k8s_openapi028::api::core::v1::ServiceAccount>();
}
impl k8s_openapi028::DeepMerge for ServiceAccountAc {
