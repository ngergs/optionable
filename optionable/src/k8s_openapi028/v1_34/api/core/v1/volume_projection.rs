...
pub struct VolumeProjectionAc {
    ...
    pub cluster_trust_bundle: Option<
        <::k8s_openapi028::api::core::v1::ClusterTrustBundleProjection as crate::Optionable>::Optioned,
    >,
    /// configMap information about the configMap data to project
    #[serde(skip_serializing_if = "Option::is_none")]
    pub config_map: Option<
        <::k8s_openapi028::api::core::v1::ConfigMapProjection as crate::Optionable>::Optioned,
    >,
    /// downwardAPI information about the downwardAPI data to project
    #[serde(rename = "downwardAPI")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub downward_api: Option<
        <::k8s_openapi028::api::core::v1::DownwardAPIProjection as crate::Optionable>::Optioned,
    >,
    ...
    pub pod_certificate: Option<
        <::k8s_openapi028::api::core::v1::PodCertificateProjection as crate::Optionable>::Optioned,
    >,
    /// secret information about the secret data to project
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret: Option<
        <::k8s_openapi028::api::core::v1::SecretProjection as crate::Optionable>::Optioned,
    >,
    /// serviceAccountToken is information about the serviceAccountToken data to project
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service_account_token: Option<
        <::k8s_openapi028::api::core::v1::ServiceAccountTokenProjection as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::VolumeProjection {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::VolumeProjection {
    ...
    fn merge(&mut self, other: VolumeProjectionAc) -> Result<(), crate::Error> {
        ...
        if self.pod_certificate.is_none() {
            self.pod_certificate = crate::OptionableConvert::try_from_optioned(
                other.pod_certificate,
            )?;
        } else if let Some(self_value) = self.pod_certificate.as_mut()
            && let Some(other_value) = other.pod_certificate
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::VolumeProjection>
for VolumeProjectionAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::VolumeProjection) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::VolumeProjection, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::VolumeProjection,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for VolumeProjectionAc {
