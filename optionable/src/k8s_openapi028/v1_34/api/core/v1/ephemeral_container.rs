...
pub struct EphemeralContainerAc {
    ...
    pub env: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::EnvVar as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub env_from: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::EnvFromSource as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub lifecycle: Option<
        <::k8s_openapi028::api::core::v1::Lifecycle as crate::Optionable>::Optioned,
    >,
    /// Probes are not allowed for ephemeral containers.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub liveness_probe: Option<
        <::k8s_openapi028::api::core::v1::Probe as crate::Optionable>::Optioned,
    >,
    ...
    pub ports: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ContainerPort as crate::Optionable>::Optioned,
        >,
    >,
    /// Probes are not allowed for ephemeral containers.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub resize_policy: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ContainerResizePolicy as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub restart_policy_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ContainerRestartRule as crate::Optionable>::Optioned,
        >,
    >,
    /// Optional: SecurityContext defines the security options the ephemeral container should be run with. If set, the fields of SecurityContext override the equivalent fields of PodSecurityContext.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_context: Option<
        <::k8s_openapi028::api::core::v1::SecurityContext as crate::Optionable>::Optioned,
    >,
    /// Probes are not allowed for ephemeral containers.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub volume_devices: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::VolumeDevice as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub volume_mounts: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::VolumeMount as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::EphemeralContainer {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::EphemeralContainer {
    ...
    fn merge(&mut self, other: EphemeralContainerAc) -> Result<(), crate::Error> {
        ...
        if self.target_container_name.is_none() {
            self.target_container_name = crate::OptionableConvert::try_from_optioned(
                other.target_container_name,
            )?;
        } else if let Some(self_value) = self.target_container_name.as_mut()
            && let Some(other_value) = other.target_container_name
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
for k8s_openapi028::api::core::v1::EphemeralContainer {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::EphemeralContainer>
for EphemeralContainerAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::EphemeralContainer,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::EphemeralContainer, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::EphemeralContainer,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for EphemeralContainerAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.lifecycle, other.lifecycle);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.stdin, other.stdin);
        k8s_openapi028::DeepMerge::merge_from(&mut self.stdin_once, other.stdin_once);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.tty, other.tty);
        crate::k8s_openapi::merge::merge_map_option_wrapped(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.working_dir, other.working_dir);
    }
}
impl crate::merge::MapKeysEq for EphemeralContainerAc {
