...
pub struct PodSecurityContextAc {
    ...
    pub app_armor_profile: Option<
        <::k8s_openapi028::api::core::v1::AppArmorProfile as crate::Optionable>::Optioned,
    >,
    ...
    pub se_linux_options: Option<
        <::k8s_openapi028::api::core::v1::SELinuxOptions as crate::Optionable>::Optioned,
    >,
    /// The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub seccomp_profile: Option<
        <::k8s_openapi028::api::core::v1::SeccompProfile as crate::Optionable>::Optioned,
    >,
    ...
    pub sysctls: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::Sysctl as crate::Optionable>::Optioned,
        >,
    >,
    /// The Windows specific settings applied to all containers. If unspecified, the options within a container's SecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. Note that this field cannot be set when spec.os.name is linux.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub windows_options: Option<
        <::k8s_openapi028::api::core::v1::WindowsSecurityContextOptions as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::PodSecurityContext {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::PodSecurityContext {
    ...
    fn merge(&mut self, other: PodSecurityContextAc) -> Result<(), crate::Error> {
        ...
        } else if let Some(self_value) = self.se_linux_change_policy.as_mut()
            && let Some(other_value) = other.se_linux_change_policy
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PodSecurityContext>
for PodSecurityContextAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::PodSecurityContext,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::PodSecurityContext, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PodSecurityContext,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodSecurityContextAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.app_armor_profile,
            other.app_armor_profile,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.fs_group, other.fs_group);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.run_as_user, other.run_as_user);
        k8s_openapi028::DeepMerge::merge_from(
