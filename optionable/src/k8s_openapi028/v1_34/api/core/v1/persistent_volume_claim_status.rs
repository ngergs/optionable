...
pub struct PersistentVolumeClaimStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PersistentVolumeClaimCondition as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub modify_volume_status: Option<
        <::k8s_openapi028::api::core::v1::ModifyVolumeStatus as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus {
...
for k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus {
    ...
    fn merge(
        ...
        } else if let Some(self_value) = self.allocated_resource_statuses.as_mut()
            && let Some(other_value) = other.allocated_resource_statuses
        {
        ...
        if self.current_volume_attributes_class_name.is_none() {
            ...
            .current_volume_attributes_class_name
            .as_mut()
            && let Some(other_value) = other.current_volume_attributes_class_name
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        } else if let Some(self_value) = self.modify_volume_status.as_mut()
            && let Some(other_value) = other.modify_volume_status
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus>
for PersistentVolumeClaimStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PersistentVolumeClaimStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PersistentVolumeClaimStatusAc {
