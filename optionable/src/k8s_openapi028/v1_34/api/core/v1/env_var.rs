...
pub struct EnvVarAc {
    ...
    pub value_from: Option<
        <::k8s_openapi028::api::core::v1::EnvVarSource as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::EnvVar {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::EnvVar {
...
#[automatically_derived]
impl crate::merge::OptionableMapKeysEq for k8s_openapi028::api::core::v1::EnvVar {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::EnvVar> for EnvVarAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::EnvVar) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::EnvVar, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::EnvVar,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for EnvVarAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.value_from, other.value_from);
    }
}
