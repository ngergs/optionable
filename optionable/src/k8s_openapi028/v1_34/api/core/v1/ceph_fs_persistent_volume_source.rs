...
impl crate::Optionable for k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource {
...
for k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource>
for CephFSPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::CephFSPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CephFSPersistentVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.secret_file, other.secret_file);
