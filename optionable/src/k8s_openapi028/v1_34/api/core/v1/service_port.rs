...
pub struct ServicePortAc {
    ...
    pub target_port: Option<
        <::k8s_openapi028::apimachinery::pkg::util::intstr::IntOrString as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::ServicePort {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::ServicePort {
...
#[automatically_derived]
impl crate::merge::OptionableMapKeysEq for k8s_openapi028::api::core::v1::ServicePort {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ServicePort>
for ServicePortAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::ServicePort) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::ServicePort, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ServicePort,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServicePortAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.node_port, other.node_port);
        k8s_openapi028::DeepMerge::merge_from(&mut self.port, other.port);
        k8s_openapi028::DeepMerge::merge_from(&mut self.protocol, other.protocol);
        k8s_openapi028::DeepMerge::merge_from(&mut self.target_port, other.target_port);
    }
}
