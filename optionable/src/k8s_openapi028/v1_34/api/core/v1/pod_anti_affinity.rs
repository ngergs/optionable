...
pub struct PodAntiAffinityAc {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::WeightedPodAffinityTerm as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PodAffinityTerm as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::PodAntiAffinity {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::PodAntiAffinity {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PodAntiAffinity>
for PodAntiAffinityAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::PodAntiAffinity) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::PodAntiAffinity, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PodAntiAffinity,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodAntiAffinityAc {
