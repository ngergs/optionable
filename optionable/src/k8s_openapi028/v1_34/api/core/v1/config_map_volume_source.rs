...
pub struct ConfigMapVolumeSourceAc {
    ...
    pub items: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::KeyToPath as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::ConfigMapVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::ConfigMapVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ConfigMapVolumeSource>
for ConfigMapVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::ConfigMapVolumeSource,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::ConfigMapVolumeSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ConfigMapVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ConfigMapVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.optional, other.optional);
    }
}
