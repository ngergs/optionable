...
pub struct ServiceSpecAc {
    ...
    pub ports: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ServicePort as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub session_affinity_config: Option<
        <::k8s_openapi028::api::core::v1::SessionAffinityConfig as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::ServiceSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::ServiceSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ServiceSpec>
for ServiceSpecAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::ServiceSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::ServiceSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ServiceSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServiceSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.allocate_load_balancer_node_ports,
            other.allocate_load_balancer_node_ports,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.cluster_ip, other.cluster_ip);
