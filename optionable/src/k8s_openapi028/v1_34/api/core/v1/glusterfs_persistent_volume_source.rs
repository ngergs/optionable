...
for k8s_openapi028::api::core::v1::GlusterfsPersistentVolumeSource {
...
for k8s_openapi028::api::core::v1::GlusterfsPersistentVolumeSource {
    ...
    fn merge(
        ...
        if self.endpoints_namespace.is_none() {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::core::v1::GlusterfsPersistentVolumeSource,
> for GlusterfsPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::GlusterfsPersistentVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::GlusterfsPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for GlusterfsPersistentVolumeSourceAc {
