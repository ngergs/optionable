...
for k8s_openapi028::api::certificates::v1alpha1::PodCertificateRequestSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::certificates::v1alpha1::PodCertificateRequestSpec,
> for PodCertificateRequestSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Result<(), crate::Error> {
