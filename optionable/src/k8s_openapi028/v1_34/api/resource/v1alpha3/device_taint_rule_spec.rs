...
pub struct DeviceTaintRuleSpecAc {
    ...
    pub device_selector: Option<
        <::k8s_openapi028::api::resource::v1alpha3::DeviceTaintSelector as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec {
...
for k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec>
for DeviceTaintRuleSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceTaintRuleSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.device_selector,
            other.device_selector,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.taint, other.taint);
    }
}
