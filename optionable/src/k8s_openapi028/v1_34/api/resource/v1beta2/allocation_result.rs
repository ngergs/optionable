...
pub struct AllocationResultAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: Option<
        <::k8s_openapi028::api::resource::v1beta2::DeviceAllocationResult as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta2::AllocationResult {
...
for k8s_openapi028::api::resource::v1beta2::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta2::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::AllocationResult,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta2::AllocationResult, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::AllocationResult,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for AllocationResultAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.allocation_timestamp,
            other.allocation_timestamp,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.devices, other.devices);
