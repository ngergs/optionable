...
pub struct DeviceClaimAc {
    ...
    pub config: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceClaimConfiguration as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub constraints: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceConstraint as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub requests: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceRequest as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::resource::v1beta2::DeviceClaim {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1beta2::DeviceClaim {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta2::DeviceClaim>
for DeviceClaimAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceClaim,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta2::DeviceClaim, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceClaim,
    ) -> Result<(), crate::Error> {
