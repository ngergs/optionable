...
for k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange {
...
for k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange {
    ...
    fn merge(
        ...
        } else if let Some(self_value) = self.step.as_mut()
            && let Some(other_value) = other.step
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        Ok(())
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange,
> for CapacityRequestPolicyRangeAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CapacityRequestPolicyRangeAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.max, other.max);
        k8s_openapi028::DeepMerge::merge_from(&mut self.min, other.min);
        k8s_openapi028::DeepMerge::merge_from(&mut self.step, other.step);
    }
}
