...
pub struct DeviceCounterConsumptionAc {
    ...
    pub counters: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1::Counter as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::resource::v1::DeviceCounterConsumption {
...
for k8s_openapi028::api::resource::v1::DeviceCounterConsumption {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1::DeviceCounterConsumption>
for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1::DeviceCounterConsumption,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceCounterConsumptionAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.counter_set, other.counter_set);
