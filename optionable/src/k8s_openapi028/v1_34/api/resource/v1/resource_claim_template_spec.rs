...
impl crate::Optionable for k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec {
...
for k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec>
for ResourceClaimTemplateSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1::ResourceClaimTemplateSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ResourceClaimTemplateSpecAc {
