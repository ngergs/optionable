...
pub struct DeviceClaimConfigurationAc {
    ...
    pub opaque: Option<
        <::k8s_openapi028::api::resource::v1::OpaqueDeviceConfiguration as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1::DeviceClaimConfiguration {
...
for k8s_openapi028::api::resource::v1::DeviceClaimConfiguration {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1::DeviceClaimConfiguration>
for DeviceClaimConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1::DeviceClaimConfiguration,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1::DeviceClaimConfiguration,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1::DeviceClaimConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceClaimConfigurationAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.opaque, other.opaque);
