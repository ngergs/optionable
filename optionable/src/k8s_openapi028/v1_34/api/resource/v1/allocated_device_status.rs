...
pub struct AllocatedDeviceStatusAc {
    ...
    pub network_data: Option<
        <::k8s_openapi028::api::resource::v1::NetworkDeviceData as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1::AllocatedDeviceStatus {
...
for k8s_openapi028::api::resource::v1::AllocatedDeviceStatus {
...
for k8s_openapi028::api::resource::v1::AllocatedDeviceStatus {
    fn keys_eq(&self, other: &<Self as crate::Optionable>::Optioned) -> bool {
        self.device == other.device && self.driver == other.driver
            && self.pool == other.pool && self.share_id == other.share_id
    }
}
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1::AllocatedDeviceStatus>
for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1::AllocatedDeviceStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1::AllocatedDeviceStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for AllocatedDeviceStatusAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.share_id, other.share_id);
    }
}
