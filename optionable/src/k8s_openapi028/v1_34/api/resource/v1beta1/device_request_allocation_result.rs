...
for k8s_openapi028::api::resource::v1beta1::DeviceRequestAllocationResult {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta1::DeviceRequestAllocationResult,
> for DeviceRequestAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::DeviceRequestAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::DeviceRequestAllocationResult,
    ) -> Result<(), crate::Error> {
