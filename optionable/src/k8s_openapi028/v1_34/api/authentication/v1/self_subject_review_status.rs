...
for k8s_openapi028::api::authentication::v1::SelfSubjectReviewStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authentication::v1::SelfSubjectReviewStatus,
> for SelfSubjectReviewStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::authentication::v1::SelfSubjectReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authentication::v1::SelfSubjectReviewStatus,
    ) -> Result<(), crate::Error> {
