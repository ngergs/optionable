...
pub struct StorageVersionMigrationSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource: Option<
        <::k8s_openapi028::api::storagemigration::v1alpha1::GroupVersionResource as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::storagemigration::v1alpha1::StorageVersionMigrationSpec {
...
for k8s_openapi028::api::storagemigration::v1alpha1::StorageVersionMigrationSpec {
    ...
    fn merge(
        ...
        } else if let Some(self_value) = self.continue_token.as_mut()
            && let Some(other_value) = other.continue_token
        {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::storagemigration::v1alpha1::StorageVersionMigrationSpec,
> for StorageVersionMigrationSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::storagemigration::v1alpha1::StorageVersionMigrationSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storagemigration::v1alpha1::StorageVersionMigrationSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StorageVersionMigrationSpecAc {
