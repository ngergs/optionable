...
for k8s_openapi028::api::admissionregistration::v1alpha1::NamedRuleWithOperations {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
> for NamedRuleWithOperationsAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NamedRuleWithOperationsAc {
