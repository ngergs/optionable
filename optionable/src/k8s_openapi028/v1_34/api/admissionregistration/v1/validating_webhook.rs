...
for k8s_openapi028::api::admissionregistration::v1::ValidatingWebhook {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::ValidatingWebhook,
> for ValidatingWebhookAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::ValidatingWebhook,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::ValidatingWebhook,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ValidatingWebhookAc {
