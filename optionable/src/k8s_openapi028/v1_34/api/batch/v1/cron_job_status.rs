...
impl crate::Optionable for k8s_openapi028::api::batch::v1::CronJobStatus {
...
impl crate::OptionableConvert for k8s_openapi028::api::batch::v1::CronJobStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::batch::v1::CronJobStatus>
for CronJobStatusAc {
    fn from_optionable(value: k8s_openapi028::api::batch::v1::CronJobStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::batch::v1::CronJobStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::batch::v1::CronJobStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CronJobStatusAc {
