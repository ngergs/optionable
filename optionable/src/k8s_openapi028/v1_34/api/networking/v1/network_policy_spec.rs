...
pub struct NetworkPolicySpecAc {
    ...
    pub egress: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub ingress: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::networking::v1::NetworkPolicyIngressRule as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::networking::v1::NetworkPolicySpec {
...
for k8s_openapi028::api::networking::v1::NetworkPolicySpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::NetworkPolicySpec>
for NetworkPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::NetworkPolicySpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::networking::v1::NetworkPolicySpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::NetworkPolicySpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NetworkPolicySpecAc {
