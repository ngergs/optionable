...
pub struct StatusDetailsAc {
    ...
    pub causes: Option<
        std::vec::Vec<
            <::k8s_openapi028::apimachinery::pkg::apis::meta::v1::StatusCause as crate::Optionable>::Optioned,
        >,
    >,
...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::StatusDetails {
...
impl crate::OptionedConvert<
    k8s_openapi028::apimachinery::pkg::apis::meta::v1::StatusDetails,
> for StatusDetailsAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::StatusDetails,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::StatusDetails,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StatusDetailsAc {
