...
pub struct CustomResourceDefinitionSpecAc {
    ...
    pub conversion: Option<
        <::k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceConversion as crate::Optionable>::Optioned,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub names: Option<
        <::k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionNames as crate::Optionable>::Optioned,
    >,
    ...
    pub versions: Option<
        std::vec::Vec<
            <::k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionVersion as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec {
...
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec {
    ...
    fn merge(
        ...
        } else if let Some(self_value) = self.conversion.as_mut()
            && let Some(other_value) = other.conversion
        {
        ...
        } else if let Some(self_value) = self.preserve_unknown_fields.as_mut()
            && let Some(other_value) = other.preserve_unknown_fields
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
impl crate::OptionedConvert<
    k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec,
> for CustomResourceDefinitionSpecAc {
    fn from_optionable(
        value: k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CustomResourceDefinitionSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.conversion, other.conversion);
        k8s_openapi028::DeepMerge::merge_from(&mut self.group, other.group);
        k8s_openapi028::DeepMerge::merge_from(&mut self.names, other.names);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.preserve_unknown_fields,
            other.preserve_unknown_fields,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.scope, other.scope);
