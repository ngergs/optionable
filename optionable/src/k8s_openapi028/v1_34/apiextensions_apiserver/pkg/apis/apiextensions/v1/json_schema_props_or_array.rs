...
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray {
...
impl crate::OptionedConvert<
    k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray,
> for JSONSchemaPropsOrArrayAc {
    fn from_optionable(
        value: k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for JSONSchemaPropsOrArrayAc {
