...
pub struct SuccessPolicyAc {
    ...
    pub rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::batch::v1::SuccessPolicyRule as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::batch::v1::SuccessPolicy {
...
impl crate::OptionableConvert for k8s_openapi028::api::batch::v1::SuccessPolicy {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::batch::v1::SuccessPolicy>
for SuccessPolicyAc {
    fn from_optionable(value: k8s_openapi028::api::batch::v1::SuccessPolicy) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::batch::v1::SuccessPolicy, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::batch::v1::SuccessPolicy,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SuccessPolicyAc {
