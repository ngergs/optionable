...
pub struct JobStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::batch::v1::JobCondition as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub uncounted_terminated_pods: Option<
        <::k8s_openapi028::api::batch::v1::UncountedTerminatedPods as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::batch::v1::JobStatus {
...
impl crate::OptionableConvert for k8s_openapi028::api::batch::v1::JobStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::batch::v1::JobStatus> for JobStatusAc {
    fn from_optionable(value: k8s_openapi028::api::batch::v1::JobStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::batch::v1::JobStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::batch::v1::JobStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for JobStatusAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.active, other.active);
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.failed, other.failed);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.succeeded, other.succeeded);
        k8s_openapi028::DeepMerge::merge_from(&mut self.terminating, other.terminating);
        k8s_openapi028::DeepMerge::merge_from(
