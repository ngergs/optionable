...
impl crate::Optionable for k8s_openapi028::api::events::v1::EventSeries {
...
impl crate::OptionableConvert for k8s_openapi028::api::events::v1::EventSeries {
    ...
    fn merge(&mut self, other: EventSeriesAc) -> Result<(), crate::Error> {
        if let Some(other_value) = other.count {
            self.count = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::events::v1::EventSeries>
for EventSeriesAc {
    fn from_optionable(value: k8s_openapi028::api::events::v1::EventSeries) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::events::v1::EventSeries, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::events::v1::EventSeries,
    ) -> Result<(), crate::Error> {
