...
impl crate::Optionable for k8s_openapi028::api::storage::v1::VolumeError {
...
impl crate::OptionableConvert for k8s_openapi028::api::storage::v1::VolumeError {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::storage::v1::VolumeError>
for VolumeErrorAc {
    fn from_optionable(value: k8s_openapi028::api::storage::v1::VolumeError) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::storage::v1::VolumeError, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storage::v1::VolumeError,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for VolumeErrorAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.error_code, other.error_code);
