...
pub struct CSINodeDriverAc {
    ...
    pub allocatable: Option<
        <::k8s_openapi028::api::storage::v1::VolumeNodeResources as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::storage::v1::CSINodeDriver {
...
impl crate::OptionableConvert for k8s_openapi028::api::storage::v1::CSINodeDriver {
    ...
    fn merge(&mut self, other: CSINodeDriverAc) -> Result<(), crate::Error> {
        ...
        if let Some(other_value) = other.node_id {
            self.node_id = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
...
for k8s_openapi028::api::storage::v1::CSINodeDriver {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::storage::v1::CSINodeDriver>
for CSINodeDriverAc {
    fn from_optionable(value: k8s_openapi028::api::storage::v1::CSINodeDriver) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::storage::v1::CSINodeDriver, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storage::v1::CSINodeDriver,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CSINodeDriverAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.allocatable, other.allocatable);
        k8s_openapi028::DeepMerge::merge_from(&mut self.name, other.name);
        k8s_openapi028::DeepMerge::merge_from(&mut self.node_id, other.node_id);
