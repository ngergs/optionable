...
impl crate::Optionable for k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject {
...
for k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject>
for ServiceAccountSubjectAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::ServiceAccountSubject,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServiceAccountSubjectAc {
