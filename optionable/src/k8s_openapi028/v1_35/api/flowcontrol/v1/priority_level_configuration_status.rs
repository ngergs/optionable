...
pub struct PriorityLevelConfigurationStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationCondition as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationStatus,
> for PriorityLevelConfigurationStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PriorityLevelConfigurationStatusAc {
