...
pub struct FlowSchemaStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::flowcontrol::v1::FlowSchemaCondition as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus {
...
for k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus>
for FlowSchemaStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::FlowSchemaStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for FlowSchemaStatusAc {
