...
pub struct PolicyRulesWithSubjectsAc {
    ...
    pub non_resource_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::flowcontrol::v1::NonResourcePolicyRule as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub resource_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::flowcontrol::v1::ResourcePolicyRule as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub subjects: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::flowcontrol::v1::Subject as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::flowcontrol::v1::PolicyRulesWithSubjects {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::PolicyRulesWithSubjects,
> for PolicyRulesWithSubjectsAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::PolicyRulesWithSubjects,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::PolicyRulesWithSubjects,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PolicyRulesWithSubjectsAc {
