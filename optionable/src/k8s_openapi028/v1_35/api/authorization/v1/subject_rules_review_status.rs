...
pub struct SubjectRulesReviewStatusAc {
    ...
    pub non_resource_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::authorization::v1::NonResourceRule as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub resource_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::authorization::v1::ResourceRule as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::authorization::v1::SubjectRulesReviewStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authorization::v1::SubjectRulesReviewStatus,
> for SubjectRulesReviewStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::authorization::v1::SubjectRulesReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authorization::v1::SubjectRulesReviewStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SubjectRulesReviewStatusAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.evaluation_error,
            other.evaluation_error,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.incomplete, other.incomplete);
