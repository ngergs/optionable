...
pub struct FieldSelectorAttributesAc {
    ...
    pub requirements: Option<
        std::vec::Vec<
            <::k8s_openapi028::apimachinery::pkg::apis::meta::v1::FieldSelectorRequirement as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::authorization::v1::FieldSelectorAttributes {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authorization::v1::FieldSelectorAttributes,
> for FieldSelectorAttributesAc {
    fn from_optionable(
        value: k8s_openapi028::api::authorization::v1::FieldSelectorAttributes,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authorization::v1::FieldSelectorAttributes,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for FieldSelectorAttributesAc {
