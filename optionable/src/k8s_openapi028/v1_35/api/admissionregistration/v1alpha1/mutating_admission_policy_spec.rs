...
pub struct MutatingAdmissionPolicySpecAc {
    ...
    pub match_conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1alpha1::MatchCondition as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub match_constraints: Option<
        <::k8s_openapi028::api::admissionregistration::v1alpha1::MatchResources as crate::Optionable>::Optioned,
    >,
    /// mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mutations: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1alpha1::Mutation as crate::Optionable>::Optioned,
        >,
    >,
    /// paramKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If paramKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in MutatingAdmissionPolicyBinding, the params variable will be null.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub param_kind: Option<
        <::k8s_openapi028::api::admissionregistration::v1alpha1::ParamKind as crate::Optionable>::Optioned,
    >,
    ...
    pub variables: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1alpha1::Variable as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec,
> for MutatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::MutatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MutatingAdmissionPolicySpecAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.param_kind, other.param_kind);
        k8s_openapi028::DeepMerge::merge_from(
