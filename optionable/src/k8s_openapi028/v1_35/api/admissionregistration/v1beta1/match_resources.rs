...
pub struct MatchResourcesAc {
    ...
    pub exclude_resource_rules: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1beta1::NamedRuleWithOperations as crate::Optionable>::Optioned,
        >,
    >,
...
for k8s_openapi028::api::admissionregistration::v1beta1::MatchResources {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::MatchResources,
> for MatchResourcesAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::MatchResources,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::MatchResources,
    ) -> Result<(), crate::Error> {
