...
for k8s_openapi028::api::admissionregistration::v1beta1::ApplyConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::ApplyConfiguration,
> for ApplyConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::ApplyConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::ApplyConfiguration,
    ) -> Result<(), crate::Error> {
