...
pub struct MutationAc {
    ...
    pub apply_configuration: Option<
        <::k8s_openapi028::api::admissionregistration::v1beta1::ApplyConfiguration as crate::Optionable>::Optioned,
    >,
    ...
    pub json_patch: Option<
        <::k8s_openapi028::api::admissionregistration::v1beta1::JSONPatch as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::admissionregistration::v1beta1::Mutation {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::Mutation,
> for MutationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::Mutation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::Mutation,
    ) -> Result<(), crate::Error> {
