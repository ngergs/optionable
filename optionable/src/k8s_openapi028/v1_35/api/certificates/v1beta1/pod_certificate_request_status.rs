...
for k8s_openapi028::api::certificates::v1beta1::PodCertificateRequestStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::certificates::v1beta1::PodCertificateRequestStatus,
> for PodCertificateRequestStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::certificates::v1beta1::PodCertificateRequestStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::certificates::v1beta1::PodCertificateRequestStatus,
    ) -> Result<(), crate::Error> {
