...
for k8s_openapi028::api::scheduling::v1alpha1::TypedLocalObjectReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::scheduling::v1alpha1::TypedLocalObjectReference,
> for TypedLocalObjectReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha1::TypedLocalObjectReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha1::TypedLocalObjectReference,
    ) -> Result<(), crate::Error> {
