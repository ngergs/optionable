...
pub struct PodGroupPolicyAc {
    ...
    pub basic: Option<
        <::k8s_openapi028::api::scheduling::v1alpha1::BasicSchedulingPolicy as crate::Optionable>::Optioned,
    >,
    /// Gang specifies that the pods in this group should be scheduled using all-or-nothing semantics.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub gang: Option<
        <::k8s_openapi028::api::scheduling::v1alpha1::GangSchedulingPolicy as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy {
...
for k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy>
for PodGroupPolicyAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha1::PodGroupPolicy,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodGroupPolicyAc {
