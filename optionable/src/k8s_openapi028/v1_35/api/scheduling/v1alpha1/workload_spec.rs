...
pub struct WorkloadSpecAc {
    ...
    pub controller_ref: Option<
        <::k8s_openapi028::api::scheduling::v1alpha1::TypedLocalObjectReference as crate::Optionable>::Optioned,
    >,
    ...
    pub pod_groups: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::scheduling::v1alpha1::PodGroup as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec {
...
for k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec>
for WorkloadSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha1::WorkloadSpec,
    ) -> Result<(), crate::Error> {
