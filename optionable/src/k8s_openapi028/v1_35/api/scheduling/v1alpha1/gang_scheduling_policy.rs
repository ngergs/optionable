...
for k8s_openapi028::api::scheduling::v1alpha1::GangSchedulingPolicy {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::scheduling::v1alpha1::GangSchedulingPolicy,
> for GangSchedulingPolicyAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha1::GangSchedulingPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha1::GangSchedulingPolicy,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for GangSchedulingPolicyAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.min_count, other.min_count);
    }
}
