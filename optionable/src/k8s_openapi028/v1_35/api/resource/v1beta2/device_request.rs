...
pub struct DeviceRequestAc {
    ...
    pub exactly: Option<
        <::k8s_openapi028::api::resource::v1beta2::ExactDeviceRequest as crate::Optionable>::Optioned,
    >,
    ...
    pub first_available: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceSubRequest as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta2::DeviceRequest {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1beta2::DeviceRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta2::DeviceRequest>
for DeviceRequestAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceRequest,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta2::DeviceRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceRequest,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi028::DeepMerge for DeviceRequestAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.exactly, other.exactly);
