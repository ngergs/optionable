...
pub struct CapacityRequestPolicyAc {
    ...
    pub valid_range: Option<
        <::k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicyRange as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicy {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicy,
> for CapacityRequestPolicyAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicy,
    ) -> Result<(), crate::Error> {
