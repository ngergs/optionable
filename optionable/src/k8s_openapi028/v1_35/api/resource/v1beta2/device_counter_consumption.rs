...
for k8s_openapi028::api::resource::v1beta2::DeviceCounterConsumption {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceCounterConsumption,
> for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
