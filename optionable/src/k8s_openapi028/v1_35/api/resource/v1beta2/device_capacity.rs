...
pub struct DeviceCapacityAc {
    ...
    pub request_policy: Option<
        <::k8s_openapi028::api::resource::v1beta2::CapacityRequestPolicy as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta2::DeviceCapacity {
...
for k8s_openapi028::api::resource::v1beta2::DeviceCapacity {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta2::DeviceCapacity>
for DeviceCapacityAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceCapacity,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta2::DeviceCapacity, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceCapacity,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceCapacityAc {
