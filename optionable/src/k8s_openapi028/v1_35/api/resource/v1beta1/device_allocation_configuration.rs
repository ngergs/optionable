...
pub struct DeviceAllocationConfigurationAc {
    ...
    pub opaque: Option<
        <::k8s_openapi028::api::resource::v1beta1::OpaqueDeviceConfiguration as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1beta1::DeviceAllocationConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta1::DeviceAllocationConfiguration,
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
