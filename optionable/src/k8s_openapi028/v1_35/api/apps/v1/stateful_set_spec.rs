...
pub struct StatefulSetSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ordinals: Option<
        <::k8s_openapi028::api::apps::v1::StatefulSetOrdinals as crate::Optionable>::Optioned,
    >,
    ...
    pub persistent_volume_claim_retention_policy: Option<
        <::k8s_openapi028::api::apps::v1::StatefulSetPersistentVolumeClaimRetentionPolicy as crate::Optionable>::Optioned,
    >,
    ...
    pub update_strategy: Option<
        <::k8s_openapi028::api::apps::v1::StatefulSetUpdateStrategy as crate::Optionable>::Optioned,
    >,
    /// volumeClaimTemplates is a list of claims that pods are allowed to reference. The StatefulSet controller is responsible for mapping network identities to claims in a way that maintains the identity of a pod. Every claim in this list must have at least one matching (by name) volumeMount in one container in the template. A claim in this list takes precedence over any volumes in the template, with the same name.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub volume_claim_templates: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PersistentVolumeClaim as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::apps::v1::StatefulSetSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::apps::v1::StatefulSetSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::apps::v1::StatefulSetSpec>
for StatefulSetSpecAc {
    fn from_optionable(value: k8s_openapi028::api::apps::v1::StatefulSetSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::apps::v1::StatefulSetSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apps::v1::StatefulSetSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StatefulSetSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.min_ready_seconds,
            other.min_ready_seconds,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.ordinals, other.ordinals);
        k8s_openapi028::DeepMerge::merge_from(
