...
pub struct ObjectMetricSourceAc {
    ...
    pub described_object: Option<
        <::k8s_openapi028::api::autoscaling::v2::CrossVersionObjectReference as crate::Optionable>::Optioned,
    >,
    /// metric identifies the target metric by name and selector
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metric: Option<
        <::k8s_openapi028::api::autoscaling::v2::MetricIdentifier as crate::Optionable>::Optioned,
    >,
    /// target specifies the target value for the given metric
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target: Option<
        <::k8s_openapi028::api::autoscaling::v2::MetricTarget as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::autoscaling::v2::ObjectMetricSource {
...
for k8s_openapi028::api::autoscaling::v2::ObjectMetricSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::autoscaling::v2::ObjectMetricSource>
for ObjectMetricSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::ObjectMetricSource,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::autoscaling::v2::ObjectMetricSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::ObjectMetricSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ObjectMetricSourceAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.described_object,
            other.described_object,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.metric, other.metric);
        k8s_openapi028::DeepMerge::merge_from(&mut self.target, other.target);
    }
}
