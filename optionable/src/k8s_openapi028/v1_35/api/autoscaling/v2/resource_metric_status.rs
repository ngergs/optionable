...
impl crate::Optionable for k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus {
...
for k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus>
for ResourceMetricStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::ResourceMetricStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ResourceMetricStatusAc {
