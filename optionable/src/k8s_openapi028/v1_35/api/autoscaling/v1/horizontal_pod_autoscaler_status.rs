...
for k8s_openapi028::api::autoscaling::v1::HorizontalPodAutoscalerStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::autoscaling::v1::HorizontalPodAutoscalerStatus,
> for HorizontalPodAutoscalerStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v1::HorizontalPodAutoscalerStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v1::HorizontalPodAutoscalerStatus,
    ) -> Result<(), crate::Error> {
