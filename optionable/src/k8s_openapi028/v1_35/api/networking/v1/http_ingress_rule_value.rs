...
pub struct HTTPIngressRuleValueAc {
    ...
    pub paths: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::networking::v1::HTTPIngressPath as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::networking::v1::HTTPIngressRuleValue {
...
for k8s_openapi028::api::networking::v1::HTTPIngressRuleValue {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::HTTPIngressRuleValue>
for HTTPIngressRuleValueAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::HTTPIngressRuleValue,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::networking::v1::HTTPIngressRuleValue,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::HTTPIngressRuleValue,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HTTPIngressRuleValueAc {
