...
pub struct EnvFromSourceAc {
    ...
    pub config_map_ref: Option<
        <::k8s_openapi028::api::core::v1::ConfigMapEnvSource as crate::Optionable>::Optioned,
    >,
    ...
    pub secret_ref: Option<
        <::k8s_openapi028::api::core::v1::SecretEnvSource as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::EnvFromSource {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::EnvFromSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::EnvFromSource>
for EnvFromSourceAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::EnvFromSource) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::EnvFromSource, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::EnvFromSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for EnvFromSourceAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.config_map_ref,
            other.config_map_ref,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.prefix, other.prefix);
        k8s_openapi028::DeepMerge::merge_from(&mut self.secret_ref, other.secret_ref);
    }
}
