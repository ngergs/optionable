...
pub struct EndpointSubsetAc {
    ...
    pub addresses: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::EndpointAddress as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub ports: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::EndpointPort as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::EndpointSubset {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::EndpointSubset {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::EndpointSubset>
for EndpointSubsetAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::EndpointSubset) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::EndpointSubset, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::EndpointSubset,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for EndpointSubsetAc {
