...
impl crate::Optionable for k8s_openapi028::api::core::v1::PodCertificateProjection {
...
for k8s_openapi028::api::core::v1::PodCertificateProjection {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PodCertificateProjection>
for PodCertificateProjectionAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::PodCertificateProjection,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::PodCertificateProjection, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PodCertificateProjection,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodCertificateProjectionAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.key_path, other.key_path);
        k8s_openapi028::DeepMerge::merge_from(&mut self.key_type, other.key_type);
        k8s_openapi028::DeepMerge::merge_from(
