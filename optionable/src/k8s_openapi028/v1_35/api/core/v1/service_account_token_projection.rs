...
impl crate::Optionable for k8s_openapi028::api::core::v1::ServiceAccountTokenProjection {
...
for k8s_openapi028::api::core::v1::ServiceAccountTokenProjection {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ServiceAccountTokenProjection>
for ServiceAccountTokenProjectionAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::ServiceAccountTokenProjection,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::ServiceAccountTokenProjection,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ServiceAccountTokenProjection,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServiceAccountTokenProjectionAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.audience, other.audience);
