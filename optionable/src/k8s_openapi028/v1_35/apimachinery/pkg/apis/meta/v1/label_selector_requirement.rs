...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement {
...
impl crate::OptionedConvert<
    k8s_openapi028::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
> for LabelSelectorRequirementAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::LabelSelectorRequirement,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for LabelSelectorRequirementAc {
