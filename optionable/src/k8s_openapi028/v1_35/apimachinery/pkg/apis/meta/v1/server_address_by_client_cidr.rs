...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR {
...
impl crate::OptionedConvert<
    k8s_openapi028::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR,
> for ServerAddressByClientCIDRAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::ServerAddressByClientCIDR,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServerAddressByClientCIDRAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.client_cidr, other.client_cidr);
