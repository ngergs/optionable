...
pub struct APIServiceSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: Option<
        <::k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::ServiceReference as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
> for APIServiceSpecAc {
    fn from_optionable(
        value: k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for APIServiceSpecAc {
