...
pub struct APIServiceStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceStatus,
> for APIServiceStatusAc {
    fn from_optionable(
        value: k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for APIServiceStatusAc {
