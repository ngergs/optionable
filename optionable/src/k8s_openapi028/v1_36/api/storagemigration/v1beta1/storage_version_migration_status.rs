...
for k8s_openapi028::api::storagemigration::v1beta1::StorageVersionMigrationStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::storagemigration::v1beta1::StorageVersionMigrationStatus,
> for StorageVersionMigrationStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::storagemigration::v1beta1::StorageVersionMigrationStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storagemigration::v1beta1::StorageVersionMigrationStatus,
    ) -> Result<(), crate::Error> {
