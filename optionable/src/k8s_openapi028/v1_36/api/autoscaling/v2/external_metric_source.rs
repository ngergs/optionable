...
impl crate::Optionable for k8s_openapi028::api::autoscaling::v2::ExternalMetricSource {
...
for k8s_openapi028::api::autoscaling::v2::ExternalMetricSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::autoscaling::v2::ExternalMetricSource>
for ExternalMetricSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::ExternalMetricSource,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::autoscaling::v2::ExternalMetricSource,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::ExternalMetricSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ExternalMetricSourceAc {
