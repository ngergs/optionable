...
pub struct HPAScalingRulesAc {
    ...
    pub policies: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::autoscaling::v2::HPAScalingPolicy as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::autoscaling::v2::HPAScalingRules {
...
impl crate::OptionableConvert for k8s_openapi028::api::autoscaling::v2::HPAScalingRules {
    ...
    fn merge(&mut self, other: HPAScalingRulesAc) -> Result<(), crate::Error> {
        ...
        if self.tolerance.is_none() {
            self.tolerance = crate::OptionableConvert::try_from_optioned(
                other.tolerance,
            )?;
        } else if let Some(self_value) = self.tolerance.as_mut()
            && let Some(other_value) = other.tolerance
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        Ok(())
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::autoscaling::v2::HPAScalingRules>
for HPAScalingRulesAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::HPAScalingRules,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::autoscaling::v2::HPAScalingRules, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::HPAScalingRules,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HPAScalingRulesAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.tolerance, other.tolerance);
    }
}
