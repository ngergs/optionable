...
pub struct LimitedPriorityLevelConfigurationAc {
    ...
    pub limit_response: Option<
        <::k8s_openapi028::api::flowcontrol::v1::LimitResponse as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration {
...
for k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration {
    ...
    fn merge(
        ...
        if self.borrowing_limit_percent.is_none() {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration,
> for LimitedPriorityLevelConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::LimitedPriorityLevelConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for LimitedPriorityLevelConfigurationAc {
