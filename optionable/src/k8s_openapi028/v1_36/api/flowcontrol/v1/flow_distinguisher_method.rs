...
for k8s_openapi028::api::flowcontrol::v1::FlowDistinguisherMethod {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::FlowDistinguisherMethod,
> for FlowDistinguisherMethodAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for FlowDistinguisherMethodAc {
