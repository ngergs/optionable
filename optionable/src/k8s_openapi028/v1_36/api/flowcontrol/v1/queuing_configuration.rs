...
impl crate::Optionable for k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration {
...
for k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration>
for QueuingConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::QueuingConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for QueuingConfigurationAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.hand_size, other.hand_size);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.queue_length_limit,
            other.queue_length_limit,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.queues, other.queues);
    }
}
