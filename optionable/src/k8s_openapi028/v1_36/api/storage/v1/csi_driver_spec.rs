...
pub struct CSIDriverSpecAc {
    ...
    pub token_requests: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::storage::v1::TokenRequest as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::storage::v1::CSIDriverSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::storage::v1::CSIDriverSpec {
    fn into_optioned(self) -> CSIDriverSpecAc {
        CSIDriverSpecAc {
            ...
            prevent_pod_scheduling_if_missing: self.prevent_pod_scheduling_if_missing,
            requires_republish: self.requires_republish,
            se_linux_mount: self.se_linux_mount,
            service_account_token_in_secrets: self.service_account_token_in_secrets,
    ...
    fn try_from_optioned(value: CSIDriverSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            prevent_pod_scheduling_if_missing: value.prevent_pod_scheduling_if_missing,
            requires_republish: value.requires_republish,
            se_linux_mount: value.se_linux_mount,
            service_account_token_in_secrets: value.service_account_token_in_secrets,
    ...
    fn merge(&mut self, other: CSIDriverSpecAc) -> Result<(), crate::Error> {
        ...
        if self.node_allocatable_update_period_seconds.is_none() {
            ...
            .node_allocatable_update_period_seconds
            .as_mut()
            && let Some(other_value) = other.node_allocatable_update_period_seconds
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        if self.prevent_pod_scheduling_if_missing.is_none() {
            self.prevent_pod_scheduling_if_missing = crate::OptionableConvert::try_from_optioned(
                other.prevent_pod_scheduling_if_missing,
            )?;
        } else if let Some(self_value) = self.prevent_pod_scheduling_if_missing.as_mut()
            && let Some(other_value) = other.prevent_pod_scheduling_if_missing
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        if self.service_account_token_in_secrets.is_none() {
            self.service_account_token_in_secrets = crate::OptionableConvert::try_from_optioned(
                other.service_account_token_in_secrets,
            )?;
        } else if let Some(self_value) = self.service_account_token_in_secrets.as_mut()
            && let Some(other_value) = other.service_account_token_in_secrets
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::storage::v1::CSIDriverSpec>
for CSIDriverSpecAc {
    fn from_optionable(value: k8s_openapi028::api::storage::v1::CSIDriverSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::storage::v1::CSIDriverSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storage::v1::CSIDriverSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CSIDriverSpecAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.prevent_pod_scheduling_if_missing,
            other.prevent_pod_scheduling_if_missing,
        );
        k8s_openapi028::DeepMerge::merge_from(
