...
for k8s_openapi028::api::apps::v1::RollingUpdateStatefulSetStrategy {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::apps::v1::RollingUpdateStatefulSetStrategy,
> for RollingUpdateStatefulSetStrategyAc {
    fn from_optionable(
        value: k8s_openapi028::api::apps::v1::RollingUpdateStatefulSetStrategy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apps::v1::RollingUpdateStatefulSetStrategy,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for RollingUpdateStatefulSetStrategyAc {
