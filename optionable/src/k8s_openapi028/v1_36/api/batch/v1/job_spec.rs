...
pub struct JobSpecAc {
    ...
    pub pod_failure_policy: Option<
        <::k8s_openapi028::api::batch::v1::PodFailurePolicy as crate::Optionable>::Optioned,
    >,
    ...
    pub success_policy: Option<
        <::k8s_openapi028::api::batch::v1::SuccessPolicy as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::batch::v1::JobSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::batch::v1::JobSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::batch::v1::JobSpec> for JobSpecAc {
    fn from_optionable(value: k8s_openapi028::api::batch::v1::JobSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::batch::v1::JobSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::batch::v1::JobSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for JobSpecAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.completions, other.completions);
        k8s_openapi028::DeepMerge::merge_from(&mut self.managed_by, other.managed_by);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.parallelism, other.parallelism);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.suspend, other.suspend);
