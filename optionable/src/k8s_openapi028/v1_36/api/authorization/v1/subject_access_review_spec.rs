...
pub struct SubjectAccessReviewSpecAc {
    ...
    pub non_resource_attributes: Option<
        <::k8s_openapi028::api::authorization::v1::NonResourceAttributes as crate::Optionable>::Optioned,
    >,
    /// resourceAttributes describes information for a resource access request
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_attributes: Option<
        <::k8s_openapi028::api::authorization::v1::ResourceAttributes as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::authorization::v1::SubjectAccessReviewSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authorization::v1::SubjectAccessReviewSpec,
> for SubjectAccessReviewSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::authorization::v1::SubjectAccessReviewSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authorization::v1::SubjectAccessReviewSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SubjectAccessReviewSpecAc {
