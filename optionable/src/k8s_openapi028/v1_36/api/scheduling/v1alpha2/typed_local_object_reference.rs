...
for k8s_openapi028::api::scheduling::v1alpha2::TypedLocalObjectReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::scheduling::v1alpha2::TypedLocalObjectReference,
> for TypedLocalObjectReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha2::TypedLocalObjectReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha2::TypedLocalObjectReference,
    ) -> Result<(), crate::Error> {
