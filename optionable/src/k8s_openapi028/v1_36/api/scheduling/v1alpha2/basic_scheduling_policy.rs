...
for k8s_openapi028::api::scheduling::v1alpha2::BasicSchedulingPolicy {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::scheduling::v1alpha2::BasicSchedulingPolicy,
> for BasicSchedulingPolicyAc {
    fn from_optionable(
        value: k8s_openapi028::api::scheduling::v1alpha2::BasicSchedulingPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::scheduling::v1alpha2::BasicSchedulingPolicy,
    ) -> Result<(), crate::Error> {
