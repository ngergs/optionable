...
for k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicyBindingSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicyBindingSpec,
> for MutatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
