...
pub struct MutatingAdmissionPolicySpecAc {
    ...
    pub mutations: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::admissionregistration::v1::Mutation as crate::Optionable>::Optioned,
        >,
    >,
...
for k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicySpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicySpec,
> for MutatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::MutatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
