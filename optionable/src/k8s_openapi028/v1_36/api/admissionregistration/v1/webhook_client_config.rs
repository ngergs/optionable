...
pub struct WebhookClientConfigAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: Option<
        <::k8s_openapi028::api::admissionregistration::v1::ServiceReference as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::admissionregistration::v1::WebhookClientConfig {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::WebhookClientConfig,
> for WebhookClientConfigAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::WebhookClientConfig,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::WebhookClientConfig,
    ) -> Result<(), crate::Error> {
