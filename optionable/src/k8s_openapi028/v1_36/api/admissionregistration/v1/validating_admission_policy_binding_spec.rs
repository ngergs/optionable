...
pub struct ValidatingAdmissionPolicyBindingSpecAc {
    ...
    pub param_ref: Option<
        <::k8s_openapi028::api::admissionregistration::v1::ParamRef as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec {
...
for k8s_openapi028::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec {
    fn into_optioned(self) -> ValidatingAdmissionPolicyBindingSpecAc {
        ValidatingAdmissionPolicyBindingSpecAc {
            ...
            validation_actions: Some(self.validation_actions),
        }
    }
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            policy_name: value
                .policy_name
                .ok_or(crate::Error {
                    missing_field: "policy_name",
                })?,
            validation_actions: value
                .validation_actions
                .ok_or(crate::Error {
                    missing_field: "validation_actions",
                })?,
        })
    }
    fn merge(
        ...
        if let Some(other_value) = other.policy_name {
            self.policy_name = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec,
> for ValidatingAdmissionPolicyBindingSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ValidatingAdmissionPolicyBindingSpecAc {
    fn merge_from(&mut self, other: Self) {
        self.match_resources = other.match_resources;
        self.param_ref = other.param_ref;
        k8s_openapi028::DeepMerge::merge_from(&mut self.policy_name, other.policy_name);
