...
for k8s_openapi028::api::admissionregistration::v1::RuleWithOperations {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1::RuleWithOperations,
> for RuleWithOperationsAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::RuleWithOperations,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::RuleWithOperations,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for RuleWithOperationsAc {
