...
pub struct MutationAc {
    ...
    pub apply_configuration: Option<
        <::k8s_openapi028::api::admissionregistration::v1::ApplyConfiguration as crate::Optionable>::Optioned,
    >,
    ...
    pub json_patch: Option<
        <::k8s_openapi028::api::admissionregistration::v1::JSONPatch as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::admissionregistration::v1::Mutation {
...
for k8s_openapi028::api::admissionregistration::v1::Mutation {
    ...
    fn merge(&mut self, other: MutationAc) -> Result<(), crate::Error> {
        ...
        } else if let Some(self_value) = self.apply_configuration.as_mut()
            && let Some(other_value) = other.apply_configuration
        {
        ...
        } else if let Some(self_value) = self.json_patch.as_mut()
            && let Some(other_value) = other.json_patch
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::admissionregistration::v1::Mutation>
for MutationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1::Mutation,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::admissionregistration::v1::Mutation, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1::Mutation,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MutationAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.apply_configuration,
            other.apply_configuration,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.json_patch, other.json_patch);
        k8s_openapi028::DeepMerge::merge_from(&mut self.patch_type, other.patch_type);
    }
}
