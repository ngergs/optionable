...
for k8s_openapi028::api::admissionregistration::v1alpha1::ApplyConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::ApplyConfiguration,
> for ApplyConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::ApplyConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::ApplyConfiguration,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ApplyConfigurationAc {
