...
for k8s_openapi028::api::admissionregistration::v1beta1::ParamKind {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1beta1::ParamKind,
> for ParamKindAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1beta1::ParamKind,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1beta1::ParamKind,
    ) -> Result<(), crate::Error> {
