...
pub struct CounterSetAc {
    ...
    pub counters: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1beta1::Counter as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta1::CounterSet {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1beta1::CounterSet {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta1::CounterSet>
for CounterSetAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::CounterSet,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta1::CounterSet, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::CounterSet,
    ) -> Result<(), crate::Error> {
