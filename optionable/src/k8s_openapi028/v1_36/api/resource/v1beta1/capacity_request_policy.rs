...
pub struct CapacityRequestPolicyAc {
    ...
    pub valid_range: Option<
        <::k8s_openapi028::api::resource::v1beta1::CapacityRequestPolicyRange as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1beta1::CapacityRequestPolicy {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta1::CapacityRequestPolicy,
> for CapacityRequestPolicyAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::CapacityRequestPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::CapacityRequestPolicy,
    ) -> Result<(), crate::Error> {
