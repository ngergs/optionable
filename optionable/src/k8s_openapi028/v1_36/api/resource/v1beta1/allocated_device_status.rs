...
pub struct AllocatedDeviceStatusAc {
    ...
    pub network_data: Option<
        <::k8s_openapi028::api::resource::v1beta1::NetworkDeviceData as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1beta1::AllocatedDeviceStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta1::AllocatedDeviceStatus,
> for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::AllocatedDeviceStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
