...
pub struct BasicDeviceAc {
    ...
    pub attributes: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1beta1::DeviceAttribute as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub capacity: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1beta1::DeviceCapacity as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub consumes_counters: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta1::DeviceCounterConsumption as crate::Optionable>::Optioned,
        >,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub node_allocatable_resource_mappings: Option<
        std::collections::BTreeMap<
            std::string::String,
            <::k8s_openapi028::api::resource::v1beta1::NodeAllocatableResourceMapping as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub taints: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta1::DeviceTaint as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::resource::v1beta1::BasicDevice {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1beta1::BasicDevice {
    fn into_optioned(self) -> BasicDeviceAc {
        BasicDeviceAc {
            ...
            node_allocatable_resource_mappings: crate::OptionableConvert::into_optioned(
    ...
    fn try_from_optioned(value: BasicDeviceAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            node_allocatable_resource_mappings: crate::OptionableConvert::try_from_optioned(
                value.node_allocatable_resource_mappings,
            )?,
    ...
    fn merge(&mut self, other: BasicDeviceAc) -> Result<(), crate::Error> {
        ...
        if self.node_allocatable_resource_mappings.is_none() {
            self.node_allocatable_resource_mappings = crate::OptionableConvert::try_from_optioned(
                other.node_allocatable_resource_mappings,
            )?;
        } else if let Some(self_value) = self.node_allocatable_resource_mappings.as_mut()
            && let Some(other_value) = other.node_allocatable_resource_mappings
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta1::BasicDevice>
for BasicDeviceAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::BasicDevice,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta1::BasicDevice, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::BasicDevice,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for BasicDeviceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::k8s_openapi::merge::merge_granular_option_wrapped(
            &mut self.node_allocatable_resource_mappings,
            other.node_allocatable_resource_mappings,
        );
