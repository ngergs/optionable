...
pub struct ResourceClaimStatusAc {
    ...
    pub allocation: Option<
        <::k8s_openapi028::api::resource::v1beta1::AllocationResult as crate::Optionable>::Optioned,
    >,
    /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta1::AllocatedDeviceStatus as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub reserved_for: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta1::ResourceClaimConsumerReference as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus {
...
for k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus>
for ResourceClaimStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::ResourceClaimStatus,
    ) -> Result<(), crate::Error> {
