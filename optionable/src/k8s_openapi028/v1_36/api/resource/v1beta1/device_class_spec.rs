...
pub struct DeviceClassSpecAc {
    ...
    pub config: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta1::DeviceClassConfiguration as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta1::DeviceClassSpec {
...
for k8s_openapi028::api::resource::v1beta1::DeviceClassSpec {
    ...
    fn merge(&mut self, other: DeviceClassSpecAc) -> Result<(), crate::Error> {
        ...
        } else if let Some(self_value) = self.extended_resource_name.as_mut()
            && let Some(other_value) = other.extended_resource_name
        {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta1::DeviceClassSpec>
for DeviceClassSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta1::DeviceClassSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1beta1::DeviceClassSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta1::DeviceClassSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceClassSpecAc {
