...
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::DeviceTaint {
...
impl crate::OptionableConvert for k8s_openapi028::api::resource::v1alpha3::DeviceTaint {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::DeviceTaint>
for DeviceTaintAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceTaint,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::resource::v1alpha3::DeviceTaint, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceTaint,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceTaintAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.effect, other.effect);
        k8s_openapi028::DeepMerge::merge_from(&mut self.key, other.key);
        k8s_openapi028::DeepMerge::merge_from(&mut self.time_added, other.time_added);
