...
for k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleStatus,
> for DeviceTaintRuleStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceTaintRuleStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for DeviceTaintRuleStatusAc {
