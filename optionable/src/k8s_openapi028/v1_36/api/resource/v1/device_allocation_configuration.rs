...
for k8s_openapi028::api::resource::v1::DeviceAllocationConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1::DeviceAllocationConfiguration,
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
