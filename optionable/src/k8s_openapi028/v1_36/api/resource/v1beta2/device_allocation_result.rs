...
pub struct DeviceAllocationResultAc {
    ...
    pub config: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceAllocationConfiguration as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub results: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::resource::v1beta2::DeviceRequestAllocationResult as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::resource::v1beta2::DeviceAllocationResult {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceAllocationResult,
> for DeviceAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceAllocationResult,
    ) -> Result<(), crate::Error> {
