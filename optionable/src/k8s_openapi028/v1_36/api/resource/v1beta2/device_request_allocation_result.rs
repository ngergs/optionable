...
for k8s_openapi028::api::resource::v1beta2::DeviceRequestAllocationResult {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceRequestAllocationResult,
> for DeviceRequestAllocationResultAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceRequestAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceRequestAllocationResult,
    ) -> Result<(), crate::Error> {
