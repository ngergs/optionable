...
for k8s_openapi028::api::resource::v1beta2::NodeAllocatableResourceMapping {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::NodeAllocatableResourceMapping,
> for NodeAllocatableResourceMappingAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::NodeAllocatableResourceMapping,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::NodeAllocatableResourceMapping,
    ) -> Result<(), crate::Error> {
