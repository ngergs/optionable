...
for k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleStatus,
> for DeviceTaintRuleStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleStatus,
    ) -> Result<(), crate::Error> {
