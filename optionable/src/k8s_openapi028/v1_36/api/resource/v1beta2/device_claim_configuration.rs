...
for k8s_openapi028::api::resource::v1beta2::DeviceClaimConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1beta2::DeviceClaimConfiguration,
> for DeviceClaimConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceClaimConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceClaimConfiguration,
    ) -> Result<(), crate::Error> {
