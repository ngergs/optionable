...
pub struct DeviceTaintRuleSpecAc {
    ...
    pub device_selector: Option<
        <::k8s_openapi028::api::resource::v1beta2::DeviceTaintSelector as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec {
...
for k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec>
for DeviceTaintRuleSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1beta2::DeviceTaintRuleSpec,
    ) -> Result<(), crate::Error> {
