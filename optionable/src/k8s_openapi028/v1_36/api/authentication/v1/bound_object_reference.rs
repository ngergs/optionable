...
for k8s_openapi028::api::authentication::v1::BoundObjectReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authentication::v1::BoundObjectReference,
> for BoundObjectReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::authentication::v1::BoundObjectReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authentication::v1::BoundObjectReference,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for BoundObjectReferenceAc {
