...
impl crate::Optionable for k8s_openapi028::api::core::v1::WindowsSecurityContextOptions {
...
for k8s_openapi028::api::core::v1::WindowsSecurityContextOptions {
    ...
    fn merge(
        ...
        } else if let Some(self_value) = self.gmsa_credential_spec.as_mut()
            && let Some(other_value) = other.gmsa_credential_spec
        {
        ...
        } else if let Some(self_value) = self.gmsa_credential_spec_name.as_mut()
            && let Some(other_value) = other.gmsa_credential_spec_name
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        } else if let Some(self_value) = self.host_process.as_mut()
            && let Some(other_value) = other.host_process
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        ...
        } else if let Some(self_value) = self.run_as_user_name.as_mut()
            && let Some(other_value) = other.run_as_user_name
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        Ok(())
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::WindowsSecurityContextOptions>
for WindowsSecurityContextOptionsAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::WindowsSecurityContextOptions,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::WindowsSecurityContextOptions,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::WindowsSecurityContextOptions,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for WindowsSecurityContextOptionsAc {
