...
pub struct NodeSpecAc {
    ...
    pub config_source: Option<
        <::k8s_openapi028::api::core::v1::NodeConfigSource as crate::Optionable>::Optioned,
    >,
    ...
    pub taints: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::Taint as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::NodeSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::NodeSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::NodeSpec> for NodeSpecAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::NodeSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::NodeSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::NodeSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NodeSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.config_source,
            other.config_source,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.external_id, other.external_id);
        k8s_openapi028::DeepMerge::merge_from(&mut self.pod_cidr, other.pod_cidr);
        crate::merge::merge_append_not_present_option_wrapped(
            &mut self.pod_cidrs,
            other.pod_cidrs,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.provider_id, other.provider_id);
