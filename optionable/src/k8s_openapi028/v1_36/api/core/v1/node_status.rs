...
pub struct NodeStatusAc {
    ...
    pub addresses: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::NodeAddress as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::NodeCondition as crate::Optionable>::Optioned,
        >,
    >,
    /// Status of the config assigned to the node via the dynamic Kubelet config feature.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub config: Option<
        <::k8s_openapi028::api::core::v1::NodeConfigStatus as crate::Optionable>::Optioned,
    >,
    /// Endpoints of daemons running on the Node.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub daemon_endpoints: Option<
        <::k8s_openapi028::api::core::v1::NodeDaemonEndpoints as crate::Optionable>::Optioned,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<
        <::k8s_openapi028::api::core::v1::NodeFeatures as crate::Optionable>::Optioned,
    >,
    /// List of container images on this node
    #[serde(skip_serializing_if = "Option::is_none")]
    pub images: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ContainerImage as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub node_info: Option<
        <::k8s_openapi028::api::core::v1::NodeSystemInfo as crate::Optionable>::Optioned,
    >,
    ...
    pub runtime_handlers: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::NodeRuntimeHandler as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub volumes_attached: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::AttachedVolume as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::NodeStatus {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::NodeStatus {
    ...
    fn merge(&mut self, other: NodeStatusAc) -> Result<(), crate::Error> {
        ...
        if self.declared_features.is_none() {
            self.declared_features = crate::OptionableConvert::try_from_optioned(
                other.declared_features,
            )?;
        } else if let Some(self_value) = self.declared_features.as_mut()
            && let Some(other_value) = other.declared_features
        {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::NodeStatus> for NodeStatusAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::NodeStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::NodeStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::NodeStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NodeStatusAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.config, other.config);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.daemon_endpoints,
            other.daemon_endpoints,
        );
        self.declared_features = other.declared_features;
        k8s_openapi028::DeepMerge::merge_from(&mut self.features, other.features);
        self.images = other.images;
        k8s_openapi028::DeepMerge::merge_from(&mut self.node_info, other.node_info);
