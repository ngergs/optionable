...
pub struct PodDNSConfigAc {
    ...
    pub options: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PodDNSConfigOption as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::PodDNSConfig {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::PodDNSConfig {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PodDNSConfig>
for PodDNSConfigAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::PodDNSConfig) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::PodDNSConfig, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PodDNSConfig,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodDNSConfigAc {
