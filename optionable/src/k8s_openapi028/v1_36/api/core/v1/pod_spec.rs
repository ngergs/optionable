...
pub struct PodSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub affinity: Option<
        <::k8s_openapi028::api::core::v1::Affinity as crate::Optionable>::Optioned,
    >,
    ...
    pub containers: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::Container as crate::Optionable>::Optioned,
        >,
    >,
    /// Specifies the DNS parameters of a pod. Parameters specified here will be merged to the generated DNS configuration based on DNSPolicy.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dns_config: Option<
        <::k8s_openapi028::api::core::v1::PodDNSConfig as crate::Optionable>::Optioned,
    >,
    ...
    pub ephemeral_containers: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::EphemeralContainer as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub host_aliases: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::HostAlias as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub image_pull_secrets: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::LocalObjectReference as crate::Optionable>::Optioned,
        >,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub os: Option<
        <::k8s_openapi028::api::core::v1::PodOS as crate::Optionable>::Optioned,
    >,
    ...
    pub readiness_gates: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PodReadinessGate as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub resource_claims: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PodResourceClaim as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub resources: Option<
        <::k8s_openapi028::api::core::v1::ResourceRequirements as crate::Optionable>::Optioned,
    >,
    ...
    pub scheduling_gates: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PodSchedulingGate as crate::Optionable>::Optioned,
        >,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scheduling_group: Option<
        <::k8s_openapi028::api::core::v1::PodSchedulingGroup as crate::Optionable>::Optioned,
    >,
    /// SecurityContext holds pod-level security attributes and common container settings. Optional: Defaults to empty.  See type description for default values of each field.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_context: Option<
        <::k8s_openapi028::api::core::v1::PodSecurityContext as crate::Optionable>::Optioned,
    >,
    ...
    pub tolerations: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::Toleration as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub topology_spread_constraints: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::TopologySpreadConstraint as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub volumes: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::Volume as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::PodSpec {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::PodSpec {
    fn into_optioned(self) -> PodSpecAc {
        PodSpecAc {
            ...
            scheduling_group: crate::OptionableConvert::into_optioned(
                self.scheduling_group,
            ),
    ...
    fn try_from_optioned(value: PodSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            scheduling_group: crate::OptionableConvert::try_from_optioned(
    ...
    fn merge(&mut self, other: PodSpecAc) -> Result<(), crate::Error> {
        ...
        if self.scheduling_group.is_none() {
            self.scheduling_group = crate::OptionableConvert::try_from_optioned(
                other.scheduling_group,
            )?;
        } else if let Some(self_value) = self.scheduling_group.as_mut()
            && let Some(other_value) = other.scheduling_group
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::PodSpec> for PodSpecAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::PodSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::PodSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::PodSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.active_deadline_seconds,
            other.active_deadline_seconds,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.affinity, other.affinity);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.dns_config, other.dns_config);
        k8s_openapi028::DeepMerge::merge_from(&mut self.dns_policy, other.dns_policy);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.host_ipc, other.host_ipc);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.host_network,
            other.host_network,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.host_pid, other.host_pid);
        k8s_openapi028::DeepMerge::merge_from(&mut self.host_users, other.host_users);
        k8s_openapi028::DeepMerge::merge_from(&mut self.hostname, other.hostname);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.os, other.os);
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.resources, other.resources);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.subdomain, other.subdomain);
        k8s_openapi028::DeepMerge::merge_from(
