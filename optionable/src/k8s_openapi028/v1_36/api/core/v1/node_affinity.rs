...
pub struct NodeAffinityAc {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::PreferredSchedulingTerm as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::NodeAffinity {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::NodeAffinity {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::NodeAffinity>
for NodeAffinityAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::NodeAffinity) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::NodeAffinity, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::NodeAffinity,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NodeAffinityAc {
