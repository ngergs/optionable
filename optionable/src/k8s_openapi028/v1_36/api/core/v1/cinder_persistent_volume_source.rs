...
impl crate::Optionable for k8s_openapi028::api::core::v1::CinderPersistentVolumeSource {
...
for k8s_openapi028::api::core::v1::CinderPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::CinderPersistentVolumeSource>
for CinderPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::CinderPersistentVolumeSource,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::CinderPersistentVolumeSource,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::CinderPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CinderPersistentVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.volume_id, other.volume_id);
    }
}
