...
impl crate::Optionable for k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource {
...
for k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource>
for ScaleIOPersistentVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ScaleIOPersistentVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ScaleIOPersistentVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.fs_type, other.fs_type);
        k8s_openapi028::DeepMerge::merge_from(&mut self.gateway, other.gateway);
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.ssl_enabled, other.ssl_enabled);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.system, other.system);
        k8s_openapi028::DeepMerge::merge_from(&mut self.volume_name, other.volume_name);
    }
}
