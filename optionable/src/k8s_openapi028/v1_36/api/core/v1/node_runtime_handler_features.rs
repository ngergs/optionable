...
impl crate::Optionable for k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures {
...
for k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures>
for NodeRuntimeHandlerFeaturesAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::NodeRuntimeHandlerFeatures,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NodeRuntimeHandlerFeaturesAc {
