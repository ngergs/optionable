...
pub struct HTTPGetActionAc {
    ...
    pub http_headers: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::HTTPHeader as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::HTTPGetAction {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::HTTPGetAction {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::HTTPGetAction>
for HTTPGetActionAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::HTTPGetAction) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::HTTPGetAction, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::HTTPGetAction,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HTTPGetActionAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.scheme, other.scheme);
    }
}
