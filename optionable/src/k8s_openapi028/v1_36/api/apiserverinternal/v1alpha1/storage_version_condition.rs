...
for k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionCondition,
> for StorageVersionConditionAc {
    fn from_optionable(
        value: k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StorageVersionConditionAc {
