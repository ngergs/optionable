...
for k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion {
...
for k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion {
    fn into_optioned(self) -> ServerStorageVersionAc {
        ServerStorageVersionAc {
            ...
            decodable_versions: Some(self.decodable_versions),
            encoding_version: Some(self.encoding_version),
    ...
    fn try_from_optioned(value: ServerStorageVersionAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            decodable_versions: value
                .decodable_versions
                .ok_or(crate::Error {
                    missing_field: "decodable_versions",
                })?,
            encoding_version: value
                .encoding_version
                .ok_or(crate::Error {
                    missing_field: "encoding_version",
                })?,
    ...
    fn merge(&mut self, other: ServerStorageVersionAc) -> Result<(), crate::Error> {
        ...
        if let Some(other_value) = other.decodable_versions {
            crate::merge::try_merge_optioned_set(
                &mut self.decodable_versions,
                other_value,
            )?;
        }
        if let Some(other_value) = other.encoding_version {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion,
> for ServerStorageVersionAc {
    fn from_optionable(
        value: k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ServerStorageVersionAc {
