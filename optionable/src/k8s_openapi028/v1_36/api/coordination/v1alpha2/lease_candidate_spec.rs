...
for k8s_openapi028::api::coordination::v1alpha2::LeaseCandidateSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::coordination::v1alpha2::LeaseCandidateSpec,
> for LeaseCandidateSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::coordination::v1alpha2::LeaseCandidateSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::coordination::v1alpha2::LeaseCandidateSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for LeaseCandidateSpecAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.lease_name, other.lease_name);
        k8s_openapi028::DeepMerge::merge_from(&mut self.ping_time, other.ping_time);
