...
pub struct NetworkPolicyPeerAc {
    ...
    pub ip_block: Option<
        <::k8s_openapi028::api::networking::v1::IPBlock as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::networking::v1::NetworkPolicyPeer {
...
for k8s_openapi028::api::networking::v1::NetworkPolicyPeer {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::NetworkPolicyPeer>
for NetworkPolicyPeerAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::NetworkPolicyPeer,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::networking::v1::NetworkPolicyPeer, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::NetworkPolicyPeer,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NetworkPolicyPeerAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.ip_block, other.ip_block);
