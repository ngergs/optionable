...
pub struct ListMetaAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shard_info: Option<
        <::k8s_openapi028::apimachinery::pkg::apis::meta::v1::ShardInfo as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta {
...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta {
    fn into_optioned(self) -> ListMetaAc {
        ListMetaAc {
            ...
            shard_info: crate::OptionableConvert::into_optioned(self.shard_info),
        }
    }
    fn try_from_optioned(value: ListMetaAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            shard_info: crate::OptionableConvert::try_from_optioned(value.shard_info)?,
        })
    }
    fn merge(&mut self, other: ListMetaAc) -> Result<(), crate::Error> {
        ...
        if self.shard_info.is_none() {
            self.shard_info = crate::OptionableConvert::try_from_optioned(
                other.shard_info,
            )?;
        } else if let Some(self_value) = self.shard_info.as_mut()
            && let Some(other_value) = other.shard_info
        {
            crate::OptionableConvert::merge(self_value, other_value)?;
        }
        Ok(())
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta>
for ListMetaAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::ListMeta,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ListMetaAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.continue_, other.continue_);
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.shard_info, other.shard_info);
    }
}
