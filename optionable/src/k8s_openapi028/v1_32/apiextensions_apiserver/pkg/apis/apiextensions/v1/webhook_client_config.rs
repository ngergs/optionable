...
pub struct WebhookClientConfigAc {
    ...
    pub ca_bundle: Option<<::k8s_openapi028::ByteString as crate::Optionable>::Optioned>,
    /// service is a reference to the service for this webhook. Either service or url must be specified.
    ///
    /// If the webhook is running within the cluster, then you should use `service`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: Option<
        <::k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::ServiceReference as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig {
...
impl crate::OptionedConvert<
    k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
> for WebhookClientConfigAc {
    fn from_optionable(
        value: k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apiextensions_apiserver::pkg::apis::apiextensions::v1::WebhookClientConfig,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for WebhookClientConfigAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.ca_bundle, other.ca_bundle);
        k8s_openapi028::DeepMerge::merge_from(&mut self.service, other.service);
        k8s_openapi028::DeepMerge::merge_from(&mut self.url, other.url);
    }
}
