...
for k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition,
> for APIServiceConditionAc {
    fn from_optionable(
        value: k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for APIServiceConditionAc {
...
impl crate::merge::MapKeysEq for APIServiceConditionAc {
