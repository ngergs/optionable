...
pub struct APIGroupAc {
    ...
    pub preferred_version: Option<
        <::k8s_openapi028::apimachinery::pkg::apis::meta::v1::GroupVersionForDiscovery as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup {
...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup>
for APIGroupAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::Resource for APIGroupAc {
    const API_VERSION: &'static str = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi028::apimachinery::pkg::apis::meta::v1::APIGroup as k8s_openapi028::Resource>::Scope;
}
...
impl k8s_openapi028::DeepMerge for APIGroupAc {
