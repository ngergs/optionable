...
pub enum PatchAc {
    Json(
        ...
        Option<
            std::vec::Vec<
                <::k8s_openapi028::serde_json::Value as crate::Optionable>::Optioned,
            >,
        >,
    ),
    Merge(
        #[serde(skip_serializing_if = "Option::is_none")]
        Option<<::k8s_openapi028::serde_json::Value as crate::Optionable>::Optioned>,
    ),
    StrategicMerge(
        #[serde(skip_serializing_if = "Option::is_none")]
        Option<<::k8s_openapi028::serde_json::Value as crate::Optionable>::Optioned>,
...
impl crate::Optionable for k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch {
...
for k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch>
for PatchAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::apis::meta::v1::Patch,
    ) -> Result<(), crate::Error> {
