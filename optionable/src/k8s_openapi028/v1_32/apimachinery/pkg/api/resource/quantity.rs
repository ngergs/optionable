...
impl crate::Optionable for k8s_openapi028::apimachinery::pkg::api::resource::Quantity {
...
for k8s_openapi028::apimachinery::pkg::api::resource::Quantity {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::apimachinery::pkg::api::resource::Quantity>
for QuantityAc {
    fn from_optionable(
        value: k8s_openapi028::apimachinery::pkg::api::resource::Quantity,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::apimachinery::pkg::api::resource::Quantity,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::apimachinery::pkg::api::resource::Quantity,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for QuantityAc {
