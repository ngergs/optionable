...
impl crate::Optionable for k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec {
...
for k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec>
for PodDisruptionBudgetSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::policy::v1::PodDisruptionBudgetSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PodDisruptionBudgetSpecAc {
