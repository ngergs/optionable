...
for k8s_openapi028::api::networking::v1::NetworkPolicyIngressRule {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::networking::v1::NetworkPolicyIngressRule,
> for NetworkPolicyIngressRuleAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::NetworkPolicyIngressRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::NetworkPolicyIngressRule,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NetworkPolicyIngressRuleAc {
