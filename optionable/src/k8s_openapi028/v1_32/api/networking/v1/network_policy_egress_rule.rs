...
pub struct NetworkPolicyEgressRuleAc {
    ...
    pub ports: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::networking::v1::NetworkPolicyPort as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub to: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::networking::v1::NetworkPolicyPeer as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule {
...
for k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule>
for NetworkPolicyEgressRuleAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1::NetworkPolicyEgressRule,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for NetworkPolicyEgressRuleAc {
