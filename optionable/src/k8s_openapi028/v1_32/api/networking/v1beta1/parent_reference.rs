...
impl crate::Optionable for k8s_openapi028::api::networking::v1beta1::ParentReference {
...
for k8s_openapi028::api::networking::v1beta1::ParentReference {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::networking::v1beta1::ParentReference>
for ParentReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::networking::v1beta1::ParentReference,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::networking::v1beta1::ParentReference,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::networking::v1beta1::ParentReference,
    ) -> Result<(), crate::Error> {
