...
impl crate::Optionable for k8s_openapi028::api::batch::v1::UncountedTerminatedPods {
...
for k8s_openapi028::api::batch::v1::UncountedTerminatedPods {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::batch::v1::UncountedTerminatedPods>
for UncountedTerminatedPodsAc {
    fn from_optionable(
        value: k8s_openapi028::api::batch::v1::UncountedTerminatedPods,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::batch::v1::UncountedTerminatedPods, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::batch::v1::UncountedTerminatedPods,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for UncountedTerminatedPodsAc {
