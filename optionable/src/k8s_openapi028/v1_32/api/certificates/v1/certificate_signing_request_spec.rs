...
pub struct CertificateSigningRequestSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub request: Option<<::k8s_openapi028::ByteString as crate::Optionable>::Optioned>,
...
for k8s_openapi028::api::certificates::v1::CertificateSigningRequestSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::certificates::v1::CertificateSigningRequestSpec,
> for CertificateSigningRequestSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CertificateSigningRequestSpecAc {
