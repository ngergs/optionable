...
for k8s_openapi028::api::certificates::v1::CertificateSigningRequestCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::certificates::v1::CertificateSigningRequestCondition,
> for CertificateSigningRequestConditionAc {
    fn from_optionable(
        value: k8s_openapi028::api::certificates::v1::CertificateSigningRequestCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::certificates::v1::CertificateSigningRequestCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for CertificateSigningRequestConditionAc {
