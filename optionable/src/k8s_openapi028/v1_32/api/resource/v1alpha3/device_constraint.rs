...
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::DeviceConstraint {
...
for k8s_openapi028::api::resource::v1alpha3::DeviceConstraint {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::DeviceConstraint>
for DeviceConstraintAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::DeviceConstraint,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1alpha3::DeviceConstraint,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::DeviceConstraint,
    ) -> Result<(), crate::Error> {
