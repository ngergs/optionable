...
pub struct AllocationResultAc {
    ...
    pub devices: Option<
        <::k8s_openapi028::api::resource::v1alpha3::DeviceAllocationResult as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi028::api::resource::v1alpha3::AllocationResult {
...
for k8s_openapi028::api::resource::v1alpha3::AllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::resource::v1alpha3::AllocationResult>
for AllocationResultAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::AllocationResult,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi028::api::resource::v1alpha3::AllocationResult,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::AllocationResult,
    ) -> Result<(), crate::Error> {
