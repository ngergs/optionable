...
for k8s_openapi028::api::resource::v1alpha3::ResourceClaimConsumerReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1alpha3::ResourceClaimConsumerReference,
> for ResourceClaimConsumerReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::ResourceClaimConsumerReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::ResourceClaimConsumerReference,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ResourceClaimConsumerReferenceAc {
