...
pub struct AllocatedDeviceStatusAc {
    ...
    pub network_data: Option<
        <::k8s_openapi028::api::resource::v1alpha3::NetworkDeviceData as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi028::api::resource::v1alpha3::AllocatedDeviceStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1alpha3::AllocatedDeviceStatus,
> for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::AllocatedDeviceStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
