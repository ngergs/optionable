...
for k8s_openapi028::api::resource::v1alpha3::OpaqueDeviceConfiguration {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::resource::v1alpha3::OpaqueDeviceConfiguration,
> for OpaqueDeviceConfigurationAc {
    fn from_optionable(
        value: k8s_openapi028::api::resource::v1alpha3::OpaqueDeviceConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::resource::v1alpha3::OpaqueDeviceConfiguration,
    ) -> Result<(), crate::Error> {
