...
for k8s_openapi028::api::authentication::v1beta1::SelfSubjectReviewStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::authentication::v1beta1::SelfSubjectReviewStatus,
> for SelfSubjectReviewStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::authentication::v1beta1::SelfSubjectReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::authentication::v1beta1::SelfSubjectReviewStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SelfSubjectReviewStatusAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.user_info, other.user_info);
    }
}
