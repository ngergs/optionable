...
for k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionSpec,
> for StorageVersionSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StorageVersionSpecAc {
