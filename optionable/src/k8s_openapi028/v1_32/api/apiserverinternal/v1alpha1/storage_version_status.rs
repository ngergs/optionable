...
pub struct StorageVersionStatusAc {
    ...
    pub conditions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionCondition as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub storage_versions: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::apiserverinternal::v1alpha1::ServerStorageVersion as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionStatus {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionStatus,
> for StorageVersionStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::apiserverinternal::v1alpha1::StorageVersionStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for StorageVersionStatusAc {
