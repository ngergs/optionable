...
for k8s_openapi028::api::storagemigration::v1alpha1::GroupVersionResource {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::storagemigration::v1alpha1::GroupVersionResource,
> for GroupVersionResourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::storagemigration::v1alpha1::GroupVersionResource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::storagemigration::v1alpha1::GroupVersionResource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for GroupVersionResourceAc {
