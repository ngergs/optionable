...
pub struct VolumeAc {
    ...
    pub aws_elastic_block_store: Option<
        <::k8s_openapi028::api::core::v1::AWSElasticBlockStoreVolumeSource as crate::Optionable>::Optioned,
    >,
    /// azureDisk represents an Azure Data Disk mount on the host and bind mount to the pod. Deprecated: AzureDisk is deprecated. All operations for the in-tree azureDisk type are redirected to the disk.csi.azure.com CSI driver.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub azure_disk: Option<
        <::k8s_openapi028::api::core::v1::AzureDiskVolumeSource as crate::Optionable>::Optioned,
    >,
    /// azureFile represents an Azure File Service mount on the host and bind mount to the pod. Deprecated: AzureFile is deprecated. All operations for the in-tree azureFile type are redirected to the file.csi.azure.com CSI driver.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub azure_file: Option<
        <::k8s_openapi028::api::core::v1::AzureFileVolumeSource as crate::Optionable>::Optioned,
    >,
    /// cephFS represents a Ceph FS mount on the host that shares a pod's lifetime. Deprecated: CephFS is deprecated and the in-tree cephfs type is no longer supported.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cephfs: Option<
        <::k8s_openapi028::api::core::v1::CephFSVolumeSource as crate::Optionable>::Optioned,
    >,
    /// cinder represents a cinder volume attached and mounted on kubelets host machine. Deprecated: Cinder is deprecated. All operations for the in-tree cinder type are redirected to the cinder.csi.openstack.org CSI driver. More info: https://examples.k8s.io/mysql-cinder-pd/README.md
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cinder: Option<
        <::k8s_openapi028::api::core::v1::CinderVolumeSource as crate::Optionable>::Optioned,
    >,
    /// configMap represents a configMap that should populate this volume
    #[serde(skip_serializing_if = "Option::is_none")]
    pub config_map: Option<
        <::k8s_openapi028::api::core::v1::ConfigMapVolumeSource as crate::Optionable>::Optioned,
    >,
    /// csi (Container Storage Interface) represents ephemeral storage that is handled by certain external CSI drivers.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub csi: Option<
        <::k8s_openapi028::api::core::v1::CSIVolumeSource as crate::Optionable>::Optioned,
    >,
    /// downwardAPI represents downward API about the pod that should populate this volume
    #[serde(rename = "downwardAPI")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub downward_api: Option<
        <::k8s_openapi028::api::core::v1::DownwardAPIVolumeSource as crate::Optionable>::Optioned,
    >,
    /// emptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir
    #[serde(skip_serializing_if = "Option::is_none")]
    pub empty_dir: Option<
        <::k8s_openapi028::api::core::v1::EmptyDirVolumeSource as crate::Optionable>::Optioned,
    >,
    ...
    pub ephemeral: Option<
        <::k8s_openapi028::api::core::v1::EphemeralVolumeSource as crate::Optionable>::Optioned,
    >,
    /// fc represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fc: Option<
        <::k8s_openapi028::api::core::v1::FCVolumeSource as crate::Optionable>::Optioned,
    >,
    /// flexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin. Deprecated: FlexVolume is deprecated. Consider using a CSIDriver instead.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flex_volume: Option<
        <::k8s_openapi028::api::core::v1::FlexVolumeSource as crate::Optionable>::Optioned,
    >,
    /// flocker represents a Flocker volume attached to a kubelet's host machine. This depends on the Flocker control service being running. Deprecated: Flocker is deprecated and the in-tree flocker type is no longer supported.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flocker: Option<
        <::k8s_openapi028::api::core::v1::FlockerVolumeSource as crate::Optionable>::Optioned,
    >,
    /// gcePersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. Deprecated: GCEPersistentDisk is deprecated. All operations for the in-tree gcePersistentDisk type are redirected to the pd.csi.storage.gke.io CSI driver. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk
    #[serde(skip_serializing_if = "Option::is_none")]
    pub gce_persistent_disk: Option<
        <::k8s_openapi028::api::core::v1::GCEPersistentDiskVolumeSource as crate::Optionable>::Optioned,
    >,
    /// gitRepo represents a git repository at a particular revision. Deprecated: GitRepo is deprecated. To provision a container with a git repo, mount an EmptyDir into an InitContainer that clones the repo using git, then mount the EmptyDir into the Pod's container.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub git_repo: Option<
        <::k8s_openapi028::api::core::v1::GitRepoVolumeSource as crate::Optionable>::Optioned,
    >,
    ...
    pub glusterfs: Option<
        <::k8s_openapi028::api::core::v1::GlusterfsVolumeSource as crate::Optionable>::Optioned,
    >,
    /// hostPath represents a pre-existing file or directory on the host machine that is directly exposed to the container. This is generally used for system agents or other privileged things that are allowed to see the host machine. Most containers will NOT need this. More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath
    #[serde(skip_serializing_if = "Option::is_none")]
    pub host_path: Option<
        <::k8s_openapi028::api::core::v1::HostPathVolumeSource as crate::Optionable>::Optioned,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub image: Option<
        <::k8s_openapi028::api::core::v1::ImageVolumeSource as crate::Optionable>::Optioned,
    >,
    /// iscsi represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://examples.k8s.io/volumes/iscsi/README.md
    #[serde(skip_serializing_if = "Option::is_none")]
    pub iscsi: Option<
        <::k8s_openapi028::api::core::v1::ISCSIVolumeSource as crate::Optionable>::Optioned,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nfs: Option<
        <::k8s_openapi028::api::core::v1::NFSVolumeSource as crate::Optionable>::Optioned,
    >,
    /// persistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
    #[serde(skip_serializing_if = "Option::is_none")]
    pub persistent_volume_claim: Option<
        <::k8s_openapi028::api::core::v1::PersistentVolumeClaimVolumeSource as crate::Optionable>::Optioned,
    >,
    /// photonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelets host machine. Deprecated: PhotonPersistentDisk is deprecated and the in-tree photonPersistentDisk type is no longer supported.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub photon_persistent_disk: Option<
        <::k8s_openapi028::api::core::v1::PhotonPersistentDiskVolumeSource as crate::Optionable>::Optioned,
    >,
    /// portworxVolume represents a portworx volume attached and mounted on kubelets host machine. Deprecated: PortworxVolume is deprecated. All operations for the in-tree portworxVolume type are redirected to the pxd.portworx.com CSI driver when the CSIMigrationPortworx feature-gate is on.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub portworx_volume: Option<
        <::k8s_openapi028::api::core::v1::PortworxVolumeSource as crate::Optionable>::Optioned,
    >,
    /// projected items for all in one resources secrets, configmaps, and downward API
    #[serde(skip_serializing_if = "Option::is_none")]
    pub projected: Option<
        <::k8s_openapi028::api::core::v1::ProjectedVolumeSource as crate::Optionable>::Optioned,
    >,
    /// quobyte represents a Quobyte mount on the host that shares a pod's lifetime. Deprecated: Quobyte is deprecated and the in-tree quobyte type is no longer supported.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quobyte: Option<
        <::k8s_openapi028::api::core::v1::QuobyteVolumeSource as crate::Optionable>::Optioned,
    >,
    /// rbd represents a Rados Block Device mount on the host that shares a pod's lifetime. Deprecated: RBD is deprecated and the in-tree rbd type is no longer supported. More info: https://examples.k8s.io/volumes/rbd/README.md
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rbd: Option<
        <::k8s_openapi028::api::core::v1::RBDVolumeSource as crate::Optionable>::Optioned,
    >,
    /// scaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes. Deprecated: ScaleIO is deprecated and the in-tree scaleIO type is no longer supported.
    #[serde(rename = "scaleIO")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scale_io: Option<
        <::k8s_openapi028::api::core::v1::ScaleIOVolumeSource as crate::Optionable>::Optioned,
    >,
    /// secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secret: Option<
        <::k8s_openapi028::api::core::v1::SecretVolumeSource as crate::Optionable>::Optioned,
    >,
    /// storageOS represents a StorageOS volume attached and mounted on Kubernetes nodes. Deprecated: StorageOS is deprecated and the in-tree storageos type is no longer supported.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub storageos: Option<
        <::k8s_openapi028::api::core::v1::StorageOSVolumeSource as crate::Optionable>::Optioned,
    >,
    /// vsphereVolume represents a vSphere volume attached and mounted on kubelets host machine. Deprecated: VsphereVolume is deprecated. All operations for the in-tree vsphereVolume type are redirected to the csi.vsphere.vmware.com CSI driver.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vsphere_volume: Option<
        <::k8s_openapi028::api::core::v1::VsphereVirtualDiskVolumeSource as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi028::api::core::v1::Volume {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::Volume {
...
#[automatically_derived]
impl crate::merge::OptionableMapKeysEq for k8s_openapi028::api::core::v1::Volume {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::Volume> for VolumeAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::Volume) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::Volume, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::Volume,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for VolumeAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.aws_elastic_block_store,
            other.aws_elastic_block_store,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.azure_disk, other.azure_disk);
        k8s_openapi028::DeepMerge::merge_from(&mut self.azure_file, other.azure_file);
        k8s_openapi028::DeepMerge::merge_from(&mut self.cephfs, other.cephfs);
        k8s_openapi028::DeepMerge::merge_from(&mut self.cinder, other.cinder);
        k8s_openapi028::DeepMerge::merge_from(&mut self.config_map, other.config_map);
        k8s_openapi028::DeepMerge::merge_from(&mut self.csi, other.csi);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.downward_api,
            other.downward_api,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.empty_dir, other.empty_dir);
        k8s_openapi028::DeepMerge::merge_from(&mut self.ephemeral, other.ephemeral);
        k8s_openapi028::DeepMerge::merge_from(&mut self.fc, other.fc);
        k8s_openapi028::DeepMerge::merge_from(&mut self.flex_volume, other.flex_volume);
        k8s_openapi028::DeepMerge::merge_from(&mut self.flocker, other.flocker);
        k8s_openapi028::DeepMerge::merge_from(
            &mut self.gce_persistent_disk,
            other.gce_persistent_disk,
        );
        k8s_openapi028::DeepMerge::merge_from(&mut self.git_repo, other.git_repo);
        k8s_openapi028::DeepMerge::merge_from(&mut self.glusterfs, other.glusterfs);
        k8s_openapi028::DeepMerge::merge_from(&mut self.host_path, other.host_path);
        k8s_openapi028::DeepMerge::merge_from(&mut self.image, other.image);
        k8s_openapi028::DeepMerge::merge_from(&mut self.iscsi, other.iscsi);
        k8s_openapi028::DeepMerge::merge_from(&mut self.name, other.name);
        k8s_openapi028::DeepMerge::merge_from(&mut self.nfs, other.nfs);
        k8s_openapi028::DeepMerge::merge_from(
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.projected, other.projected);
        k8s_openapi028::DeepMerge::merge_from(&mut self.quobyte, other.quobyte);
        k8s_openapi028::DeepMerge::merge_from(&mut self.rbd, other.rbd);
        k8s_openapi028::DeepMerge::merge_from(&mut self.scale_io, other.scale_io);
        k8s_openapi028::DeepMerge::merge_from(&mut self.secret, other.secret);
        k8s_openapi028::DeepMerge::merge_from(&mut self.storageos, other.storageos);
        k8s_openapi028::DeepMerge::merge_from(
