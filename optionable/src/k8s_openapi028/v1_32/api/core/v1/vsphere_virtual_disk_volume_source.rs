...
for k8s_openapi028::api::core::v1::VsphereVirtualDiskVolumeSource {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::core::v1::VsphereVirtualDiskVolumeSource,
> for VsphereVirtualDiskVolumeSourceAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::VsphereVirtualDiskVolumeSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::VsphereVirtualDiskVolumeSource,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for VsphereVirtualDiskVolumeSourceAc {
    fn merge_from(&mut self, other: Self) {
        ...
        k8s_openapi028::DeepMerge::merge_from(&mut self.volume_path, other.volume_path);
    }
}
