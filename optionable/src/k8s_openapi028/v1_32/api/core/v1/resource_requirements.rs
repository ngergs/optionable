...
pub struct ResourceRequirementsAc {
    ...
    pub claims: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::core::v1::ResourceClaim as crate::Optionable>::Optioned,
        >,
    >,
...
impl crate::Optionable for k8s_openapi028::api::core::v1::ResourceRequirements {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::ResourceRequirements {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::ResourceRequirements>
for ResourceRequirementsAc {
    fn from_optionable(
        value: k8s_openapi028::api::core::v1::ResourceRequirements,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::ResourceRequirements, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::ResourceRequirements,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for ResourceRequirementsAc {
