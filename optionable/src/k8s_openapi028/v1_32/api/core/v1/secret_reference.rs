...
impl crate::Optionable for k8s_openapi028::api::core::v1::SecretReference {
...
impl crate::OptionableConvert for k8s_openapi028::api::core::v1::SecretReference {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::core::v1::SecretReference>
for SecretReferenceAc {
    fn from_optionable(value: k8s_openapi028::api::core::v1::SecretReference) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::core::v1::SecretReference, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::core::v1::SecretReference,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for SecretReferenceAc {
