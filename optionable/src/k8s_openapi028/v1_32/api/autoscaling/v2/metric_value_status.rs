...
impl crate::Optionable for k8s_openapi028::api::autoscaling::v2::MetricValueStatus {
...
for k8s_openapi028::api::autoscaling::v2::MetricValueStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi028::api::autoscaling::v2::MetricValueStatus>
for MetricValueStatusAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::MetricValueStatus,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi028::api::autoscaling::v2::MetricValueStatus, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::MetricValueStatus,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MetricValueStatusAc {
