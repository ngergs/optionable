...
pub struct HorizontalPodAutoscalerSpecAc {
    ...
    pub behavior: Option<
        <::k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerBehavior as crate::Optionable>::Optioned,
    >,
    ...
    pub metrics: Option<
        std::vec::Vec<
            <::k8s_openapi028::api::autoscaling::v2::MetricSpec as crate::Optionable>::Optioned,
        >,
    >,
...
for k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerSpec {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerSpec,
> for HorizontalPodAutoscalerSpecAc {
    fn from_optionable(
        value: k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::autoscaling::v2::HorizontalPodAutoscalerSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for HorizontalPodAutoscalerSpecAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi028::DeepMerge::merge_from(&mut self.behavior, other.behavior);
