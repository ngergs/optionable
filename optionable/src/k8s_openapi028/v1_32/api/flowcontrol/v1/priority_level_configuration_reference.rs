...
for k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationReference {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationReference,
> for PriorityLevelConfigurationReferenceAc {
    fn from_optionable(
        value: k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::flowcontrol::v1::PriorityLevelConfigurationReference,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for PriorityLevelConfigurationReferenceAc {
