...
for k8s_openapi028::api::admissionregistration::v1alpha1::MatchCondition {
...
impl crate::OptionedConvert<
    k8s_openapi028::api::admissionregistration::v1alpha1::MatchCondition,
> for MatchConditionAc {
    fn from_optionable(
        value: k8s_openapi028::api::admissionregistration::v1alpha1::MatchCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi028::api::admissionregistration::v1alpha1::MatchCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi028::DeepMerge for MatchConditionAc {
