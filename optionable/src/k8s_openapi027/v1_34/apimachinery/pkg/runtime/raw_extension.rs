...
impl crate::OptionableConvert for k8s_openapi027::apimachinery::pkg::runtime::RawExtension {
...
impl crate::OptionedConvert<k8s_openapi027::apimachinery::pkg::runtime::RawExtension>
    for RawExtensionAc
{
    fn from_optionable(value: k8s_openapi027::apimachinery::pkg::runtime::RawExtension) -> Self {
