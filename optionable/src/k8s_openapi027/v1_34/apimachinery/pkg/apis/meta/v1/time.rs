...
for k8s_openapi027::apimachinery::pkg::apis::meta::v1::Time {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::apimachinery::pkg::apis::meta::v1::Time>
for TimeAc {
    fn from_optionable(
        value: k8s_openapi027::apimachinery::pkg::apis::meta::v1::Time,
    ) -> Self {
...
impl k8s_openapi027::DeepMerge for TimeAc {
