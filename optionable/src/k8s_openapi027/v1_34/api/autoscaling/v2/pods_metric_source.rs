...
impl crate::OptionableConvert for k8s_openapi027::api::autoscaling::v2::PodsMetricSource {
...
{
    fn from_optionable(value: k8s_openapi027::api::autoscaling::v2::PodsMetricSource) -> Self {
