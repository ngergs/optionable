...
impl crate::Optionable for k8s_openapi027::api::storage::v1::VolumeAttributesClass {
...
for VolumeAttributesClassAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::storage::v1::VolumeAttributesClass, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::storage::v1::VolumeAttributesClass,
    ) -> Result<(), crate::Error> {
