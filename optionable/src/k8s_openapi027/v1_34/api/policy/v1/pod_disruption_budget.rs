...
impl crate::OptionableConvert for k8s_openapi027::api::policy::v1::PodDisruptionBudget {
...
for PodDisruptionBudgetAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::policy::v1::PodDisruptionBudget, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::policy::v1::PodDisruptionBudget,
    ) -> Result<(), crate::Error> {
