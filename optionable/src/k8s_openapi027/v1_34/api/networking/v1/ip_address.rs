...
pub struct IPAddressAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::networking::v1::IPAddressSpec as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::networking::v1::IPAddress {
...
impl crate::OptionableConvert for k8s_openapi027::api::networking::v1::IPAddress {
...
for IPAddressAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::networking::v1::IPAddress, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::networking::v1::IPAddress,
    ) -> Result<(), crate::Error> {
...
fn roundtrip_ipaddressac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::networking::v1::IPAddress>();
}
impl k8s_openapi027::DeepMerge for IPAddressAc {
