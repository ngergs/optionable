...
impl crate::OptionableConvert for k8s_openapi027::api::networking::v1::ServiceCIDRSpec {
...
for ServiceCIDRSpecAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::networking::v1::ServiceCIDRSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::networking::v1::ServiceCIDRSpec,
    ) -> Result<(), crate::Error> {
