...
pub struct IPAddressSpecAc {
    ...
    pub parent_ref: Option<
        <::k8s_openapi027::api::networking::v1::ParentReference as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::networking::v1::IPAddressSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::networking::v1::IPAddressSpec {
...
for IPAddressSpecAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::networking::v1::IPAddressSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::networking::v1::IPAddressSpec,
    ) -> Result<(), crate::Error> {
