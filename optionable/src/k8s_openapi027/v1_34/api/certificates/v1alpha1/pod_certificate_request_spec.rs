...
impl crate::Optionable for k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec {
...
impl crate::OptionableConvert
    for k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec
{
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec>
    for PodCertificateRequestSpecAc
{
    fn from_optionable(
        value: k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec, crate::Error>
    {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::certificates::v1alpha1::PodCertificateRequestSpec,
    ) -> Result<(), crate::Error> {
