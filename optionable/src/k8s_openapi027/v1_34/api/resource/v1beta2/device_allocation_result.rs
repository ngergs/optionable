...
pub struct DeviceAllocationResultAc {
    ...
    pub config: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::DeviceAllocationConfiguration as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub results: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::DeviceRequestAllocationResult as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable
for k8s_openapi027::api::resource::v1beta2::DeviceAllocationResult {
...
for k8s_openapi027::api::resource::v1beta2::DeviceAllocationResult {
    ...
    fn merge(&mut self, other: DeviceAllocationResultAc) -> Result<(), crate::Error> {
        ...
        if let Some(other_value) = other.results {
            self.results = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
        Ok(())
    }
}
