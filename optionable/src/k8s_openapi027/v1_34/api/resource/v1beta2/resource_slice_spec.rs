...
pub struct ResourceSliceSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1beta2::Device>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pool: Option<
        <::k8s_openapi027::api::resource::v1beta2::ResourcePool as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shared_counters: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1beta2::CounterSet>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec {
    fn into_optioned(self) -> ResourceSliceSpecAc {
        ResourceSliceSpecAc {
            ...
            shared_counters: crate::OptionableConvert::into_optioned(self.shared_counters),
        }
    }
    fn try_from_optioned(value: ResourceSliceSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            shared_counters: crate::OptionableConvert::try_from_optioned(value.shared_counters)?,
        })
    }
    fn merge(&mut self, other: ResourceSliceSpecAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.shared_counters, other.shared_counters)?;
        Ok(())
    }
}
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec>
    for ResourceSliceSpecAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec,
    ) -> Result<(), crate::Error> {
