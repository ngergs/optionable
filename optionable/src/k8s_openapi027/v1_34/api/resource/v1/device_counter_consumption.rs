...
for k8s_openapi027::api::resource::v1::DeviceCounterConsumption {
...
for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi027::api::resource::v1::DeviceCounterConsumption,
        crate::Error,
    > {
