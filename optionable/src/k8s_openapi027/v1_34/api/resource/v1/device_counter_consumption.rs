...
pub struct DeviceCounterConsumptionAc {
    ...
    pub counters: Option<
        <std::collections::BTreeMap<
            std::string::String,
            ::k8s_openapi027::api::resource::v1::Counter,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1::DeviceCounterConsumption {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1::DeviceCounterConsumption {
    ...
    fn try_from_optioned(value: DeviceCounterConsumptionAc) -> Result<Self, crate::Error> {
        Ok(Self {
            counter_set: crate::OptionableConvert::try_from_optioned(value.counter_set.ok_or(
                crate::Error {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1::DeviceCounterConsumption>
    for DeviceCounterConsumptionAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1::DeviceCounterConsumption) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::DeviceCounterConsumption, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
