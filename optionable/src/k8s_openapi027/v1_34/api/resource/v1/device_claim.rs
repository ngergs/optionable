...
pub struct DeviceClaimAc {
    ...
    pub config: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::DeviceClaimConfiguration>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub constraints: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::DeviceConstraint>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requests: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::DeviceRequest>,
    > as crate::Optionable>::Optioned,
}
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1::DeviceClaim> for DeviceClaimAc {
