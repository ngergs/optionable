...
pub struct DeviceClassAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::resource::v1::DeviceClassSpec as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1::DeviceClass {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1::DeviceClass {
...
for DeviceClassAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::DeviceClass, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::DeviceClass,
    ) -> Result<(), crate::Error> {
