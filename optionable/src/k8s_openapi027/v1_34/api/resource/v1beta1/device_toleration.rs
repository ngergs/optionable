...
impl crate::Optionable for k8s_openapi027::api::resource::v1beta1::DeviceToleration {
...
for DeviceTolerationAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1beta1::DeviceToleration, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1beta1::DeviceToleration,
    ) -> Result<(), crate::Error> {
