...
impl crate::Optionable for k8s_openapi027::api::core::v1::SleepAction {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::SleepAction {
...
for SleepActionAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::SleepAction, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::SleepAction,
    ) -> Result<(), crate::Error> {
