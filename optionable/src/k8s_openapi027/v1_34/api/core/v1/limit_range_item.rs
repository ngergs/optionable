...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::LimitRangeItem {
    fn into_optioned(self) -> LimitRangeItemAc {
        LimitRangeItemAc {
            ...
            default_request: crate::OptionableConvert::into_optioned(self.default_request),
    ...
    fn try_from_optioned(value: LimitRangeItemAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            default_request: crate::OptionableConvert::try_from_optioned(value.default_request)?,
    ...
    fn merge(&mut self, other: LimitRangeItemAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.default_request, other.default_request)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::LimitRangeItem> for LimitRangeItemAc {
