...
impl crate::Optionable for k8s_openapi027::api::core::v1::AzureFilePersistentVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::AzureFilePersistentVolumeSource {
    fn into_optioned(self) -> AzureFilePersistentVolumeSourceAc {
        AzureFilePersistentVolumeSourceAc {
            ...
            secret_namespace: crate::OptionableConvert::into_optioned(self.secret_namespace),
            share_name: Some(crate::OptionableConvert::into_optioned(self.share_name)),
        }
    }
    fn try_from_optioned(value: AzureFilePersistentVolumeSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            secret_namespace: crate::OptionableConvert::try_from_optioned(value.secret_namespace)?,
    ...
    fn merge(&mut self, other: AzureFilePersistentVolumeSourceAc) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(&mut self.read_only, other.read_only)?;
        if let Some(other_value) = other.secret_name {
            crate::OptionableConvert::merge(&mut self.secret_name, other_value)?;
        }
        crate::OptionableConvert::merge(&mut self.secret_namespace, other.secret_namespace)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::AzureFilePersistentVolumeSource>
    for AzureFilePersistentVolumeSourceAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::AzureFilePersistentVolumeSource, crate::Error> {
