...
pub struct WebhookClientConfigAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service: Option<
        <::k8s_openapi027::api::admissionregistration::v1::ServiceReference as crate::Optionable>::Optioned,
    >,
...
impl k8s_openapi027::DeepMerge for WebhookClientConfigAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi027::DeepMerge::merge_from(&mut self.ca_bundle, other.ca_bundle);
