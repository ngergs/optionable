...
pub struct MutationAc {
    ...
    pub apply_configuration: Option<
        <::k8s_openapi027::api::admissionregistration::v1beta1::ApplyConfiguration as crate::Optionable>::Optioned,
    >,
    ...
    pub json_patch: Option<
        <::k8s_openapi027::api::admissionregistration::v1beta1::JSONPatch as crate::Optionable>::Optioned,
    >,
...
> for MutationAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1beta1::Mutation,
    ) -> Result<(), crate::Error> {
