...
impl crate::OptionableConvert for k8s_openapi027::api::authorization::v1::NonResourceRule {
    fn into_optioned(self) -> NonResourceRuleAc {
        NonResourceRuleAc {
            non_resource_urls: crate::OptionableConvert::into_optioned(self.non_resource_urls),
    ...
    fn merge(&mut self, other: NonResourceRuleAc) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(&mut self.non_resource_urls, other.non_resource_urls)?;
...
{
    fn from_optionable(value: k8s_openapi027::api::authorization::v1::NonResourceRule) -> Self {
