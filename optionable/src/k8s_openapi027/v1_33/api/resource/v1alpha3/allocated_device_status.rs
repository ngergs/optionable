...
pub struct AllocatedDeviceStatusAc {
    ...
    pub network_data: Option<
        <::k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData as crate::Optionable>::Optioned,
    >,
...
> for AllocatedDeviceStatusAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1alpha3::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
