...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::DeviceSubRequest {
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::DeviceSubRequest) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::DeviceSubRequest, crate::Error> {
