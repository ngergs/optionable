...
for k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData {
...
for NetworkDeviceDataAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData,
        crate::Error,
    > {
