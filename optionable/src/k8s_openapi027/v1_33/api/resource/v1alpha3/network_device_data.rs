...
impl crate::Optionable for k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData {
    fn into_optioned(self) -> NetworkDeviceDataAc {
        NetworkDeviceDataAc {
            hardware_address: crate::OptionableConvert::into_optioned(self.hardware_address),
    ...
    fn try_from_optioned(value: NetworkDeviceDataAc) -> Result<Self, crate::Error> {
        Ok(Self {
            hardware_address: crate::OptionableConvert::try_from_optioned(value.hardware_address)?,
            interface_name: crate::OptionableConvert::try_from_optioned(value.interface_name)?,
            ips: crate::OptionableConvert::try_from_optioned(value.ips)?,
        })
    }
    fn merge(&mut self, other: NetworkDeviceDataAc) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(&mut self.hardware_address, other.hardware_address)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData>
    for NetworkDeviceDataAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1alpha3::NetworkDeviceData,
    ) -> Result<(), crate::Error> {
