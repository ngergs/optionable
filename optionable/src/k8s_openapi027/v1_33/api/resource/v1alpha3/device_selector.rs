...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::DeviceSelector {
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::DeviceSelector) -> Self {
