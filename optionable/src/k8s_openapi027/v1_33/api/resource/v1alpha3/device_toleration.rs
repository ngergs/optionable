...
for k8s_openapi027::api::resource::v1alpha3::DeviceToleration {
...
for DeviceTolerationAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1alpha3::DeviceToleration,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi027::api::resource::v1alpha3::DeviceToleration,
        crate::Error,
    > {
