...
pub struct DeviceRequestAc {
    ...
    pub first_available: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1alpha3::DeviceSubRequest>,
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::DeviceRequest {
...
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1alpha3::DeviceRequest>
    for DeviceRequestAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::DeviceRequest) -> Self {
