...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta2::DeviceTaint> for DeviceTaintAc {
    fn from_optionable(value: k8s_openapi027::api::resource::v1beta2::DeviceTaint) -> Self {
