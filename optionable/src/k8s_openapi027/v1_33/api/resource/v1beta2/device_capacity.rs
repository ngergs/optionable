...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1beta2::DeviceCapacity {
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1beta2::DeviceCapacity) -> Self {
