...
for k8s_openapi027::api::resource::v1beta1::CELDeviceSelector {
...
for CELDeviceSelectorAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1beta1::CELDeviceSelector,
    ) -> Self {
...
impl k8s_openapi027::DeepMerge for CELDeviceSelectorAc {
