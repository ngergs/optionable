...
pub struct DeviceAllocationResultAc {
    ...
    pub config: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1beta1::DeviceAllocationConfiguration>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub results: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1beta1::DeviceRequestAllocationResult>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1beta1::DeviceAllocationResult {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1beta1::DeviceAllocationResult {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta1::DeviceAllocationResult>
    for DeviceAllocationResultAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1beta1::DeviceAllocationResult, crate::Error> {
