...
> for ValidatingAdmissionPolicyAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::Resource for ValidatingAdmissionPolicyAc {
    const API_VERSION: &'static str = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Resource>::Scope;
}
impl k8s_openapi027::Metadata for ValidatingAdmissionPolicyAc {
    type Ty = <k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicy as k8s_openapi027::Metadata>::Ty;
