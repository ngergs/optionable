...
pub struct TypeCheckingAc {
    ...
    pub expression_warnings: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::admissionregistration::v1::ExpressionWarning as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::admissionregistration::v1::TypeChecking {
...
for TypeCheckingAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1::TypeChecking,
    ) -> Result<(), crate::Error> {
