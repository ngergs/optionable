...
pub struct LeaseCandidateAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::coordination::v1alpha2::LeaseCandidateSpec as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate {
...
for LeaseCandidateAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::Resource for LeaseCandidateAc {
    const API_VERSION: &'static str = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Resource>::Scope;
}
impl k8s_openapi027::Metadata for LeaseCandidateAc {
    type Ty = <k8s_openapi027::api::coordination::v1alpha2::LeaseCandidate as k8s_openapi027::Metadata>::Ty;
