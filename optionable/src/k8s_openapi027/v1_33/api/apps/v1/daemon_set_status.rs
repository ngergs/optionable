...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::DaemonSetStatus {
    fn into_optioned(self) -> DaemonSetStatusAc {
        DaemonSetStatusAc {
            ...
            number_available: crate::OptionableConvert::into_optioned(self.number_available),
            number_misscheduled: Some(self.number_misscheduled),
            number_ready: Some(self.number_ready),
            number_unavailable: crate::OptionableConvert::into_optioned(self.number_unavailable),
    ...
    fn try_from_optioned(value: DaemonSetStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            current_number_scheduled: value.current_number_scheduled.ok_or(crate::Error {
                missing_field: "current_number_scheduled",
            })?,
            desired_number_scheduled: value.desired_number_scheduled.ok_or(crate::Error {
                missing_field: "desired_number_scheduled",
            })?,
            number_available: crate::OptionableConvert::try_from_optioned(value.number_available)?,
            number_misscheduled: value.number_misscheduled.ok_or(crate::Error {
                missing_field: "number_misscheduled",
            })?,
            number_ready: value.number_ready.ok_or(crate::Error {
    ...
    fn merge(&mut self, other: DaemonSetStatusAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.number_available, other.number_available)?;
        ...
        crate::OptionableConvert::merge(&mut self.number_unavailable, other.number_unavailable)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::apps::v1::DaemonSetStatus> for DaemonSetStatusAc {
