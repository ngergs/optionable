...
pub struct ServiceCIDRAc {
    ...
    pub spec: <Option<
        ::k8s_openapi027::api::networking::v1::ServiceCIDRSpec,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: <Option<
        ::k8s_openapi027::api::networking::v1::ServiceCIDRStatus,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::networking::v1::ServiceCIDR {
...
impl crate::OptionableConvert for k8s_openapi027::api::networking::v1::ServiceCIDR {
...
for ServiceCIDRAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::networking::v1::ServiceCIDR, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::networking::v1::ServiceCIDR,
    ) -> Result<(), crate::Error> {
