...
impl crate::Optionable for k8s_openapi027::api::core::v1::VolumeResourceRequirements {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::VolumeResourceRequirements {
    ...
    fn try_from_optioned(value: VolumeResourceRequirementsAc) -> Result<Self, crate::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: VolumeResourceRequirementsAc) -> Result<(), crate::Error> {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::VolumeResourceRequirements>
    for VolumeResourceRequirementsAc
{
    fn from_optionable(value: k8s_openapi027::api::core::v1::VolumeResourceRequirements) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::VolumeResourceRequirements, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::VolumeResourceRequirements,
    ) -> Result<(), crate::Error> {
