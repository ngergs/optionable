...
pub struct PersistentVolumeAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::core::v1::PersistentVolumeStatus as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::core::v1::PersistentVolume {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::PersistentVolume {
...
for PersistentVolumeAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::PersistentVolume, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::PersistentVolume,
    ) -> Result<(), crate::Error> {
...
fn roundtrip_persistentvolumeac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::core::v1::PersistentVolume>();
}
impl k8s_openapi027::DeepMerge for PersistentVolumeAc {
