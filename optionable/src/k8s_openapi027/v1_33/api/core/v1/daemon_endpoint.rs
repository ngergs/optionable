...
impl crate::Optionable for k8s_openapi027::api::core::v1::DaemonEndpoint {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::DaemonEndpoint {
...
for DaemonEndpointAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::DaemonEndpoint, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::DaemonEndpoint,
    ) -> Result<(), crate::Error> {
