...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::Binding {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::Binding> for BindingAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::Binding,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for BindingAc {
    type Ty = <k8s_openapi027::api::core::v1::Binding as k8s_openapi027::Metadata>::Ty;
...
fn roundtrip_bindingac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::core::v1::Binding>();
}
