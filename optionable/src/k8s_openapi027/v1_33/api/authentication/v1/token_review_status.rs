...
impl crate::OptionableConvert for k8s_openapi027::api::authentication::v1::TokenReviewStatus {
    ...
    fn try_from_optioned(value: TokenReviewStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            authenticated: crate::OptionableConvert::try_from_optioned(value.authenticated)?,
...
{
    fn from_optionable(value: k8s_openapi027::api::authentication::v1::TokenReviewStatus) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::authentication::v1::TokenReviewStatus, crate::Error> {
