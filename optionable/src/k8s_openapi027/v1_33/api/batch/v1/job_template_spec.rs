...
impl crate::Optionable for k8s_openapi027::api::batch::v1::JobTemplateSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::batch::v1::JobTemplateSpec {
...
for JobTemplateSpecAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::batch::v1::JobTemplateSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::batch::v1::JobTemplateSpec,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::DeepMerge for JobTemplateSpecAc {
