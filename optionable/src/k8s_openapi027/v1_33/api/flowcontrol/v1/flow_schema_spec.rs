...
pub struct FlowSchemaSpecAc {
    ...
    pub distinguisher_method: Option<
        <::k8s_openapi027::api::flowcontrol::v1::FlowDistinguisherMethod as crate::Optionable>::Optioned,
    >,
    ...
    pub rules: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::flowcontrol::v1::PolicyRulesWithSubjects as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::flowcontrol::v1::FlowSchemaSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::flowcontrol::v1::FlowSchemaSpec {
...
for FlowSchemaSpecAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::flowcontrol::v1::FlowSchemaSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::flowcontrol::v1::FlowSchemaSpec,
    ) -> Result<(), crate::Error> {
