...
for k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrStringArray {
...
impl crate::OptionedConvert<
    k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrStringArray,
> for JSONSchemaPropsOrStringArrayAc {
    fn from_optionable(
        value: k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrStringArray,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrStringArray,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::DeepMerge for JSONSchemaPropsOrStringArrayAc {
    fn merge_from(&mut self, other: Self) {
        match self {
            JSONSchemaPropsOrStringArrayAc::Schema(self_0) => {
                if let JSONSchemaPropsOrStringArrayAc::Schema(other_0) = other {
                    k8s_openapi027::DeepMerge::merge_from(self_0, other_0);
                } else {
                    *self = other;
                }
            }
            JSONSchemaPropsOrStringArrayAc::Strings(self_0) => {
                if let JSONSchemaPropsOrStringArrayAc::Strings(other_0) = other {
                    k8s_openapi027::DeepMerge::merge_from(self_0, other_0);
                } else {
                    *self = other;
                }
