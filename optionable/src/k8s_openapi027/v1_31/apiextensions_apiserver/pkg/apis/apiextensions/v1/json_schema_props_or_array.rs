...
for k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray {
...
> for JSONSchemaPropsOrArrayAc {
    fn from_optionable(
        value: k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::apiextensions_apiserver::pkg::apis::apiextensions::v1::JSONSchemaPropsOrArray,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::DeepMerge for JSONSchemaPropsOrArrayAc {
    fn merge_from(&mut self, other: Self) {
        match self {
            JSONSchemaPropsOrArrayAc::Schema(self_0) => {
                if let JSONSchemaPropsOrArrayAc::Schema(other_0) = other {
                    k8s_openapi027::DeepMerge::merge_from(self_0, other_0);
                } else {
                    *self = other;
                }
            }
            JSONSchemaPropsOrArrayAc::Schemas(self_0) => {
                if let JSONSchemaPropsOrArrayAc::Schemas(other_0) = other {
                    k8s_openapi027::DeepMerge::merge_from(self_0, other_0);
                } else {
                    *self = other;
                }
