...
impl crate::OptionableConvert for k8s_openapi027::apimachinery::pkg::api::resource::Quantity {
...
impl crate::OptionedConvert<k8s_openapi027::apimachinery::pkg::api::resource::Quantity>
    for QuantityAc
{
    fn from_optionable(value: k8s_openapi027::apimachinery::pkg::api::resource::Quantity) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::apimachinery::pkg::api::resource::Quantity, crate::Error> {
...
impl From<crate::k8s_openapi::apimachinery::pkg::util::intstr::IntOrStringAc> for QuantityAc {
    fn from(value: crate::k8s_openapi::apimachinery::pkg::util::intstr::IntOrStringAc) -> Self {
        QuantityAc(match value {
            crate::k8s_openapi::apimachinery::pkg::util::intstr::IntOrStringAc::Int(i) => {
                i.map(|i| i.to_string())
            }
