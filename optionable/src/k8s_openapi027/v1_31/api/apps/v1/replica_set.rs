...
pub struct ReplicaSetAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::apps::v1::ReplicaSetSpec as crate::Optionable>::Optioned,
    >,
    /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::apps::v1::ReplicaSetStatus as crate::Optionable>::Optioned,
    >,
}
...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::ReplicaSet {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::apps::v1::ReplicaSet> for ReplicaSetAc {
    fn from_optionable(value: k8s_openapi027::api::apps::v1::ReplicaSet) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::apps::v1::ReplicaSet, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::apps::v1::ReplicaSet,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for ReplicaSetAc {
    type Ty = <k8s_openapi027::api::apps::v1::ReplicaSet as k8s_openapi027::Metadata>::Ty;
...
fn roundtrip_replicasetac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::apps::v1::ReplicaSet>();
}
impl k8s_openapi027::DeepMerge for ReplicaSetAc {
