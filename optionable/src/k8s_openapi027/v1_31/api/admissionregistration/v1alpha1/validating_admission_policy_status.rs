    ...
    for k8s_openapi027::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus
{
    ...
    fn try_from_optioned(value: ValidatingAdmissionPolicyStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            conditions: crate::OptionableConvert::try_from_optioned(value.conditions)?,
            observed_generation: crate::OptionableConvert::try_from_optioned(
                value.observed_generation,
            )?,
            type_checking: crate::OptionableConvert::try_from_optioned(value.type_checking)?,
        })
    }
    fn merge(&mut self, other: ValidatingAdmissionPolicyStatusAc) -> Result<(), crate::Error> {
