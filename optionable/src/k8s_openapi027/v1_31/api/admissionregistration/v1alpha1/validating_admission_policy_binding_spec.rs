...
impl crate::Optionable
    for k8s_openapi027::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec
{
    ...
    for k8s_openapi027::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec
{
    fn into_optioned(self) -> ValidatingAdmissionPolicyBindingSpecAc {
        ValidatingAdmissionPolicyBindingSpecAc {
            ...
            validation_actions: crate::OptionableConvert::into_optioned(self.validation_actions),
        }
    }
    ...
    fn merge(&mut self, other: ValidatingAdmissionPolicyBindingSpecAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.validation_actions, other.validation_actions)?;
        Ok(())
    }
}
#[automatically_derived]
...
{
    fn from_optionable(
        value: k8s_openapi027::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBindingSpec,
    ) -> Result<(), crate::Error> {
