...
impl crate::Optionable for k8s_openapi027::api::coordination::v1alpha1::LeaseCandidateSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::coordination::v1alpha1::LeaseCandidateSpec {
    fn into_optioned(self) -> LeaseCandidateSpecAc {
        LeaseCandidateSpecAc {
            ...
            preferred_strategies: Some(crate::OptionableConvert::into_optioned(
    ...
    fn try_from_optioned(value: LeaseCandidateSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            binary_version: crate::OptionableConvert::try_from_optioned(value.binary_version)?,
            ...
            preferred_strategies: crate::OptionableConvert::try_from_optioned(
                value.preferred_strategies.ok_or(crate::Error {
    ...
    fn merge(&mut self, other: LeaseCandidateSpecAc) -> Result<(), crate::Error> {
        ...
        if let Some(other_value) = other.preferred_strategies {
            crate::OptionableConvert::merge(&mut self.preferred_strategies, other_value)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::coordination::v1alpha1::LeaseCandidateSpec>
    for LeaseCandidateSpecAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::coordination::v1alpha1::LeaseCandidateSpec, crate::Error> {
