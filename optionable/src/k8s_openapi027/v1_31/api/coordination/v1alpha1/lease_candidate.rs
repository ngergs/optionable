...
impl crate::OptionableConvert for k8s_openapi027::api::coordination::v1alpha1::LeaseCandidate {
...
{
    fn from_optionable(value: k8s_openapi027::api::coordination::v1alpha1::LeaseCandidate) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::coordination::v1alpha1::LeaseCandidate, crate::Error> {
...
fn roundtrip_leasecandidateac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::coordination::v1alpha1::LeaseCandidate>(
    );
}
