...
impl crate::Optionable for k8s_openapi027::api::flowcontrol::v1beta3::UserSubject {
...
for UserSubjectAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::flowcontrol::v1beta3::UserSubject, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::flowcontrol::v1beta3::UserSubject,
    ) -> Result<(), crate::Error> {
