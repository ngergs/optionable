...
pub struct LimitedPriorityLevelConfigurationAc {
    ...
    pub limit_response: Option<
        <::k8s_openapi027::api::flowcontrol::v1beta3::LimitResponse as crate::Optionable>::Optioned,
    >,
...
for k8s_openapi027::api::flowcontrol::v1beta3::LimitedPriorityLevelConfiguration {
    ...
    fn merge(
        ...
        if let Some(other_value) = other.borrowing_limit_percent {
        ...
        if self.limit_response.is_none() {
            self.limit_response = other.limit_response;
        }
        if let Some(other_value) = other.limit_response {
            crate::OptionableConvert::merge(&mut self.limit_response, other_value)?;
        }
