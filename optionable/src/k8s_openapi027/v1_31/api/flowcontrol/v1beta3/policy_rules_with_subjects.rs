...
pub struct PolicyRulesWithSubjectsAc {
    ...
    pub non_resource_rules: <Option<
        std::vec::Vec<::k8s_openapi027::api::flowcontrol::v1beta3::NonResourcePolicyRule>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_rules: <Option<
        std::vec::Vec<::k8s_openapi027::api::flowcontrol::v1beta3::ResourcePolicyRule>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subjects: Option<
        <std::vec::Vec<
            ::k8s_openapi027::api::flowcontrol::v1beta3::Subject,
        > as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::flowcontrol::v1beta3::PolicyRulesWithSubjects {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::flowcontrol::v1beta3::PolicyRulesWithSubjects>
    for PolicyRulesWithSubjectsAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::flowcontrol::v1beta3::PolicyRulesWithSubjects, crate::Error>
    {
