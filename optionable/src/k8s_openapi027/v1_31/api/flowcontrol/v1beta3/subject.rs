...
pub struct SubjectAc {
    ...
    pub group: Option<
        <::k8s_openapi027::api::flowcontrol::v1beta3::GroupSubject as crate::Optionable>::Optioned,
    >,
    ...
    pub service_account: Option<
        <::k8s_openapi027::api::flowcontrol::v1beta3::ServiceAccountSubject as crate::Optionable>::Optioned,
    >,
    /// `user` matches based on username.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: Option<
        <::k8s_openapi027::api::flowcontrol::v1beta3::UserSubject as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::flowcontrol::v1beta3::Subject {
...
impl crate::OptionableConvert for k8s_openapi027::api::flowcontrol::v1beta3::Subject {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::flowcontrol::v1beta3::Subject>
for SubjectAc {
    fn from_optionable(
        value: k8s_openapi027::api::flowcontrol::v1beta3::Subject,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::flowcontrol::v1beta3::Subject, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::flowcontrol::v1beta3::Subject,
    ) -> Result<(), crate::Error> {
