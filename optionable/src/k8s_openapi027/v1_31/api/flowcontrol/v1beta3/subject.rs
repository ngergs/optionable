...
pub struct SubjectAc {
    ...
    pub group: <Option<
        ::k8s_openapi027::api::flowcontrol::v1beta3::GroupSubject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: <Option<
        ::k8s_openapi027::api::flowcontrol::v1beta3::UserSubject,
    > as crate::Optionable>::Optioned,
}
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::flowcontrol::v1beta3::Subject> for SubjectAc {
    fn from_optionable(value: k8s_openapi027::api::flowcontrol::v1beta3::Subject) -> Self {
