...
impl crate::Optionable for k8s_openapi027::api::authentication::v1alpha1::SelfSubjectReview {
...
impl crate::OptionableConvert for k8s_openapi027::api::authentication::v1alpha1::SelfSubjectReview {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::authentication::v1alpha1::SelfSubjectReview>
    for SelfSubjectReviewAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::authentication::v1alpha1::SelfSubjectReview, crate::Error>
    {
