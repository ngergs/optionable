...
impl crate::OptionableConvert for k8s_openapi027::api::authentication::v1::TokenRequestSpec {
    fn into_optioned(self) -> TokenRequestSpecAc {
        TokenRequestSpecAc {
            audiences: Some(crate::OptionableConvert::into_optioned(self.audiences)),
            bound_object_ref: crate::OptionableConvert::into_optioned(self.bound_object_ref),
    ...
    fn try_from_optioned(value: TokenRequestSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            audiences: crate::OptionableConvert::try_from_optioned(value.audiences.ok_or(
                crate::Error {
                    missing_field: "audiences",
                },
            )?)?,
            bound_object_ref: crate::OptionableConvert::try_from_optioned(value.bound_object_ref)?,
    ...
    fn merge(&mut self, other: TokenRequestSpecAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.bound_object_ref, other.bound_object_ref)?;
...
{
    fn from_optionable(value: k8s_openapi027::api::authentication::v1::TokenRequestSpec) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::authentication::v1::TokenRequestSpec, crate::Error> {
