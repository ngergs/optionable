...
pub struct DeviceClaimAc {
    ...
    pub constraints: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1alpha3::DeviceConstraint>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requests: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1alpha3::DeviceRequest>,
    > as crate::Optionable>::Optioned,
}
...
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1alpha3::DeviceClaim>
    for DeviceClaimAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::DeviceClaim) -> Self {
