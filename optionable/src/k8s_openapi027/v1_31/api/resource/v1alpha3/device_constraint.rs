...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::DeviceConstraint {
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1alpha3::DeviceConstraint) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::DeviceConstraint, crate::Error> {
