...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1alpha3::Device {
...
for DeviceAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::Device, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1alpha3::Device,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::DeepMerge for DeviceAc {
    fn merge_from(&mut self, other: Self) {
        k8s_openapi027::DeepMerge::merge_from(&mut self.basic, other.basic);
