...
impl crate::Optionable for k8s_openapi027::api::resource::v1alpha3::PodSchedulingContextSpec {
    ...
    for k8s_openapi027::api::resource::v1alpha3::PodSchedulingContextSpec
{
    fn into_optioned(self) -> PodSchedulingContextSpecAc {
        PodSchedulingContextSpecAc {
            potential_nodes: crate::OptionableConvert::into_optioned(self.potential_nodes),
            selected_node: crate::OptionableConvert::into_optioned(self.selected_node),
        }
    }
    fn try_from_optioned(value: PodSchedulingContextSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            potential_nodes: crate::OptionableConvert::try_from_optioned(value.potential_nodes)?,
            selected_node: crate::OptionableConvert::try_from_optioned(value.selected_node)?,
        })
    }
    fn merge(&mut self, other: PodSchedulingContextSpecAc) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(&mut self.potential_nodes, other.potential_nodes)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1alpha3::PodSchedulingContextSpec>
    for PodSchedulingContextSpecAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::PodSchedulingContextSpec, crate::Error>
    {
