...
> for HorizontalPodAutoscalerAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::Resource for HorizontalPodAutoscalerAc {
    const API_VERSION: &'static str = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Resource>::Scope;
}
impl k8s_openapi027::Metadata for HorizontalPodAutoscalerAc {
    type Ty = <k8s_openapi027::api::autoscaling::v2::HorizontalPodAutoscaler as k8s_openapi027::Metadata>::Ty;
