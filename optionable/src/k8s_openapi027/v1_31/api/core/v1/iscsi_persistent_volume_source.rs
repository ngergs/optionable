...
pub struct ISCSIPersistentVolumeSourceAc {
    ...
    pub lun: Option<i32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub portals: <Option<std::vec::Vec<std::string::String>> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::ISCSIPersistentVolumeSource {
    ...
    fn try_from_optioned(value: ISCSIPersistentVolumeSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: ISCSIPersistentVolumeSourceAc) -> Result<(), crate::Error> {
...
{
    fn from_optionable(value: k8s_openapi027::api::core::v1::ISCSIPersistentVolumeSource) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::ISCSIPersistentVolumeSource, crate::Error> {
