...
impl crate::Optionable for k8s_openapi027::api::core::v1::VolumeDevice {
...
#[automatically_derived]
impl crate::merge::OptionableMapKeysEq for k8s_openapi027::api::core::v1::VolumeDevice {
...
for VolumeDeviceAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::VolumeDevice, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::VolumeDevice,
    ) -> Result<(), crate::Error> {
