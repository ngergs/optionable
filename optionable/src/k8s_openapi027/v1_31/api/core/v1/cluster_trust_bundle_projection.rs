...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::ClusterTrustBundleProjection {
    ...
    fn try_from_optioned(value: ClusterTrustBundleProjectionAc) -> Result<Self, crate::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: ClusterTrustBundleProjectionAc) -> Result<(), crate::Error> {
...
{
    fn from_optionable(value: k8s_openapi027::api::core::v1::ClusterTrustBundleProjection) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::ClusterTrustBundleProjection, crate::Error> {
