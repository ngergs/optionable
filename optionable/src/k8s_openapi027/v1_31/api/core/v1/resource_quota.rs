...
pub struct ResourceQuotaAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::core::v1::ResourceQuotaSpec as crate::Optionable>::Optioned,
    >,
    /// Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::core::v1::ResourceQuotaStatus as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::core::v1::ResourceQuota {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::ResourceQuota {
...
for ResourceQuotaAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::ResourceQuota, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::ResourceQuota,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for ResourceQuotaAc {
    type Ty = <k8s_openapi027::api::core::v1::ResourceQuota as k8s_openapi027::Metadata>::Ty;
...
fn roundtrip_resourcequotaac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::core::v1::ResourceQuota>();
}
impl k8s_openapi027::DeepMerge for ResourceQuotaAc {
