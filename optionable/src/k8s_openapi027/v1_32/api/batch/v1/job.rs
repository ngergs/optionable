...
pub struct JobAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::batch::v1::JobSpec as crate::Optionable>::Optioned,
    >,
    /// Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::batch::v1::JobStatus as crate::Optionable>::Optioned,
    >,
}
...
impl crate::OptionableConvert for k8s_openapi027::api::batch::v1::Job {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::batch::v1::Job> for JobAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::batch::v1::Job,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for JobAc {
    type Ty = <k8s_openapi027::api::batch::v1::Job as k8s_openapi027::Metadata>::Ty;
...
#[test]
fn roundtrip_jobac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::batch::v1::Job>();
}
impl k8s_openapi027::DeepMerge for JobAc {
