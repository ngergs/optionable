...
pub struct PodFailurePolicyAc {
    ...
    pub rules: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::batch::v1::PodFailurePolicyRule as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::batch::v1::PodFailurePolicy {
...
impl crate::OptionableConvert for k8s_openapi027::api::batch::v1::PodFailurePolicy {
...
for PodFailurePolicyAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::batch::v1::PodFailurePolicy, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::batch::v1::PodFailurePolicy,
    ) -> Result<(), crate::Error> {
