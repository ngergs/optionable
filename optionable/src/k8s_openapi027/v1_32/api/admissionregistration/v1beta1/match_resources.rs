...
impl crate::Optionable for k8s_openapi027::api::admissionregistration::v1beta1::MatchResources {
...
impl crate::OptionableConvert
    for k8s_openapi027::api::admissionregistration::v1beta1::MatchResources
{
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::admissionregistration::v1beta1::MatchResources>
    for MatchResourcesAc
{
    fn from_optionable(
        value: k8s_openapi027::api::admissionregistration::v1beta1::MatchResources,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::admissionregistration::v1beta1::MatchResources, crate::Error>
    {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1beta1::MatchResources,
    ) -> Result<(), crate::Error> {
