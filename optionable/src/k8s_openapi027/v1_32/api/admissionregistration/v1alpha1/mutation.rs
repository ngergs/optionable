...
impl crate::Optionable for k8s_openapi027::api::admissionregistration::v1alpha1::Mutation {
...
impl crate::OptionableConvert for k8s_openapi027::api::admissionregistration::v1alpha1::Mutation {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::admissionregistration::v1alpha1::Mutation>
    for MutationAc
{
    fn from_optionable(
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::admissionregistration::v1alpha1::Mutation, crate::Error> {
