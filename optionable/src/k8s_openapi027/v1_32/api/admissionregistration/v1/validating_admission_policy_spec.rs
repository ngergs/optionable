...
pub struct ValidatingAdmissionPolicySpecAc {
    ...
    pub audit_annotations: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::admissionregistration::v1::AuditAnnotation as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub param_kind: Option<
        <::k8s_openapi027::api::admissionregistration::v1::ParamKind as crate::Optionable>::Optioned,
    >,
    /// Validations contain CEL expressions which is used to apply the validation. Validations and AuditAnnotations may not both be empty; a minimum of one Validations or AuditAnnotations is required.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub validations: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::admissionregistration::v1::Validation as crate::Optionable>::Optioned,
        >,
    >,
...
for k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicySpec {
    ...
    fn merge(
        ...
        if let Some(other_value) = other.validations {
            self.validations = crate::OptionableConvert::try_from_optioned(other_value)?;
        }
        if self.variables.is_none() {
            self.variables = other.variables;
        }
        if let Some(other_value) = other.variables {
            crate::merge::try_merge_optioned_map(&mut self.variables, other_value)?;
        }
        Ok(())
    }
}
...
> for ValidatingAdmissionPolicySpecAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1::ValidatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
