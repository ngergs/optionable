...
impl crate::OptionableConvert for k8s_openapi027::api::coordination::v1::LeaseSpec {
    fn into_optioned(self) -> LeaseSpecAc {
        LeaseSpecAc {
            ...
            holder_identity: crate::OptionableConvert::into_optioned(self.holder_identity),
            lease_duration_seconds: crate::OptionableConvert::into_optioned(
                self.lease_duration_seconds,
            ),
            lease_transitions: crate::OptionableConvert::into_optioned(self.lease_transitions),
            preferred_holder: crate::OptionableConvert::into_optioned(self.preferred_holder),
    ...
    fn try_from_optioned(value: LeaseSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            acquire_time: crate::OptionableConvert::try_from_optioned(value.acquire_time)?,
            holder_identity: crate::OptionableConvert::try_from_optioned(value.holder_identity)?,
            ...
            preferred_holder: crate::OptionableConvert::try_from_optioned(value.preferred_holder)?,
    ...
    fn merge(&mut self, other: LeaseSpecAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.holder_identity, other.holder_identity)?;
        crate::OptionableConvert::merge(
            &mut self.lease_duration_seconds,
            other.lease_duration_seconds,
        )?;
        crate::OptionableConvert::merge(&mut self.lease_transitions, other.lease_transitions)?;
        crate::OptionableConvert::merge(&mut self.preferred_holder, other.preferred_holder)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::coordination::v1::LeaseSpec> for LeaseSpecAc {
