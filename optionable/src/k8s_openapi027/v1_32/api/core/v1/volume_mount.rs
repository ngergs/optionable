...
pub struct VolumeMountAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub recursive_read_only: <Option<std::string::String> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::VolumeMount {
    fn into_optioned(self) -> VolumeMountAc {
        VolumeMountAc {
            ...
            mount_propagation: crate::OptionableConvert::into_optioned(self.mount_propagation),
            name: Some(crate::OptionableConvert::into_optioned(self.name)),
            read_only: crate::OptionableConvert::into_optioned(self.read_only),
            recursive_read_only: crate::OptionableConvert::into_optioned(self.recursive_read_only),
    ...
    fn try_from_optioned(value: VolumeMountAc) -> Result<Self, crate::Error> {
        Ok(Self {
            mount_path: crate::OptionableConvert::try_from_optioned(value.mount_path.ok_or(
                crate::Error {
            ...
            sub_path_expr: crate::OptionableConvert::try_from_optioned(value.sub_path_expr)?,
        })
    }
    fn merge(&mut self, other: VolumeMountAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.mount_propagation, other.mount_propagation)?;
        if let Some(other_value) = other.name {
            crate::OptionableConvert::merge(&mut self.name, other_value)?;
        }
        crate::OptionableConvert::merge(&mut self.read_only, other.read_only)?;
        crate::OptionableConvert::merge(&mut self.recursive_read_only, other.recursive_read_only)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::VolumeMount> for VolumeMountAc {
