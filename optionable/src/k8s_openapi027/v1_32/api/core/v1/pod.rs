...
pub struct PodAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::core::v1::PodStatus as crate::Optionable>::Optioned,
    >,
}
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::Pod {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::Pod> for PodAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::Pod,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for PodAc {
    type Ty = <k8s_openapi027::api::core::v1::Pod as k8s_openapi027::Metadata>::Ty;
...
#[test]
fn roundtrip_podac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::core::v1::Pod>();
}
impl k8s_openapi027::DeepMerge for PodAc {
