...
impl crate::Optionable for k8s_openapi027::api::core::v1::LimitRangeSpec {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::LimitRangeSpec {
...
for LimitRangeSpecAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::LimitRangeSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::core::v1::LimitRangeSpec,
    ) -> Result<(), crate::Error> {
