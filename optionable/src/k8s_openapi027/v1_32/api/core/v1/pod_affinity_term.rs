...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::PodAffinityTerm {
    fn into_optioned(self) -> PodAffinityTermAc {
        PodAffinityTermAc {
            ...
            mismatch_label_keys: crate::OptionableConvert::into_optioned(self.mismatch_label_keys),
    ...
    fn merge(&mut self, other: PodAffinityTermAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.mismatch_label_keys, other.mismatch_label_keys)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::PodAffinityTerm> for PodAffinityTermAc {
