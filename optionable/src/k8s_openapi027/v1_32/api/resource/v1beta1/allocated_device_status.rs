...
impl crate::Optionable for k8s_openapi027::api::resource::v1beta1::AllocatedDeviceStatus {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1beta1::AllocatedDeviceStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta1::AllocatedDeviceStatus>
    for AllocatedDeviceStatusAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1beta1::AllocatedDeviceStatus, crate::Error> {
