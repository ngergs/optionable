...
> for StorageVersionAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::Resource for StorageVersionAc {
    const API_VERSION: &'static str = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::URL_PATH_SEGMENT;
    type Scope = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Resource>::Scope;
}
impl k8s_openapi027::Metadata for StorageVersionAc {
    type Ty = <k8s_openapi027::api::apiserverinternal::v1alpha1::StorageVersion as k8s_openapi027::Metadata>::Ty;
...
impl k8s_openapi027::DeepMerge for StorageVersionAc {
