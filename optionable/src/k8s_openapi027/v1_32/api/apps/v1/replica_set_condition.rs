...
impl crate::Optionable for k8s_openapi027::api::apps::v1::ReplicaSetCondition {
...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::ReplicaSetCondition {
...
for k8s_openapi027::api::apps::v1::ReplicaSetCondition {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::apps::v1::ReplicaSetCondition>
for ReplicaSetConditionAc {
    fn from_optionable(
        value: k8s_openapi027::api::apps::v1::ReplicaSetCondition,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::apps::v1::ReplicaSetCondition, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::apps::v1::ReplicaSetCondition,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::DeepMerge for ReplicaSetConditionAc {
