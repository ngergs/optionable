...
impl crate::OptionableConvert for k8s_openapi027::api::networking::v1beta1::ParentReference {
...
{
    fn from_optionable(value: k8s_openapi027::api::networking::v1beta1::ParentReference) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::networking::v1beta1::ParentReference, crate::Error> {
