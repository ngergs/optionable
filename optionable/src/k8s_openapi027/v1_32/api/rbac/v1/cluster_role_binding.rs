...
impl crate::OptionableConvert for k8s_openapi027::api::rbac::v1::ClusterRoleBinding {
...
for ClusterRoleBindingAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::rbac::v1::ClusterRoleBinding, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::rbac::v1::ClusterRoleBinding,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::DeepMerge for ClusterRoleBindingAc {
