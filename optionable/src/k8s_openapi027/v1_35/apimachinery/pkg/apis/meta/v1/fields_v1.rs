...
impl crate::OptionableConvert for k8s_openapi027::apimachinery::pkg::apis::meta::v1::FieldsV1 {
...
impl crate::OptionedConvert<k8s_openapi027::apimachinery::pkg::apis::meta::v1::FieldsV1>
    for FieldsV1Ac
{
    fn from_optionable(value: k8s_openapi027::apimachinery::pkg::apis::meta::v1::FieldsV1) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::apimachinery::pkg::apis::meta::v1::FieldsV1, crate::Error> {
