...
pub enum PatchAc {
    ...
    Merge(
        #[serde(skip_serializing_if = "Option::is_none")]
        Option<<::k8s_openapi027::serde_json::Value as crate::Optionable>::Optioned>,
    ),
    StrategicMerge(
        #[serde(skip_serializing_if = "Option::is_none")]
        Option<<::k8s_openapi027::serde_json::Value as crate::Optionable>::Optioned>,
...
impl crate::Optionable for k8s_openapi027::apimachinery::pkg::apis::meta::v1::Patch {
...
for PatchAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::apimachinery::pkg::apis::meta::v1::Patch, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::apimachinery::pkg::apis::meta::v1::Patch,
    ) -> Result<(), crate::Error> {
