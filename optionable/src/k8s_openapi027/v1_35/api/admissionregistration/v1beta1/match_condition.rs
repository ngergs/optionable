...
impl crate::Optionable for k8s_openapi027::api::admissionregistration::v1beta1::MatchCondition {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::admissionregistration::v1beta1::MatchCondition>
    for MatchConditionAc
{
    fn from_optionable(
        value: k8s_openapi027::api::admissionregistration::v1beta1::MatchCondition,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::admissionregistration::v1beta1::MatchCondition, crate::Error>
    {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::admissionregistration::v1beta1::MatchCondition,
    ) -> Result<(), crate::Error> {
