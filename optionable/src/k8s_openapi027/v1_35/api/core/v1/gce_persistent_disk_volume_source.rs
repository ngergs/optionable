...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::GCEPersistentDiskVolumeSource {
    ...
    fn try_from_optioned(value: GCEPersistentDiskVolumeSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
            fs_type: crate::OptionableConvert::try_from_optioned(value.fs_type)?,
            partition: crate::OptionableConvert::try_from_optioned(value.partition)?,
            pd_name: crate::OptionableConvert::try_from_optioned(value.pd_name.ok_or(
                crate::Error {
    ...
    fn merge(&mut self, other: GCEPersistentDiskVolumeSourceAc) -> Result<(), crate::Error> {
    ...
    for GCEPersistentDiskVolumeSourceAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::GCEPersistentDiskVolumeSource, crate::Error> {
