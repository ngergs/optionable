...
impl crate::Optionable for k8s_openapi027::api::core::v1::StorageOSPersistentVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::StorageOSPersistentVolumeSource {
    ...
    fn try_from_optioned(value: StorageOSPersistentVolumeSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: StorageOSPersistentVolumeSourceAc) -> Result<(), crate::Error> {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::StorageOSPersistentVolumeSource>
    for StorageOSPersistentVolumeSourceAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::StorageOSPersistentVolumeSource, crate::Error> {
