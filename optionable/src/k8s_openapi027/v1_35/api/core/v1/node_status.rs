...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::NodeStatus {
    fn into_optioned(self) -> NodeStatusAc {
        NodeStatusAc {
            ...
            daemon_endpoints: crate::OptionableConvert::into_optioned(self.daemon_endpoints),
            declared_features: crate::OptionableConvert::into_optioned(self.declared_features),
            ...
            runtime_handlers: crate::OptionableConvert::into_optioned(self.runtime_handlers),
            volumes_attached: crate::OptionableConvert::into_optioned(self.volumes_attached),
    ...
    fn try_from_optioned(value: NodeStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            daemon_endpoints: crate::OptionableConvert::try_from_optioned(value.daemon_endpoints)?,
            ...
            runtime_handlers: crate::OptionableConvert::try_from_optioned(value.runtime_handlers)?,
            volumes_attached: crate::OptionableConvert::try_from_optioned(value.volumes_attached)?,
            volumes_in_use: crate::OptionableConvert::try_from_optioned(value.volumes_in_use)?,
        })
    }
    fn merge(&mut self, other: NodeStatusAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.daemon_endpoints, other.daemon_endpoints)?;
        crate::OptionableConvert::merge(&mut self.declared_features, other.declared_features)?;
        ...
        crate::OptionableConvert::merge(&mut self.runtime_handlers, other.runtime_handlers)?;
        crate::OptionableConvert::merge(&mut self.volumes_attached, other.volumes_attached)?;
