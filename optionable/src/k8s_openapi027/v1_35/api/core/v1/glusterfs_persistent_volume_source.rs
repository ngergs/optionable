...
pub struct GlusterfsPersistentVolumeSourceAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub endpoints_namespace: <Option<std::string::String> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi027::api::core::v1::GlusterfsPersistentVolumeSource {
...
impl crate::OptionableConvert for k8s_openapi027::api::core::v1::GlusterfsPersistentVolumeSource {
    fn into_optioned(self) -> GlusterfsPersistentVolumeSourceAc {
        GlusterfsPersistentVolumeSourceAc {
            ...
            endpoints_namespace: crate::OptionableConvert::into_optioned(self.endpoints_namespace),
            path: Some(crate::OptionableConvert::into_optioned(self.path)),
            read_only: crate::OptionableConvert::into_optioned(self.read_only),
        }
    }
    fn try_from_optioned(value: GlusterfsPersistentVolumeSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: GlusterfsPersistentVolumeSourceAc) -> Result<(), crate::Error> {
        if let Some(other_value) = other.endpoints {
            crate::OptionableConvert::merge(&mut self.endpoints, other_value)?;
        }
        crate::OptionableConvert::merge(&mut self.endpoints_namespace, other.endpoints_namespace)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::core::v1::GlusterfsPersistentVolumeSource>
    for GlusterfsPersistentVolumeSourceAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::core::v1::GlusterfsPersistentVolumeSource, crate::Error> {
