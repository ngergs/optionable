...
impl crate::Optionable for k8s_openapi027::api::apiserverinternal::v1alpha1::ServerStorageVersion {
    ...
    for k8s_openapi027::api::apiserverinternal::v1alpha1::ServerStorageVersion
{
    fn into_optioned(self) -> ServerStorageVersionAc {
        ServerStorageVersionAc {
            ...
            decodable_versions: crate::OptionableConvert::into_optioned(self.decodable_versions),
            encoding_version: crate::OptionableConvert::into_optioned(self.encoding_version),
            served_versions: crate::OptionableConvert::into_optioned(self.served_versions),
        }
    }
    fn try_from_optioned(value: ServerStorageVersionAc) -> Result<Self, crate::Error> {
        Ok(Self {
            api_server_id: crate::OptionableConvert::try_from_optioned(value.api_server_id)?,
            decodable_versions: crate::OptionableConvert::try_from_optioned(
                value.decodable_versions,
            )?,
            encoding_version: crate::OptionableConvert::try_from_optioned(value.encoding_version)?,
            served_versions: crate::OptionableConvert::try_from_optioned(value.served_versions)?,
        })
    }
    fn merge(&mut self, other: ServerStorageVersionAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.decodable_versions, other.decodable_versions)?;
        crate::OptionableConvert::merge(&mut self.encoding_version, other.encoding_version)?;
        crate::OptionableConvert::merge(&mut self.served_versions, other.served_versions)?;
        Ok(())
    }
}
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::apiserverinternal::v1alpha1::ServerStorageVersion>
    for ServerStorageVersionAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::apiserverinternal::v1alpha1::ServerStorageVersion, crate::Error>
    {
