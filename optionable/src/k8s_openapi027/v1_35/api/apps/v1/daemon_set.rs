...
pub struct DaemonSetAc {
    ...
    pub spec: Option<
        <::k8s_openapi027::api::apps::v1::DaemonSetSpec as crate::Optionable>::Optioned,
    >,
    /// The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<
        <::k8s_openapi027::api::apps::v1::DaemonSetStatus as crate::Optionable>::Optioned,
    >,
}
...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::DaemonSet {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::apps::v1::DaemonSet> for DaemonSetAc {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::apps::v1::DaemonSet,
    ) -> Result<(), crate::Error> {
...
impl k8s_openapi027::Metadata for DaemonSetAc {
    type Ty = <k8s_openapi027::api::apps::v1::DaemonSet as k8s_openapi027::Metadata>::Ty;
...
fn roundtrip_daemonsetac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::apps::v1::DaemonSet>();
}
impl k8s_openapi027::DeepMerge for DaemonSetAc {
