...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::RollingUpdateDeployment {
    ...
    fn try_from_optioned(value: RollingUpdateDeploymentAc) -> Result<Self, crate::Error> {
        Ok(Self {
...
{
    fn from_optionable(value: k8s_openapi027::api::apps::v1::RollingUpdateDeployment) -> Self {
