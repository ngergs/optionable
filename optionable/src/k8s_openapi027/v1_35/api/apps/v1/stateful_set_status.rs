...
impl crate::OptionableConvert for k8s_openapi027::api::apps::v1::StatefulSetStatus {
    fn into_optioned(self) -> StatefulSetStatusAc {
        StatefulSetStatusAc {
            ...
            current_revision: crate::OptionableConvert::into_optioned(self.current_revision),
            ...
            update_revision: crate::OptionableConvert::into_optioned(self.update_revision),
    ...
    fn try_from_optioned(value: StatefulSetStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            ...
            current_revision: crate::OptionableConvert::try_from_optioned(value.current_revision)?,
            ...
            update_revision: crate::OptionableConvert::try_from_optioned(value.update_revision)?,
    ...
    fn merge(&mut self, other: StatefulSetStatusAc) -> Result<(), crate::Error> {
        ...
        crate::OptionableConvert::merge(&mut self.current_revision, other.current_revision)?;
        ...
        crate::OptionableConvert::merge(&mut self.update_revision, other.update_revision)?;
