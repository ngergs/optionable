...
impl crate::OptionableConvert for k8s_openapi027::api::flowcontrol::v1::FlowSchemaStatus {
...
{
    fn from_optionable(value: k8s_openapi027::api::flowcontrol::v1::FlowSchemaStatus) -> Self {
