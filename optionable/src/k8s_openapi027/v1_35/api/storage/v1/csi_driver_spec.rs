...
pub struct CSIDriverSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service_account_token_in_secrets: <Option<bool> as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::OptionableConvert for k8s_openapi027::api::storage::v1::CSIDriverSpec {
    fn into_optioned(self) -> CSIDriverSpecAc {
        CSIDriverSpecAc {
            attach_required: crate::OptionableConvert::into_optioned(self.attach_required),
            fs_group_policy: crate::OptionableConvert::into_optioned(self.fs_group_policy),
            node_allocatable_update_period_seconds: crate::OptionableConvert::into_optioned(
                self.node_allocatable_update_period_seconds,
            ),
            pod_info_on_mount: crate::OptionableConvert::into_optioned(self.pod_info_on_mount),
            requires_republish: crate::OptionableConvert::into_optioned(self.requires_republish),
            se_linux_mount: crate::OptionableConvert::into_optioned(self.se_linux_mount),
            service_account_token_in_secrets: crate::OptionableConvert::into_optioned(
                self.service_account_token_in_secrets,
            ),
            storage_capacity: crate::OptionableConvert::into_optioned(self.storage_capacity),
    ...
    fn try_from_optioned(value: CSIDriverSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            attach_required: crate::OptionableConvert::try_from_optioned(value.attach_required)?,
            fs_group_policy: crate::OptionableConvert::try_from_optioned(value.fs_group_policy)?,
            ...
            se_linux_mount: crate::OptionableConvert::try_from_optioned(value.se_linux_mount)?,
            service_account_token_in_secrets: crate::OptionableConvert::try_from_optioned(
                value.service_account_token_in_secrets,
            )?,
            storage_capacity: crate::OptionableConvert::try_from_optioned(value.storage_capacity)?,
            token_requests: crate::OptionableConvert::try_from_optioned(value.token_requests)?,
    ...
    fn merge(&mut self, other: CSIDriverSpecAc) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(&mut self.attach_required, other.attach_required)?;
        crate::OptionableConvert::merge(&mut self.fs_group_policy, other.fs_group_policy)?;
        crate::OptionableConvert::merge(
            &mut self.node_allocatable_update_period_seconds,
            other.node_allocatable_update_period_seconds,
        )?;
        crate::OptionableConvert::merge(&mut self.pod_info_on_mount, other.pod_info_on_mount)?;
        crate::OptionableConvert::merge(&mut self.requires_republish, other.requires_republish)?;
        ...
        crate::OptionableConvert::merge(&mut self.storage_capacity, other.storage_capacity)?;
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::storage::v1::CSIDriverSpec> for CSIDriverSpecAc {
