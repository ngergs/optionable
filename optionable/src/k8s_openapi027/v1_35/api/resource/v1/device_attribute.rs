...
impl crate::Optionable for k8s_openapi027::api::resource::v1::DeviceAttribute {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1::DeviceAttribute {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1::DeviceAttribute>
    for DeviceAttributeAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1::DeviceAttribute) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::DeviceAttribute, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::DeviceAttribute,
    ) -> Result<(), crate::Error> {
