...
pub struct ResourceSliceSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::Device>,
    ...
    pub shared_counters: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::CounterSet>,
    > as crate::Optionable>::Optioned,
}
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1::ResourceSliceSpec) -> Self {
