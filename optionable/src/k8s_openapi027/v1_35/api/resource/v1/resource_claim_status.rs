...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1::ResourceClaimStatus {
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1::ResourceClaimStatus) -> Self {
