...
pub struct ExactDeviceRequestAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capacity: <Option<
        ::k8s_openapi027::api::resource::v1::CapacityRequirements,
    ...
    pub selectors: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1::DeviceSelector>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1::ExactDeviceRequest) -> Self {
