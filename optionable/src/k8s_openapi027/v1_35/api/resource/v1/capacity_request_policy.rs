...
pub struct CapacityRequestPolicyAc {
    ...
    pub valid_range: Option<
        <::k8s_openapi027::api::resource::v1::CapacityRequestPolicyRange as crate::Optionable>::Optioned,
    >,
...
impl crate::Optionable for k8s_openapi027::api::resource::v1::CapacityRequestPolicy {
...
for k8s_openapi027::api::resource::v1::CapacityRequestPolicy {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1::CapacityRequestPolicy>
for CapacityRequestPolicyAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1::CapacityRequestPolicy,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::CapacityRequestPolicy, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::CapacityRequestPolicy,
    ) -> Result<(), crate::Error> {
