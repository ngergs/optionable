...
impl crate::Optionable for k8s_openapi027::api::resource::v1::DeviceTaint {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1::DeviceTaint {
...
for DeviceTaintAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::DeviceTaint, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::DeviceTaint,
    ) -> Result<(), crate::Error> {
