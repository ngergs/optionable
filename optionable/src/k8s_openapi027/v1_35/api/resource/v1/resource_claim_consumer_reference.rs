...
impl crate::Optionable for k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference {
...
impl crate::OptionableConvert
    for k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference
{
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference>
    for ResourceClaimConsumerReferenceAc
{
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference, crate::Error>
    {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1::ResourceClaimConsumerReference,
    ) -> Result<(), crate::Error> {
