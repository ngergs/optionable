...
for DeviceTaintRuleAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi027::Resource for DeviceTaintRuleAc {
    const API_VERSION: &'static str = <k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule as k8s_openapi027::Resource>::API_VERSION;
    const GROUP: &'static str = <k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule as k8s_openapi027::Resource>::GROUP;
    const KIND: &'static str = <k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule as k8s_openapi027::Resource>::KIND;
    const VERSION: &'static str = <k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule as k8s_openapi027::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <k8s_openapi027::api::resource::v1alpha3::DeviceTaintRule as k8s_openapi027::Resource>::URL_PATH_SEGMENT;
...
impl k8s_openapi027::DeepMerge for DeviceTaintRuleAc {
