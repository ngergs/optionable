...
pub struct ResourceClaimSpecAc {
    ...
    pub devices: Option<
        <::k8s_openapi027::api::resource::v1beta2::DeviceClaim as crate::Optionable>::Optioned,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec {
...
for k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec>
for ResourceClaimSpecAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1beta2::ResourceClaimSpec,
    ) -> Result<(), crate::Error> {
