...
pub struct ResourceClaimStatusAc {
    ...
    pub allocation: Option<
        <::k8s_openapi027::api::resource::v1beta2::AllocationResult as crate::Optionable>::Optioned,
    >,
    /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub devices: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::AllocatedDeviceStatus as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub reserved_for: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::ResourceClaimConsumerReference as crate::Optionable>::Optioned,
        >,
    >,
}
#[automatically_derived]
impl crate::Optionable for k8s_openapi027::api::resource::v1beta2::ResourceClaimStatus {
...
for k8s_openapi027::api::resource::v1beta2::ResourceClaimStatus {
    ...
    fn merge(&mut self, other: ResourceClaimStatusAc) -> Result<(), crate::Error> {
        ...
        if self.devices.is_none() {
            ...
            crate::merge::try_merge_optioned_map(&mut self.devices, other.devices)?;
        }
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta2::ResourceClaimStatus>
for ResourceClaimStatusAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1beta2::ResourceClaimStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1beta2::ResourceClaimStatus,
    ) -> Result<(), crate::Error> {
