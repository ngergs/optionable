...
pub struct ResourceSliceSpecAc {
    ...
    pub devices: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::Device as crate::Optionable>::Optioned,
        >,
    >,
    ...
    pub shared_counters: Option<
        std::vec::Vec<
            <::k8s_openapi027::api::resource::v1beta2::CounterSet as crate::Optionable>::Optioned,
        >,
    >,
}
...
for k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec {
...
for ResourceSliceSpecAc {
    fn from_optionable(
        value: k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        k8s_openapi027::api::resource::v1beta2::ResourceSliceSpec,
        crate::Error,
    > {
