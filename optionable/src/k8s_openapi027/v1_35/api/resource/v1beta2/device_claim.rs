...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta2::DeviceClaim> for DeviceClaimAc {
    fn from_optionable(value: k8s_openapi027::api::resource::v1beta2::DeviceClaim) -> Self {
