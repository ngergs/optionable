...
pub struct DeviceSubRequestAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capacity: <Option<
        ::k8s_openapi027::api::resource::v1beta1::CapacityRequirements,
    ...
    pub selectors: <Option<
        std::vec::Vec<::k8s_openapi027::api::resource::v1beta1::DeviceSelector>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for k8s_openapi027::api::resource::v1beta1::DeviceSubRequest {
...
impl crate::OptionableConvert for k8s_openapi027::api::resource::v1beta1::DeviceSubRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::resource::v1beta1::DeviceSubRequest>
    for DeviceSubRequestAc
{
    fn from_optionable(value: k8s_openapi027::api::resource::v1beta1::DeviceSubRequest) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::resource::v1beta1::DeviceSubRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::resource::v1beta1::DeviceSubRequest,
    ) -> Result<(), crate::Error> {
