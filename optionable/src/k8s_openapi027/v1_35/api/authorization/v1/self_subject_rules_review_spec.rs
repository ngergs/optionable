...
impl crate::Optionable for k8s_openapi027::api::authorization::v1::SelfSubjectRulesReviewSpec {
    ...
    for k8s_openapi027::api::authorization::v1::SelfSubjectRulesReviewSpec
{
    ...
    fn try_from_optioned(value: SelfSubjectRulesReviewSpecAc) -> Result<Self, crate::Error> {
        Ok(Self {
            namespace: crate::OptionableConvert::try_from_optioned(value.namespace)?,
        })
    }
    fn merge(&mut self, other: SelfSubjectRulesReviewSpecAc) -> Result<(), crate::Error> {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::authorization::v1::SelfSubjectRulesReviewSpec>
    for SelfSubjectRulesReviewSpecAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::authorization::v1::SelfSubjectRulesReviewSpec, crate::Error>
    {
