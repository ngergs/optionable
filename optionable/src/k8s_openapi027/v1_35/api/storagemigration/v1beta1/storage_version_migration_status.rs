...
impl crate::Optionable
    for k8s_openapi027::api::storagemigration::v1beta1::StorageVersionMigrationStatus
{
    ...
    for k8s_openapi027::api::storagemigration::v1beta1::StorageVersionMigrationStatus
{
    ...
    fn try_from_optioned(value: StorageVersionMigrationStatusAc) -> Result<Self, crate::Error> {
        Ok(Self {
            conditions: crate::OptionableConvert::try_from_optioned(value.conditions)?,
            resource_version: crate::OptionableConvert::try_from_optioned(value.resource_version)?,
        })
    }
    fn merge(&mut self, other: StorageVersionMigrationStatusAc) -> Result<(), crate::Error> {
...
{
    fn from_optionable(
        value: k8s_openapi027::api::storagemigration::v1beta1::StorageVersionMigrationStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::storagemigration::v1beta1::StorageVersionMigrationStatus,
    ) -> Result<(), crate::Error> {
