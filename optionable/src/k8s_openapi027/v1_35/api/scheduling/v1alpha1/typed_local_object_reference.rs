...
impl crate::Optionable for k8s_openapi027::api::scheduling::v1alpha1::TypedLocalObjectReference {
    ...
    for k8s_openapi027::api::scheduling::v1alpha1::TypedLocalObjectReference
{
    ...
    fn try_from_optioned(value: TypedLocalObjectReferenceAc) -> Result<Self, crate::Error> {
        Ok(Self {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::scheduling::v1alpha1::TypedLocalObjectReference>
    for TypedLocalObjectReferenceAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::scheduling::v1alpha1::TypedLocalObjectReference, crate::Error>
    {
