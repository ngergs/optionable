...
impl crate::Optionable for k8s_openapi027::api::scheduling::v1alpha1::Workload {
...
impl crate::OptionableConvert for k8s_openapi027::api::scheduling::v1alpha1::Workload {
...
for WorkloadAc {
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::scheduling::v1alpha1::Workload, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::scheduling::v1alpha1::Workload,
    ) -> Result<(), crate::Error> {
