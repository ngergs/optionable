...
impl crate::Optionable for k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource {
...
impl crate::OptionableConvert
    for k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource
{
    ...
    fn try_from_optioned(value: ContainerResourceMetricSourceAc) -> Result<Self, crate::Error> {
        Ok(Self {
            container: crate::OptionableConvert::try_from_optioned(value.container.ok_or(
                crate::Error {
    ...
    fn merge(&mut self, other: ContainerResourceMetricSourceAc) -> Result<(), crate::Error> {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource>
    for ContainerResourceMetricSourceAc
{
    fn from_optionable(
        value: k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource, crate::Error>
    {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut k8s_openapi027::api::autoscaling::v2::ContainerResourceMetricSource,
    ) -> Result<(), crate::Error> {
