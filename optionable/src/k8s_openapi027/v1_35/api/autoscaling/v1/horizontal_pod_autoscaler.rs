...
impl crate::Optionable for k8s_openapi027::api::autoscaling::v1::HorizontalPodAutoscaler {
...
impl crate::OptionableConvert for k8s_openapi027::api::autoscaling::v1::HorizontalPodAutoscaler {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<k8s_openapi027::api::autoscaling::v1::HorizontalPodAutoscaler>
    for HorizontalPodAutoscalerAc
{
    ...
    fn try_into_optionable(
        self,
    ) -> Result<k8s_openapi027::api::autoscaling::v1::HorizontalPodAutoscaler, crate::Error> {
...
fn roundtrip_horizontalpodautoscalerac() {
    crate::testutil::roundtrip_test::<k8s_openapi027::api::autoscaling::v1::HorizontalPodAutoscaler>(
    );
}
