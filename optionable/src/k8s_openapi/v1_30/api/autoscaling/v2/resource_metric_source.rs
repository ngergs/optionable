...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::autoscaling::v2::ResourceMetricSource>
for ResourceMetricSourceAc {
    fn from_optionable(
        value: ::k8s_openapi::api::autoscaling::v2::ResourceMetricSource,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::autoscaling::v2::ResourceMetricSource,
    ) -> Result<(), crate::Error> {
