...
impl crate::OptionedConvert<
    ::k8s_openapi::api::authorization::v1::SelfSubjectRulesReviewSpec,
> for SelfSubjectRulesReviewSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::authorization::v1::SelfSubjectRulesReviewSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::authorization::v1::SelfSubjectRulesReviewSpec,
    ) -> Result<(), crate::Error> {
