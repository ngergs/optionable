...
pub struct PolicyRulesWithSubjectsAc {
    ...
    pub non_resource_rules: <Option<
        std::vec::Vec<::k8s_openapi::api::flowcontrol::v1beta3::NonResourcePolicyRule>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_rules: <Option<
        std::vec::Vec<::k8s_openapi::api::flowcontrol::v1beta3::ResourcePolicyRule>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subjects: Option<
        <std::vec::Vec<
            ::k8s_openapi::api::flowcontrol::v1beta3::Subject,
        > as crate::Optionable>::Optioned,
    >,
}
