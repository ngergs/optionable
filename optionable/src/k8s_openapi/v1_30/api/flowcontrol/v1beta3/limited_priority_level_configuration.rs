...
pub struct LimitedPriorityLevelConfigurationAc {
    ...
    pub limit_response: <Option<
        ::k8s_openapi::api::flowcontrol::v1beta3::LimitResponse,
...
for ::k8s_openapi::api::flowcontrol::v1beta3::LimitedPriorityLevelConfiguration {
...
> for LimitedPriorityLevelConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1beta3::LimitedPriorityLevelConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1beta3::LimitedPriorityLevelConfiguration,
    ) -> Result<(), crate::Error> {
