...
for ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextSpec {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextSpec,
> for PodSchedulingContextSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextSpec,
    ) -> Result<(), crate::Error> {
