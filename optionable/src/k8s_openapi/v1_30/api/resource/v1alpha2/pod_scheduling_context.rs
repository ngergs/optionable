...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1alpha2::PodSchedulingContext>
for PodSchedulingContextAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContext,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContext,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContext,
    ) -> Result<(), crate::Error> {
