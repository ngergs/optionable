...
for ::k8s_openapi::api::resource::v1alpha2::ResourceClassParametersReference {
...
> for ResourceClassParametersReferenceAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::ResourceClassParametersReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::ResourceClassParametersReference,
    ) -> Result<(), crate::Error> {
