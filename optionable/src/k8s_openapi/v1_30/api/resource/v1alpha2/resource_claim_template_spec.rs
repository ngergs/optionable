...
for ::k8s_openapi::api::resource::v1alpha2::ResourceClaimTemplateSpec {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha2::ResourceClaimTemplateSpec,
> for ResourceClaimTemplateSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::ResourceClaimTemplateSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::ResourceClaimTemplateSpec,
    ) -> Result<(), crate::Error> {
