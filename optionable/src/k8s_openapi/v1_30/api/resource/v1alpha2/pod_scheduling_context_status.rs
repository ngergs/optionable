...
for ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextStatus {
...
> for PodSchedulingContextStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::PodSchedulingContextStatus,
    ) -> Result<(), crate::Error> {
