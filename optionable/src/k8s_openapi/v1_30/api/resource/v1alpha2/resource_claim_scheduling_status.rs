...
for ::k8s_openapi::api::resource::v1alpha2::ResourceClaimSchedulingStatus {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha2::ResourceClaimSchedulingStatus,
> for ResourceClaimSchedulingStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha2::ResourceClaimSchedulingStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha2::ResourceClaimSchedulingStatus,
    ) -> Result<(), crate::Error> {
