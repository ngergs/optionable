...
pub struct ValidatingAdmissionPolicySpecAc {
    ...
    pub validations: <Option<
        std::vec::Vec<::k8s_openapi::api::admissionregistration::v1alpha1::Validation>,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
...
for ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicySpec {
...
> for ValidatingAdmissionPolicySpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicySpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicySpec,
    ) -> Result<(), crate::Error> {
