...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta2::ResourceClaimTemplate>
for ResourceClaimTemplateAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::ResourceClaimTemplate,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::resource::v1beta2::ResourceClaimTemplate,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::ResourceClaimTemplate,
    ) -> Result<(), crate::Error> {
