...
for ::k8s_openapi::api::resource::v1beta2::OpaqueDeviceConfiguration {
...
> for OpaqueDeviceConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::OpaqueDeviceConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::OpaqueDeviceConfiguration,
    ) -> Result<(), crate::Error> {
