...
pub struct AllocatedDeviceStatusAc {
    ...
    pub network_data: <Option<
        ::k8s_openapi::api::resource::v1beta2::NetworkDeviceData,
    > as crate::Optionable>::Optioned,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pool: Option<<std::string::String as crate::Optionable>::Optioned>,
}
#[automatically_derived]
impl crate::Optionable for ::k8s_openapi::api::resource::v1beta2::AllocatedDeviceStatus {
...
for ::k8s_openapi::api::resource::v1beta2::AllocatedDeviceStatus {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta2::AllocatedDeviceStatus>
for AllocatedDeviceStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::AllocatedDeviceStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::AllocatedDeviceStatus,
    ) -> Result<(), crate::Error> {
