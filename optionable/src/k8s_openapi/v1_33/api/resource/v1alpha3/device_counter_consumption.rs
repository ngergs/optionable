...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha3::DeviceCounterConsumption,
> for DeviceCounterConsumptionAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::DeviceCounterConsumption,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::DeviceCounterConsumption,
    ) -> Result<(), crate::Error> {
