...
pub struct DeviceRequestAc {
    ...
    pub first_available: <Option<
        std::vec::Vec<::k8s_openapi::api::resource::v1alpha3::DeviceSubRequest>,
    ...
    pub tolerations: <Option<
        std::vec::Vec<::k8s_openapi::api::resource::v1alpha3::DeviceToleration>,
    > as crate::Optionable>::Optioned,
}
#[automatically_derived]
impl crate::Optionable for ::k8s_openapi::api::resource::v1alpha3::DeviceRequest {
...
impl crate::OptionableConvert for ::k8s_openapi::api::resource::v1alpha3::DeviceRequest {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1alpha3::DeviceRequest>
for DeviceRequestAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::DeviceRequest,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<::k8s_openapi::api::resource::v1alpha3::DeviceRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::DeviceRequest,
    ) -> Result<(), crate::Error> {
