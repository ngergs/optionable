...
impl crate::Optionable for ::k8s_openapi::api::resource::v1alpha3::NetworkDeviceData {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1alpha3::NetworkDeviceData>
for NetworkDeviceDataAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::NetworkDeviceData,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::resource::v1alpha3::NetworkDeviceData,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::NetworkDeviceData,
    ) -> Result<(), crate::Error> {
