...
pub struct ResourceSliceSpecAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pool: Option<
        <::k8s_openapi::api::resource::v1beta1::ResourcePool as crate::Optionable>::Optioned,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Optionable for ::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec>
for ResourceSliceSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec,
    ) -> Result<(), crate::Error> {
