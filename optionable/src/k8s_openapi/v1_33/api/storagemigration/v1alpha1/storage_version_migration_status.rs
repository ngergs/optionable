...
> for StorageVersionMigrationStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::storagemigration::v1alpha1::StorageVersionMigrationStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::storagemigration::v1alpha1::StorageVersionMigrationStatus,
    ) -> Result<(), crate::Error> {
