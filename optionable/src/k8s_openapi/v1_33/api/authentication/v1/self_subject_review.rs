...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::authentication::v1::SelfSubjectReview>
for SelfSubjectReviewAc {
    fn from_optionable(
        value: ::k8s_openapi::api::authentication::v1::SelfSubjectReview,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::authentication::v1::SelfSubjectReview,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::authentication::v1::SelfSubjectReview,
    ) -> Result<(), crate::Error> {
