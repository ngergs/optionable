...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass>
for VolumeAttributesClassAc {
    fn from_optionable(
        value: ::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass,
    ) -> Result<(), crate::Error> {
        crate::OptionableConvert::merge(other, self)
    }
}
impl k8s_openapi::Resource for VolumeAttributesClassAc {
    const API_VERSION: &'static str = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::API_VERSION;
    const GROUP: &'static str = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::GROUP;
    const KIND: &'static str = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::KIND;
    const VERSION: &'static str = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::VERSION;
    const URL_PATH_SEGMENT: &'static str = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::URL_PATH_SEGMENT;
    type Scope = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Resource>::Scope;
}
impl k8s_openapi::Metadata for VolumeAttributesClassAc {
    type Ty = <::k8s_openapi::api::storage::v1beta1::VolumeAttributesClass as k8s_openapi::Metadata>::Ty;
