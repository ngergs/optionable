...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::storage::v1::CSIDriver> for CSIDriverAc {
    fn from_optionable(value: ::k8s_openapi::api::storage::v1::CSIDriver) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<::k8s_openapi::api::storage::v1::CSIDriver, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::storage::v1::CSIDriver,
    ) -> Result<(), crate::Error> {
...
fn roundtrip_csidriverac() {
    crate::testutil::roundtrip_test::<::k8s_openapi::api::storage::v1::CSIDriver>();
}
