...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::networking::v1beta1::ServiceCIDRStatus>
for ServiceCIDRStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::networking::v1beta1::ServiceCIDRStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::networking::v1beta1::ServiceCIDRStatus,
    ) -> Result<(), crate::Error> {
