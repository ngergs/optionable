...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::admissionregistration::v1::TypeChecking>
for TypeCheckingAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1::TypeChecking,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1::TypeChecking,
    ) -> Result<(), crate::Error> {
