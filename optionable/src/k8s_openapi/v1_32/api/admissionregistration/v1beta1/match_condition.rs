...
for ::k8s_openapi::api::admissionregistration::v1beta1::MatchCondition {
...
> for MatchConditionAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1beta1::MatchCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1beta1::MatchCondition,
    ) -> Result<(), crate::Error> {
