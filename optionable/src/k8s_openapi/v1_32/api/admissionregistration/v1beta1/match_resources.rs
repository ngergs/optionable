...
pub struct MatchResourcesAc {
    ...
    pub exclude_resource_rules: <Option<
        std::vec::Vec<
            ::k8s_openapi::api::admissionregistration::v1beta1::NamedRuleWithOperations,
        >,
...
for ::k8s_openapi::api::admissionregistration::v1beta1::MatchResources {
...
> for MatchResourcesAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1beta1::MatchResources,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1beta1::MatchResources,
    ) -> Result<(), crate::Error> {
