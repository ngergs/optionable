...
impl crate::Optionable for ::k8s_openapi::api::admissionregistration::v1beta1::Variable {
...
for ::k8s_openapi::api::admissionregistration::v1beta1::Variable {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::admissionregistration::v1beta1::Variable>
for VariableAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1beta1::Variable,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1beta1::Variable,
    ) -> Result<(), crate::Error> {
