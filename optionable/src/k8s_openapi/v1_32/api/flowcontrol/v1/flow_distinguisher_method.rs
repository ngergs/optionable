...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::flowcontrol::v1::FlowDistinguisherMethod>
for FlowDistinguisherMethodAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1::FlowDistinguisherMethod,
    ) -> Result<(), crate::Error> {
