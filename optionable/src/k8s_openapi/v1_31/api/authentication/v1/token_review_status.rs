...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::authentication::v1::TokenReviewStatus>
for TokenReviewStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::authentication::v1::TokenReviewStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::authentication::v1::TokenReviewStatus,
    ) -> Result<(), crate::Error> {
