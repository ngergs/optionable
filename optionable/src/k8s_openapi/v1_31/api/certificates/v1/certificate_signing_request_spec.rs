...
impl crate::OptionedConvert<
    ::k8s_openapi::api::certificates::v1::CertificateSigningRequestSpec,
> for CertificateSigningRequestSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::certificates::v1::CertificateSigningRequestSpec,
    ) -> Result<(), crate::Error> {
