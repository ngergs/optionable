...
impl crate::OptionedConvert<
    ::k8s_openapi::api::flowcontrol::v1::PriorityLevelConfigurationReference,
> for PriorityLevelConfigurationReferenceAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1::PriorityLevelConfigurationReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1::PriorityLevelConfigurationReference,
    ) -> Result<(), crate::Error> {
