...
impl crate::OptionedConvert<
    ::k8s_openapi::api::flowcontrol::v1beta3::ExemptPriorityLevelConfiguration,
> for ExemptPriorityLevelConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1beta3::ExemptPriorityLevelConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1beta3::ExemptPriorityLevelConfiguration,
    ) -> Result<(), crate::Error> {
