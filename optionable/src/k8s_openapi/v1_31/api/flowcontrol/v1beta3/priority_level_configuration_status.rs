...
> for PriorityLevelConfigurationStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1beta3::PriorityLevelConfigurationStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1beta3::PriorityLevelConfigurationStatus,
    ) -> Result<(), crate::Error> {
