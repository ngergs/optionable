...
> for PriorityLevelConfigurationConditionAc {
    fn from_optionable(
        value: ::k8s_openapi::api::flowcontrol::v1beta3::PriorityLevelConfigurationCondition,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::flowcontrol::v1beta3::PriorityLevelConfigurationCondition,
    ) -> Result<(), crate::Error> {
