...
for ::k8s_openapi::api::resource::v1alpha3::DeviceAllocationConfiguration {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha3::DeviceAllocationConfiguration,
> for DeviceAllocationConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::DeviceAllocationConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::DeviceAllocationConfiguration,
    ) -> Result<(), crate::Error> {
