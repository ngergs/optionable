...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1alpha3::ResourceClaimTemplate,
> for ResourceClaimTemplateAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::ResourceClaimTemplate,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::ResourceClaimTemplate,
    ) -> Result<(), crate::Error> {
