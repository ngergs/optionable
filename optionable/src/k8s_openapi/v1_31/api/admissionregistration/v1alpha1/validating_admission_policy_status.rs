...
> for ValidatingAdmissionPolicyStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyStatus,
    ) -> Result<(), crate::Error> {
