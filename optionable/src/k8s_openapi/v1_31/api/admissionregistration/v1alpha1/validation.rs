...
for ::k8s_openapi::api::admissionregistration::v1alpha1::Validation {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::admissionregistration::v1alpha1::Validation,
> for ValidationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1alpha1::Validation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1alpha1::Validation,
    ) -> Result<(), crate::Error> {
