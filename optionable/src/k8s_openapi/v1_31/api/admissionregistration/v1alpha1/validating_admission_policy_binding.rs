...
> for ValidatingAdmissionPolicyBindingAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBinding,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1alpha1::ValidatingAdmissionPolicyBinding,
    ) -> Result<(), crate::Error> {
