...
> for APIServiceSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::kube_aggregator::pkg::apis::apiregistration::v1::APIServiceSpec,
    ) -> Result<(), crate::Error> {
