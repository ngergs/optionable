...
#[automatically_derived]
impl crate::Optionable for StatefulSetOpt {
    type Optioned = StatefulSetOpt;
}
#[automatically_derived]
impl crate::OptionableConvert for ::k8s_openapi::api::apps::v1::StatefulSet {
    ...
    fn merge(&mut self, other: StatefulSetOpt) -> Result<(), crate::optionable::Error> {
