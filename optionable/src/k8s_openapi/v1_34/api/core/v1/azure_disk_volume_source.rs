...
for ::k8s_openapi::api::core::v1::azure_disk_volume_source::AzureDiskVolumeSource {
...
for ::k8s_openapi::api::core::v1::azure_disk_volume_source::AzureDiskVolumeSource {
    fn into_optioned(self) -> AzureDiskVolumeSourceOpt {
        AzureDiskVolumeSourceOpt {
            caching_mode: <Option<
                std::string::String,
            > as crate::OptionableConvert>::into_optioned(self.caching_mode),
            disk_name: Some(
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            caching_mode: <Option<
                std::string::String,
            > as crate::OptionableConvert>::try_from_optioned(value.caching_mode)?,
            disk_name: <std::string::String as crate::OptionableConvert>::try_from_optioned(
                value
                    .disk_name
            ...
            disk_uri: <std::string::String as crate::OptionableConvert>::try_from_optioned(
                value
                    .disk_uri
                    .ok_or(crate::optionable::Error {
