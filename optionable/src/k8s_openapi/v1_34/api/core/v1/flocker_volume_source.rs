...
for ::k8s_openapi::api::core::v1::flocker_volume_source::FlockerVolumeSource {
...
for ::k8s_openapi::api::core::v1::flocker_volume_source::FlockerVolumeSource {
    fn into_optioned(self) -> FlockerVolumeSourceOpt {
        FlockerVolumeSourceOpt {
            dataset_name: <Option<
                std::string::String,
            > as crate::OptionableConvert>::into_optioned(self.dataset_name),
            dataset_uuid: <Option<
                std::string::String,
            > as crate::OptionableConvert>::into_optioned(self.dataset_uuid),
        }
    }
    fn try_from_optioned(
        ...
        Ok(Self {
            dataset_name: <Option<
                std::string::String,
            > as crate::OptionableConvert>::try_from_optioned(value.dataset_name)?,
            dataset_uuid: <Option<
                std::string::String,
            > as crate::OptionableConvert>::try_from_optioned(value.dataset_uuid)?,
        })
    }
    fn merge(
        &mut self,
