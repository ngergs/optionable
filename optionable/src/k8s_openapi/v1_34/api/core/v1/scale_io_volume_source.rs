...
for ::k8s_openapi::api::core::v1::scale_io_volume_source::ScaleIOVolumeSource {
...
for ::k8s_openapi::api::core::v1::scale_io_volume_source::ScaleIOVolumeSource {
    fn into_optioned(self) -> ScaleIOVolumeSourceOpt {
        ScaleIOVolumeSourceOpt {
            ...
            secret_ref: Some(
                <::k8s_openapi::api::core::v1::LocalObjectReference as crate::OptionableConvert>::into_optioned(
                    self.secret_ref,
                ),
            ),
            ssl_enabled: <Option<
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            secret_ref: <::k8s_openapi::api::core::v1::LocalObjectReference as crate::OptionableConvert>::try_from_optioned(
                value
                    .secret_ref
                    .ok_or(crate::optionable::Error {
    ...
    fn merge(
        ...
        if let Some(other_value) = other.secret_ref {
            <::k8s_openapi::api::core::v1::LocalObjectReference as crate::OptionableConvert>::merge(
                &mut self.secret_ref,
                other_value,
            )?;
        }
