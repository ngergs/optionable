...
for ::k8s_openapi::api::core::v1::persistent_volume_claim_spec::PersistentVolumeClaimSpec {
...
for ::k8s_openapi::api::core::v1::persistent_volume_claim_spec::PersistentVolumeClaimSpec {
    fn into_optioned(self) -> PersistentVolumeClaimSpecOpt {
        PersistentVolumeClaimSpecOpt {
            ...
            data_source: <Option<
                ::k8s_openapi::api::core::v1::TypedLocalObjectReference,
            > as crate::OptionableConvert>::into_optioned(self.data_source),
            data_source_ref: <Option<
                ::k8s_openapi::api::core::v1::TypedObjectReference,
            > as crate::OptionableConvert>::into_optioned(self.data_source_ref),
            resources: <Option<
                ::k8s_openapi::api::core::v1::VolumeResourceRequirements,
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            data_source: <Option<
                ::k8s_openapi::api::core::v1::TypedLocalObjectReference,
            > as crate::OptionableConvert>::try_from_optioned(value.data_source)?,
            data_source_ref: <Option<
                ::k8s_openapi::api::core::v1::TypedObjectReference,
            > as crate::OptionableConvert>::try_from_optioned(value.data_source_ref)?,
            resources: <Option<
                ::k8s_openapi::api::core::v1::VolumeResourceRequirements,
    ...
    fn merge(
        ...
        <Option<
            ::k8s_openapi::api::core::v1::TypedLocalObjectReference,
        > as crate::OptionableConvert>::merge(&mut self.data_source, other.data_source)?;
        <Option<
            ::k8s_openapi::api::core::v1::TypedObjectReference,
        > as crate::OptionableConvert>::merge(
