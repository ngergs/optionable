...
#[automatically_derived]
impl crate::Optionable for NodeOpt {
    type Optioned = NodeOpt;
}
#[automatically_derived]
impl crate::OptionableConvert for ::k8s_openapi::api::core::v1::Node {
    ...
    fn try_from_optioned(value: NodeOpt) -> Result<Self, crate::optionable::Error> {
        Ok(Self {
    ...
    fn merge(&mut self, other: NodeOpt) -> Result<(), crate::optionable::Error> {
