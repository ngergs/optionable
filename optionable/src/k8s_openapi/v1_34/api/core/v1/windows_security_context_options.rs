...
for ::k8s_openapi::api::core::v1::WindowsSecurityContextOptions {
    fn into_optioned(self) -> WindowsSecurityContextOptionsOpt {
        WindowsSecurityContextOptionsOpt {
            gmsa_credential_spec: <Option<
                std::string::String,
            > as crate::OptionableConvert>::into_optioned(self.gmsa_credential_spec),
            gmsa_credential_spec_name: <Option<
                std::string::String,
            ...
            host_process: <Option<
                bool,
            > as crate::OptionableConvert>::into_optioned(self.host_process),
            run_as_user_name: <Option<
                std::string::String,
            > as crate::OptionableConvert>::into_optioned(self.run_as_user_name),
        }
    }
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            host_process: <Option<
                bool,
            > as crate::OptionableConvert>::try_from_optioned(value.host_process)?,
            run_as_user_name: <Option<
                std::string::String,
            > as crate::OptionableConvert>::try_from_optioned(value.run_as_user_name)?,
        })
    }
    fn merge(
        &mut self,
