        ...
        OverheadOpt {
            pod_fixed: <Option<
                std::collections::BTreeMap<
                    ...
                    ::k8s_openapi::apimachinery::pkg::api::resource::Quantity,
                >,
            > as crate::OptionableConvert>::into_optioned(self.pod_fixed),
        }
    }
        ...
        Ok(Self {
            pod_fixed: <Option<
                std::collections::BTreeMap<
                    ...
                    ::k8s_openapi::apimachinery::pkg::api::resource::Quantity,
                >,
            > as crate::OptionableConvert>::try_from_optioned(value.pod_fixed)?,
        })
    }
    fn merge(&mut self, other: OverheadOpt) -> Result<(), crate::optionable::Error> {
        <Option<
            std::collections::BTreeMap<
                ...
                ::k8s_openapi::apimachinery::pkg::api::resource::Quantity,
            >,
        > as crate::OptionableConvert>::merge(&mut self.pod_fixed, other.pod_fixed)?;
        Ok(())
    }
}
