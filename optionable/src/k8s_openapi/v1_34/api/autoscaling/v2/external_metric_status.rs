...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::autoscaling::v2::ExternalMetricStatus>
for ExternalMetricStatusAc {
    fn from_optionable(
        value: ::k8s_openapi::api::autoscaling::v2::ExternalMetricStatus,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::autoscaling::v2::ExternalMetricStatus,
    ) -> Result<(), crate::Error> {
