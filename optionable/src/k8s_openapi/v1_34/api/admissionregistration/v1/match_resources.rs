...
for ::k8s_openapi::api::admissionregistration::v1::MatchResources {
...
> for MatchResourcesAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1::MatchResources,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1::MatchResources,
    ) -> Result<(), crate::Error> {
