...
> for NamedRuleWithOperationsAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1alpha1::NamedRuleWithOperations,
    ) -> Result<(), crate::Error> {
