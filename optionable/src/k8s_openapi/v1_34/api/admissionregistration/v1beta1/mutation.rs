...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::admissionregistration::v1beta1::Mutation>
for MutationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1beta1::Mutation,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1beta1::Mutation,
    ) -> Result<(), crate::Error> {
