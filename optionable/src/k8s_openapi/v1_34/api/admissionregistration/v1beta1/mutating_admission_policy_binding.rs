...
impl crate::OptionedConvert<
    ::k8s_openapi::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBinding,
> for MutatingAdmissionPolicyBindingAc {
    fn from_optionable(
        value: ::k8s_openapi::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBinding,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::admissionregistration::v1beta1::MutatingAdmissionPolicyBinding,
    ) -> Result<(), crate::Error> {
