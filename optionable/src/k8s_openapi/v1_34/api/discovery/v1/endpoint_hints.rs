...
impl crate::OptionableConvert for ::k8s_openapi::api::discovery::v1::EndpointHints {
    fn into_optioned(self) -> EndpointHintsOpt {
        EndpointHintsOpt {
            for_nodes: <Option<
                std::vec::Vec<::k8s_openapi::api::discovery::v1::ForNode>,
            > as crate::OptionableConvert>::into_optioned(self.for_nodes),
            for_zones: <Option<
                std::vec::Vec<::k8s_openapi::api::discovery::v1::ForZone>,
            > as crate::OptionableConvert>::into_optioned(self.for_zones),
        }
    }
    fn try_from_optioned(
        ...
        Ok(Self {
            for_nodes: <Option<
                std::vec::Vec<::k8s_openapi::api::discovery::v1::ForNode>,
            > as crate::OptionableConvert>::try_from_optioned(value.for_nodes)?,
            for_zones: <Option<
                std::vec::Vec<::k8s_openapi::api::discovery::v1::ForZone>,
            > as crate::OptionableConvert>::try_from_optioned(value.for_zones)?,
        })
    }
    fn merge(
        &mut self,
        ...
        <Option<
            std::vec::Vec<::k8s_openapi::api::discovery::v1::ForNode>,
        > as crate::OptionableConvert>::merge(&mut self.for_nodes, other.for_nodes)?;
        <Option<
            std::vec::Vec<::k8s_openapi::api::discovery::v1::ForZone>,
        > as crate::OptionableConvert>::merge(&mut self.for_zones, other.for_zones)?;
        Ok(())
    }
}
