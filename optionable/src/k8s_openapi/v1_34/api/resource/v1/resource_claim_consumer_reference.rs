...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1::ResourceClaimConsumerReference,
> for ResourceClaimConsumerReferenceAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1::ResourceClaimConsumerReference,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1::ResourceClaimConsumerReference,
    ) -> Result<(), crate::Error> {
