...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1::OpaqueDeviceConfiguration>
for OpaqueDeviceConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1::OpaqueDeviceConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1::OpaqueDeviceConfiguration,
    ) -> Result<(), crate::Error> {
