...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1::DeviceClaimConfiguration>
for DeviceClaimConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1::DeviceClaimConfiguration,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::resource::v1::DeviceClaimConfiguration,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1::DeviceClaimConfiguration,
    ) -> Result<(), crate::Error> {
