...
impl crate::Optionable for ::k8s_openapi::api::resource::v1::CapacityRequestPolicyRange {
...
for ::k8s_openapi::api::resource::v1::CapacityRequestPolicyRange {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1::CapacityRequestPolicyRange>
for CapacityRequestPolicyRangeAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1::CapacityRequestPolicyRange,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1::CapacityRequestPolicyRange,
    ) -> Result<(), crate::Error> {
