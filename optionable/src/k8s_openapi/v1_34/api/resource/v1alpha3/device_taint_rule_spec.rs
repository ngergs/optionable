...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec>
for DeviceTaintRuleSpecAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec,
    ) -> Self {
    ...
    fn try_into_optionable(
        ...
        ::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec,
        crate::Error,
    > {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec,
    ) -> Result<(), crate::Error> {
