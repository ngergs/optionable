...
for ::k8s_openapi::api::resource::v1alpha3::DeviceTaintRule {
    fn into_optioned(self) -> DeviceTaintRuleOpt {
        DeviceTaintRuleOpt {
            ...
            spec: Some(
                <::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec as crate::OptionableConvert>::into_optioned(
                    self.spec,
                ),
            ),
        }
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            spec: <::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec as crate::OptionableConvert>::try_from_optioned(
                value
                    .spec
                    .ok_or(crate::optionable::Error {
                        missing_field: "spec",
    ...
    fn merge(
        ...
        if let Some(other_value) = other.spec {
            <::k8s_openapi::api::resource::v1alpha3::DeviceTaintRuleSpec as crate::OptionableConvert>::merge(
                &mut self.spec,
                other_value,
            )?;
        }
