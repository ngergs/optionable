...
for ::k8s_openapi::api::resource::v1beta1::DeviceClaimConfiguration {
...
impl crate::OptionedConvert<
    ::k8s_openapi::api::resource::v1beta1::DeviceClaimConfiguration,
> for DeviceClaimConfigurationAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta1::DeviceClaimConfiguration,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta1::DeviceClaimConfiguration,
    ) -> Result<(), crate::Error> {
