...
for ::k8s_openapi::api::resource::v1beta1::resource_claim_template_spec::ResourceClaimTemplateSpec {
...
for ::k8s_openapi::api::resource::v1beta1::resource_claim_template_spec::ResourceClaimTemplateSpec {
    fn into_optioned(self) -> ResourceClaimTemplateSpecOpt {
        ResourceClaimTemplateSpecOpt {
            ...
            spec: Some(
                <::k8s_openapi::api::resource::v1beta1::ResourceClaimSpec as crate::OptionableConvert>::into_optioned(
                    self.spec,
                ),
            ),
        }
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            spec: <::k8s_openapi::api::resource::v1beta1::ResourceClaimSpec as crate::OptionableConvert>::try_from_optioned(
                value
                    .spec
    ...
    fn merge(
        ...
        if let Some(other_value) = other.spec {
            <::k8s_openapi::api::resource::v1beta1::ResourceClaimSpec as crate::OptionableConvert>::merge(
                &mut self.spec,
                other_value,
            )?;
        }
