...
for ::k8s_openapi::api::resource::v1beta1::DeviceRequestAllocationResult {
...
> for DeviceRequestAllocationResultAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta1::DeviceRequestAllocationResult,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta1::DeviceRequestAllocationResult,
    ) -> Result<(), crate::Error> {
