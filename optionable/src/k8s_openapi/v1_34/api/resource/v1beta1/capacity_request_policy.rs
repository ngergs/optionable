...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta1::CapacityRequestPolicy>
for CapacityRequestPolicyAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta1::CapacityRequestPolicy,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta1::CapacityRequestPolicy,
    ) -> Result<(), crate::Error> {
