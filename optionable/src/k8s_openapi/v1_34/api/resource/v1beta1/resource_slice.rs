...
pub struct ResourceSliceAc {
    ...
    pub spec: Option<
        <::k8s_openapi::api::resource::v1beta1::ResourceSliceSpec as crate::Optionable>::Optioned,
    >,
    #[serde(
        flatten,
...
impl crate::OptionableConvert for ::k8s_openapi::api::resource::v1beta1::ResourceSlice {
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta1::ResourceSlice>
for ResourceSliceAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta1::ResourceSlice,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<::k8s_openapi::api::resource::v1beta1::ResourceSlice, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta1::ResourceSlice,
    ) -> Result<(), crate::Error> {
...
fn roundtrip_resourcesliceac() {
    crate::testutil::roundtrip_test::<
        ::k8s_openapi::api::resource::v1beta1::ResourceSlice,
    >();
}
