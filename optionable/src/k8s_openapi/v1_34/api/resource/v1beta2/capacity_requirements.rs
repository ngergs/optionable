...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta2::CapacityRequirements>
for CapacityRequirementsAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::CapacityRequirements,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::CapacityRequirements,
    ) -> Result<(), crate::Error> {
