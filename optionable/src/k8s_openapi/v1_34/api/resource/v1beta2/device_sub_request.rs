...
pub struct DeviceSubRequestAc {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capacity: <Option<
        ::k8s_openapi::api::resource::v1beta2::CapacityRequirements,
...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta2::DeviceSubRequest>
for DeviceSubRequestAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::DeviceSubRequest,
    ) -> Self {
        crate::OptionableConvert::into_optioned(value)
    }
    fn try_into_optionable(
        self,
    ) -> Result<::k8s_openapi::api::resource::v1beta2::DeviceSubRequest, crate::Error> {
        crate::OptionableConvert::try_from_optioned(self)
    }
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::DeviceSubRequest,
    ) -> Result<(), crate::Error> {
