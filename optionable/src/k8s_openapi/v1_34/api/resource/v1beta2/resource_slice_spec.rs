...
for ::k8s_openapi::api::resource::v1beta2::resource_slice_spec::ResourceSliceSpec {
...
for ::k8s_openapi::api::resource::v1beta2::resource_slice_spec::ResourceSliceSpec {
    fn into_optioned(self) -> ResourceSliceSpecOpt {
        ResourceSliceSpecOpt {
            ...
            pool: Some(
                <::k8s_openapi::api::resource::v1beta2::ResourcePool as crate::OptionableConvert>::into_optioned(
                    self.pool,
                ),
            ),
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            pool: <::k8s_openapi::api::resource::v1beta2::ResourcePool as crate::OptionableConvert>::try_from_optioned(
                value
                    .pool
                    .ok_or(crate::optionable::Error {
                        missing_field: "pool",
    ...
    fn merge(
        ...
        if let Some(other_value) = other.pool {
            <::k8s_openapi::api::resource::v1beta2::ResourcePool as crate::OptionableConvert>::merge(
                &mut self.pool,
                other_value,
            )?;
        }
