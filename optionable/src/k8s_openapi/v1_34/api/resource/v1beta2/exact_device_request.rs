...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::resource::v1beta2::ExactDeviceRequest>
for ExactDeviceRequestAc {
    fn from_optionable(
        value: ::k8s_openapi::api::resource::v1beta2::ExactDeviceRequest,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::resource::v1beta2::ExactDeviceRequest,
    ) -> Result<(), crate::Error> {
