...
for ::k8s_openapi::api::networking::v1::ingress_tls::IngressTLS {
    fn into_optioned(self) -> IngressTLSOpt {
        IngressTLSOpt {
            hosts: <Option<
                std::vec::Vec<std::string::String>,
            > as crate::OptionableConvert>::into_optioned(self.hosts),
            secret_name: <Option<
                std::string::String,
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            hosts: <Option<
                std::vec::Vec<std::string::String>,
            > as crate::OptionableConvert>::try_from_optioned(value.hosts)?,
            secret_name: <Option<
                std::string::String,
    ...
    fn merge(&mut self, other: IngressTLSOpt) -> Result<(), crate::optionable::Error> {
        <Option<
            std::vec::Vec<std::string::String>,
        > as crate::OptionableConvert>::merge(&mut self.hosts, other.hosts)?;
        <Option<
            std::string::String,
