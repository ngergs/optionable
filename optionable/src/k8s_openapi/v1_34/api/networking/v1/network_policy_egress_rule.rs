...
#[automatically_derived]
#[cfg(feature = "k8s_openapi_convert")]
impl crate::OptionedConvert<::k8s_openapi::api::networking::v1::NetworkPolicyEgressRule>
for NetworkPolicyEgressRuleAc {
    fn from_optionable(
        value: ::k8s_openapi::api::networking::v1::NetworkPolicyEgressRule,
    ) -> Self {
    ...
    fn merge_into(
        self,
        other: &mut ::k8s_openapi::api::networking::v1::NetworkPolicyEgressRule,
    ) -> Result<(), crate::Error> {
