...
for ::k8s_openapi::api::batch::v1::cron_job_status::CronJobStatus {
    fn into_optioned(self) -> CronJobStatusOpt {
        CronJobStatusOpt {
            ...
            last_schedule_time: <Option<
                ::k8s_openapi::apimachinery::pkg::apis::meta::v1::Time,
            > as crate::OptionableConvert>::into_optioned(self.last_schedule_time),
            last_successful_time: <Option<
                ::k8s_openapi::apimachinery::pkg::apis::meta::v1::Time,
            > as crate::OptionableConvert>::into_optioned(self.last_successful_time),
        }
    }
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            last_schedule_time: <Option<
                ::k8s_openapi::apimachinery::pkg::apis::meta::v1::Time,
            > as crate::OptionableConvert>::try_from_optioned(value.last_schedule_time)?,
            last_successful_time: <Option<
                ::k8s_openapi::apimachinery::pkg::apis::meta::v1::Time,
