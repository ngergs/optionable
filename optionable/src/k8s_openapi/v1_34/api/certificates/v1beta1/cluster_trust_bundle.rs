...
for ::k8s_openapi::api::certificates::v1beta1::cluster_trust_bundle::ClusterTrustBundle {
    fn into_optioned(self) -> ClusterTrustBundleOpt {
        ClusterTrustBundleOpt {
            ...
            spec: Some(
                <::k8s_openapi::api::certificates::v1beta1::ClusterTrustBundleSpec as crate::OptionableConvert>::into_optioned(
                    self.spec,
                ),
            ),
        }
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            spec: <::k8s_openapi::api::certificates::v1beta1::ClusterTrustBundleSpec as crate::OptionableConvert>::try_from_optioned(
                value
                    .spec
                    .ok_or(crate::optionable::Error {
                        missing_field: "spec",
    ...
    fn merge(
        ...
        if let Some(other_value) = other.spec {
            <::k8s_openapi::api::certificates::v1beta1::ClusterTrustBundleSpec as crate::OptionableConvert>::merge(
                &mut self.spec,
                other_value,
            )?;
        }
