...
for ::k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::custom_resource_definition::CustomResourceDefinition {
...
for ::k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::custom_resource_definition::CustomResourceDefinition {
    fn into_optioned(self) -> CustomResourceDefinitionOpt {
        CustomResourceDefinitionOpt {
            ...
            spec: Some(
                <::k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec as crate::OptionableConvert>::into_optioned(
                    self.spec,
                ),
            ),
            status: <Option<
    ...
    fn try_from_optioned(
        ...
        Ok(Self {
            ...
            spec: <::k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec as crate::OptionableConvert>::try_from_optioned(
                value
                    .spec
                    .ok_or(crate::optionable::Error {
                        missing_field: "spec",
    ...
    fn merge(
        ...
        if let Some(other_value) = other.spec {
            <::k8s_openapi::apiextensions_apiserver::pkg::apis::apiextensions::v1::CustomResourceDefinitionSpec as crate::OptionableConvert>::merge(
                &mut self.spec,
                other_value,
            )?;
        }
